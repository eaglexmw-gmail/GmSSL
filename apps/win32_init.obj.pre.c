...
#line 822 "C:\\Program Files (x86)\\Windows Kits\\8.0\\include\\um\\synchapi.h"
...
#line 847 "C:\\Program Files (x86)\\Windows Kits\\8.0\\include\\um\\synchapi.h"
...
#line 512 "C:\\Program Files (x86)\\Windows Kits\\8.0\\include\\um\\memoryapi.h"
...
#line 1197 "C:\\Program Files (x86)\\Windows Kits\\8.0\\include\\um\\winreg.h"
...
if (h == ((HANDLE)(LONG_PTR)-1))
return 0;   
if (slash)
udlen = WideCharToMultiByte(65001, 0, wstr, slash,
...
break;
uflen = WideCharToMultiByte(65001, 0, data.cFileName, -1,
((void *)0), 0, ((void *)0), ((void *)0));
arg = malloc(udlen + uflen);
if (arg == ((void *)0))
break;
if (udlen)
WideCharToMultiByte(65001, 0, wstr, slash,
arg, udlen, ((void *)0), ((void *)0));
WideCharToMultiByte(65001, 0, data.cFileName, -1,
arg + udlen, uflen, ((void *)0), ((void *)0));
newargv[newargc++] = arg;
...
char *arg;
if (GetEnvironmentVariableW(L"OPENSSL_WIN32_UTF8", ((void *)0), 0) == 0)
return;
newargc = 0;
newargv = ((void *)0);
...
ulen = 0;
if (wlen > 0) {
ulen = WideCharToMultiByte(65001, 0, warg, wlen,
((void *)0), 0, ((void *)0), ((void *)0));
if (ulen <= 0)
continue;
}
...
if (wlen > 0)
WideCharToMultiByte(65001, 0, warg, wlen,
arg, ulen, ((void *)0), ((void *)0));
arg[ulen] = '\0';
newargv[newargc++] = arg;
}
}
