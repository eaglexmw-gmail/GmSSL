...
if (ctx->blocks > (1UI64 << 61))
return -2;              
while (len >= 16) {
#line 173 "crypto\\modes\\ccm128.c"
ctx->cmac.u[0] ^= ((u64 *)inp)[0];
ctx->cmac.u[1] ^= ((u64 *)inp)[1];
#line 176 "crypto\\modes\\ccm128.c"
(*block) (ctx->cmac.c, ctx->cmac.c, key);
(*block) (ctx->nonce.c, scratch.c, key);
ctr64_inc(ctx->nonce.c);
#line 184 "crypto\\modes\\ccm128.c"
((u64 *)out)[0] = scratch.u[0] ^ ((u64 *)inp)[0];
((u64 *)out)[1] = scratch.u[1] ^ ((u64 *)inp)[1];
#line 187 "crypto\\modes\\ccm128.c"
inp += 16;
out += 16;
len -= 16;
}
...
return -1;
while (len >= 16) {
#line 249 "crypto\\modes\\ccm128.c"
(*block) (ctx->nonce.c, scratch.c, key);
ctr64_inc(ctx->nonce.c);
#line 257 "crypto\\modes\\ccm128.c"
ctx->cmac.u[0] ^= (((u64 *)out)[0] = scratch.u[0] ^ ((u64 *)inp)[0]);
ctx->cmac.u[1] ^= (((u64 *)out)[1] = scratch.u[1] ^ ((u64 *)inp)[1]);
#line 260 "crypto\\modes\\ccm128.c"
(*block) (ctx->cmac.c, ctx->cmac.c, key);
inp += 16;
out += 16;
len -= 16;
