...
len -= 16;
while (len >= 16) {
#line 48 "crypto\\modes\\xts128.c"
scratch.u[0] = ((u64 *)inp)[0] ^ tweak.u[0];
scratch.u[1] = ((u64 *)inp)[1] ^ tweak.u[1];
#line 51 "crypto\\modes\\xts128.c"
(*ctx->block1) (scratch.c, scratch.c, ctx->key1);
#line 57 "crypto\\modes\\xts128.c"
((u64 *)out)[0] = scratch.u[0] ^= tweak.u[0];
((u64 *)out)[1] = scratch.u[1] ^= tweak.u[1];
#line 60 "crypto\\modes\\xts128.c"
inp += 16;
out += 16;
len -= 16;
if (len == 0)
...
#line 131 "crypto\\modes\\xts128.c"
scratch.u[0] = ((u64 *)inp)[0] ^ tweak1.u[0];
scratch.u[1] = ((u64 *)inp)[1] ^ tweak1.u[1];
#line 134 "crypto\\modes\\xts128.c"
(*ctx->block1) (scratch.c, scratch.c, ctx->key1);
...
scratch.u[1] ^= tweak.u[1];
(*ctx->block1) (scratch.c, scratch.c, ctx->key1);
#line 151 "crypto\\modes\\xts128.c"
((u64 *)out)[0] = scratch.u[0] ^ tweak.u[0];
((u64 *)out)[1] = scratch.u[1] ^ tweak.u[1];
#line 154 "crypto\\modes\\xts128.c"
}
return 0;
}
