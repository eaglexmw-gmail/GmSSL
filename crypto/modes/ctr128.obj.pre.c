...
#line 121 "crypto\\modes\\ctr128.c"
while (l < len) {
if (n == 0) {
(*block) (ivec, ecount_buf, key);
ctr128_inc(ivec);
...
ctr32 = _byteswap_ulong((u32)(*(const u32 *)(ivec + 12)));
while (len >= 16) {
...
*(u32 *)(ivec + 12) = _byteswap_ulong((u32)(ctr32));
if (ctr32 == 0)
ctr96_inc(ivec);
blocks *= 16;
len -= blocks;
