...
#line 13 "crypto\\modes\\gcm128.c"
#line 21 "crypto\\modes\\gcm128.c"
#line 215 "crypto\\modes\\gcm128.c"
static void gcm_init_4bit(u128 Htable[16], u64 H[2])
{
u128 V;
#line 222 "crypto\\modes\\gcm128.c"
Htable[0].hi = 0;
Htable[0].lo = 0;
V.hi = H[0];
V.lo = H[1];
#line 243 "crypto\\modes\\gcm128.c"
Htable[8] = V;
do { if (sizeof(size_t)==8) { u64 T = 0xe100000000000000UI64 & (0-(V.lo&1)); V.lo = (V.hi<<63)|(V.lo>>1); V.hi = (V.hi>>1 )^T; } else { u32 T = 0xe1000000U & (0-(u32)(V.lo&1)); V.lo = (V.hi<<63)|(V.lo>>1); V.hi = (V.hi>>1 )^((u64)T<<32); } } while(0);
Htable[4] = V;
do { if (sizeof(size_t)==8) { u64 T = 0xe100000000000000UI64 & (0-(V.lo&1)); V.lo = (V.hi<<63)|(V.lo>>1); V.hi = (V.hi>>1 )^T; } else { u32 T = 0xe1000000U & (0-(u32)(V.lo&1)); V.lo = (V.hi<<63)|(V.lo>>1); V.hi = (V.hi>>1 )^((u64)T<<32); } } while(0);
Htable[2] = V;
do { if (sizeof(size_t)==8) { u64 T = 0xe100000000000000UI64 & (0-(V.lo&1)); V.lo = (V.hi<<63)|(V.lo>>1); V.hi = (V.hi>>1 )^T; } else { u32 T = 0xe1000000U & (0-(u32)(V.lo&1)); V.lo = (V.hi<<63)|(V.lo>>1); V.hi = (V.hi>>1 )^((u64)T<<32); } } while(0);
...
#line 264 "crypto\\modes\\gcm128.c"
#line 288 "crypto\\modes\\gcm128.c"
}
void gcm_gmult_4bit(u64 Xi[2], const u128 Htable[16]);
void gcm_ghash_4bit(u64 Xi[2], const u128 Htable[16], const u8 *inp,
size_t len);
#line 552 "crypto\\modes\\gcm128.c"
#line 563 "crypto\\modes\\gcm128.c"
#line 630 "crypto\\modes\\gcm128.c"
extern unsigned int OPENSSL_ia32cap_P[];
void gcm_init_clmul(u128 Htable[16], const u64 Xi[2]);
void gcm_gmult_clmul(u64 Xi[2], const u128 Htable[16]);
void gcm_ghash_clmul(u64 Xi[2], const u128 Htable[16], const u8 *inp,
size_t len);
#line 655 "crypto\\modes\\gcm128.c"
...
size_t len);
#line 666 "crypto\\modes\\gcm128.c"
#line 702 "crypto\\modes\\gcm128.c"
#line 703 "crypto\\modes\\gcm128.c"
#line 711 "crypto\\modes\\gcm128.c"
#line 712 "crypto\\modes\\gcm128.c"
void CRYPTO_gcm128_init(GCM128_CONTEXT *ctx, void *key, block128_f block)
{
const union {
long one;
...
if (is_endian.little) {
ctx->H.u[0] = _byteswap_uint64((u64)(ctx->H.u[0]));
ctx->H.u[1] = _byteswap_uint64((u64)(ctx->H.u[1]));
#line 739 "crypto\\modes\\gcm128.c"
}
#line 743 "crypto\\modes\\gcm128.c"
#line 748 "crypto\\modes\\gcm128.c"
...
#line 764 "crypto\\modes\\gcm128.c"
gcm_init_4bit(ctx->Htable, ctx->H.u);
if (OPENSSL_ia32cap_P[0] & (1 << 25)) { 
#line 771 "crypto\\modes\\gcm128.c"
...
#line 781 "crypto\\modes\\gcm128.c"
#line 824 "crypto\\modes\\gcm128.c"
#line 826 "crypto\\modes\\gcm128.c"
}
void CRYPTO_gcm128_setiv(GCM128_CONTEXT *ctx, const unsigned char *iv,
size_t len)
{
...
#line 839 "crypto\\modes\\gcm128.c"
ctx->Yi.u[0] = 0;
ctx->Yi.u[1] = 0;
ctx->Xi.u[0] = 0;
ctx->Xi.u[1] = 0;
...
len0 <<= 3;
if (is_endian.little) {
ctx->Yi.u[1] ^= _byteswap_uint64((u64)(len0));
#line 883 "crypto\\modes\\gcm128.c"
} else
ctx->Yi.u[1] ^= len0;
(*gcm_gmult_p)(ctx->Yi.u,ctx->Htable);
if (is_endian.little)
ctr = _byteswap_ulong((u32)(ctx->Yi.d[3]));
#line 894 "crypto\\modes\\gcm128.c"
else
ctr = ctx->Yi.d[3];
}
...
++ctr;
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 906 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
}
int CRYPTO_gcm128_aad(GCM128_CONTEXT *ctx, const unsigned char *aad,
...
#line 922 "crypto\\modes\\gcm128.c"
#line 923 "crypto\\modes\\gcm128.c"
if (ctx->len.u[1])
return -2;
alen += len;
if (alen > (1UI64 << 61) || (sizeof(len) == 8 && alen < len))
return -1;
ctx->len.u[0] = alen;
n = ctx->ares;
if (n) {
...
#line 961 "crypto\\modes\\gcm128.c"
if (len) {
n = (unsigned int)len;
for (i = 0; i < len; ++i)
ctx->Xi.c[i] ^= aad[i];
...
void (*gcm_ghash_p) (u64 Xi[2], const u128 Htable[16],
const u8 *inp, size_t len) = ctx->ghash;
#line 990 "crypto\\modes\\gcm128.c"
#line 991 "crypto\\modes\\gcm128.c"
mlen += len;
if (mlen > ((1UI64 << 36) - 32) || (sizeof(len) == 8 && mlen < len))
return -1;
ctx->len.u[1] = mlen;
if (ctx->ares) {
(*gcm_gmult_p)(ctx->Xi.u,ctx->Htable);
...
if (is_endian.little)
ctr = _byteswap_ulong((u32)(ctx->Yi.d[3]));
#line 1009 "crypto\\modes\\gcm128.c"
else
ctr = ctx->Yi.d[3];
n = ctx->mres;
...
#line 1033 "crypto\\modes\\gcm128.c"
while (len >= (3*1024)) {
size_t j = (3*1024);
while (j) {
...
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1050 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
...
#line 1062 "crypto\\modes\\gcm128.c"
if ((i = (len & (size_t)-16))) {
size_t j = i;
while (len >= 16) {
size_t *out_t = (size_t *)out;
...
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1077 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
for (i = 0; i < 16 / sizeof(size_t); ++i)
out_t[i] = in_t[i] ^ ctx->EKi.t[i];
...
#line 1110 "crypto\\modes\\gcm128.c"
if (len) {
(*block) (ctx->Yi.c, ctx->EKi.c, key);
++ctr;
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1119 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
while (len--) {
...
#line 1132 "crypto\\modes\\gcm128.c"
for (i = 0; i < len; ++i) {
if (n == 0) {
(*block) (ctx->Yi.c, ctx->EKi.c, key);
++ctr;
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1142 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
}
...
void (*gcm_ghash_p) (u64 Xi[2], const u128 Htable[16],
const u8 *inp, size_t len) = ctx->ghash;
#line 1174 "crypto\\modes\\gcm128.c"
#line 1175 "crypto\\modes\\gcm128.c"
mlen += len;
if (mlen > ((1UI64 << 36) - 32) || (sizeof(len) == 8 && mlen < len))
return -1;
ctx->len.u[1] = mlen;
...
if (is_endian.little)
ctr = _byteswap_ulong((u32)(ctx->Yi.d[3]));
#line 1193 "crypto\\modes\\gcm128.c"
else
ctr = ctx->Yi.d[3];
n = ctx->mres;
if (16 % sizeof(size_t) == 0) { 
...
#line 1219 "crypto\\modes\\gcm128.c"
while (len >= (3*1024)) {
size_t j = (3*1024);
...
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1237 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
for (i = 0; i < 16 / sizeof(size_t); ++i)
out_t[i] = in_t[i] ^ ctx->EKi.t[i];
...
#line 1248 "crypto\\modes\\gcm128.c"
if ((i = (len & (size_t)-16))) {
...
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1262 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
for (i = 0; i < 16 / sizeof(size_t); ++i)
out_t[i] = in_t[i] ^ ctx->EKi.t[i];
...
#line 1297 "crypto\\modes\\gcm128.c"
if (len) {
(*block) (ctx->Yi.c, ctx->EKi.c, key);
++ctr;
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1306 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
while (len--) {
u8 c = in[n];
...
#line 1321 "crypto\\modes\\gcm128.c"
for (i = 0; i < len; ++i) {
u8 c;
if (n == 0) {
(*block) (ctx->Yi.c, ctx->EKi.c, key);
...
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1332 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
}
c = in[i];
...
size_t len, ctr128_f stream)
{
#line 1354 "crypto\\modes\\gcm128.c"
const union {
long one;
char little;
} is_endian = { 1 };
...
void (*gcm_ghash_p) (u64 Xi[2], const u128 Htable[16],
const u8 *inp, size_t len) = ctx->ghash;
#line 1368 "crypto\\modes\\gcm128.c"
#line 1369 "crypto\\modes\\gcm128.c"
mlen += len;
if (mlen > ((1UI64 << 36) - 32) || (sizeof(len) == 8 && mlen < len))
return -1;
ctx->len.u[1] = mlen;
...
if (is_endian.little)
ctr = _byteswap_ulong((u32)(ctx->Yi.d[3]));
#line 1387 "crypto\\modes\\gcm128.c"
else
ctr = ctx->Yi.d[3];
n = ctx->mres;
if (n) {
...
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1414 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
...
#line 1422 "crypto\\modes\\gcm128.c"
if ((i = (len & (size_t)-16))) {
size_t j = i / 16;
...
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1433 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
in += i;
len -= i;
...
out += i;
#line 1448 "crypto\\modes\\gcm128.c"
}
if (len) {
...
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1458 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
while (len--) {
ctx->Xi.c[n] ^= out[n] = in[n] ^ ctx->EKi.c[n];
...
ctx->mres = n;
return 0;
#line 1469 "crypto\\modes\\gcm128.c"
}
int CRYPTO_gcm128_decrypt_ctr32(GCM128_CONTEXT *ctx,
const unsigned char *in, unsigned char *out,
size_t len, ctr128_f stream)
{
#line 1478 "crypto\\modes\\gcm128.c"
const union {
long one;
char little;
} is_endian = { 1 };
...
void (*gcm_ghash_p) (u64 Xi[2], const u128 Htable[16],
const u8 *inp, size_t len) = ctx->ghash;
#line 1492 "crypto\\modes\\gcm128.c"
#line 1493 "crypto\\modes\\gcm128.c"
mlen += len;
if (mlen > ((1UI64 << 36) - 32) || (sizeof(len) == 8 && mlen < len))
return -1;
ctx->len.u[1] = mlen;
...
if (is_endian.little)
ctr = _byteswap_ulong((u32)(ctx->Yi.d[3]));
#line 1511 "crypto\\modes\\gcm128.c"
else
ctr = ctx->Yi.d[3];
n = ctx->mres;
if (n) {
...
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1541 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
out += (3*1024);
in += (3*1024);
...
#line 1548 "crypto\\modes\\gcm128.c"
if ((i = (len & (size_t)-16))) {
size_t j = i / 16;
(*gcm_ghash_p)(ctx->Xi.u,ctx->Htable,in,i);
#line 1564 "crypto\\modes\\gcm128.c"
(*stream) (in, out, j, key, ctx->Yi.c);
ctr += (unsigned int)j;
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1572 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
out += i;
in += i;
...
if (is_endian.little)
ctx->Yi.d[3] = _byteswap_ulong((u32)(ctr));
#line 1587 "crypto\\modes\\gcm128.c"
else
ctx->Yi.d[3] = ctr;
while (len--) {
u8 c = in[n];
...
ctx->mres = n;
return 0;
#line 1600 "crypto\\modes\\gcm128.c"
}
int CRYPTO_gcm128_finish(GCM128_CONTEXT *ctx, const unsigned char *tag,
size_t len)
{
...
void (*gcm_gmult_p) (u64 Xi[2], const u128 Htable[16]) = ctx->gmult;
#line 1614 "crypto\\modes\\gcm128.c"
if (ctx->mres || ctx->ares)
(*gcm_gmult_p)(ctx->Xi.u,ctx->Htable);
if (is_endian.little) {
alen = _byteswap_uint64((u64)(alen));
clen = _byteswap_uint64((u64)(clen));
#line 1631 "crypto\\modes\\gcm128.c"
}
ctx->Xi.u[0] ^= alen;
ctx->Xi.u[1] ^= clen;
(*gcm_gmult_p)(ctx->Xi.u,ctx->Htable);
...
{
GCM128_CONTEXT *ret;
if ((ret = CRYPTO_malloc(sizeof(*ret), "crypto\\modes\\gcm128.c", 1657)) != ((void *)0))
CRYPTO_gcm128_init(ret, key, block);
return ret;
}
void CRYPTO_gcm128_release(GCM128_CONTEXT *ctx)
{
CRYPTO_clear_free(ctx, sizeof(*ctx), "crypto\\modes\\gcm128.c", 1665);
}
#line 2303 "crypto\\modes\\gcm128.c"
