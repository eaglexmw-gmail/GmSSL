                             ...
                             unsigned char ivec[16], cbc128_f cbc)
{
    ...
    in += len;
    out += len;
#line 115 "crypto\\modes\\cts128.c"
    memset(tmp.c, 0, sizeof(tmp));
    memcpy(tmp.c, in, residue);
    memcpy(out, out - 16, residue);
    (*cbc) (tmp.c, out - 16, 16, key, ivec, 1);
#line 120 "crypto\\modes\\cts128.c"
    return len + residue;
}
size_t CRYPTO_nistcts128_encrypt(const unsigned char *in, unsigned char *out,
                                 size_t len, const void *key,
                                 unsigned char ivec[16], cbc128_f cbc)
{
    ...
    in += len;
    out += len;
#line 151 "crypto\\modes\\cts128.c"
    memset(tmp.c, 0, sizeof(tmp));
    memcpy(tmp.c, in, residue);
    (*cbc) (tmp.c, out - 16 + residue, 16, key, ivec, 1);
#line 155 "crypto\\modes\\cts128.c"
    return len + residue;
}
size_t CRYPTO_cts128_decrypt_block(const unsigned char *in,
                                   unsigned char *out, size_t len,
                             ...
                             unsigned char ivec[16], cbc128_f cbc)
{
    ...
    memcpy(tmp.c, in + 16, residue);
#line 282 "crypto\\modes\\cts128.c"
    (*cbc) (tmp.c, tmp.c, 32, key, ivec, 0);
    memcpy(out, tmp.c, 16 + residue);
#line 285 "crypto\\modes\\cts128.c"
    return 16 + len + residue;
}
size_t CRYPTO_nistcts128_decrypt(const unsigned char *in, unsigned char *out,
                                 size_t len, const void *key,
                                 unsigned char ivec[16], cbc128_f cbc)
{
    ...
    memcpy(tmp.c, in, residue);
#line 326 "crypto\\modes\\cts128.c"
    (*cbc) (tmp.c, tmp.c, 32, key, ivec, 0);
    memcpy(out, tmp.c, 16 + residue);
#line 329 "crypto\\modes\\cts128.c"
    return 16 + len + residue;
}
#line 524 "crypto\\modes\\cts128.c"
