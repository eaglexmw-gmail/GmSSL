...
#line 13 "crypto\\o_time.c"
struct tm *OPENSSL_gmtime(const time_t *timer, struct tm *result)
{
    struct tm *ts = ((void *)0);
#line 62 "crypto\\o_time.c"
    ts = gmtime(timer);
    if (ts == ((void *)0))
        return ((void *)0);
    memcpy(result, ts, sizeof(struct tm));
    ts = result;
#line 69 "crypto\\o_time.c"
#line 219 "crypto\\o_time.c"
    return ts;
}
