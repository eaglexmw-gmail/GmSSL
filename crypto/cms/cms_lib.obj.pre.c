...
#line 14 "crypto\\cms\\cms_lib.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/bio.h"
#line 15 "crypto\\cms\\cms_lib.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/asn1.h"
#line 16 "crypto\\cms\\cms_lib.c"
...
#line 18 "crypto\\cms\\cms_lib.c"
CMS_ContentInfo *d2i_CMS_ContentInfo(CMS_ContentInfo **a, const unsigned char **in, long len) { return (CMS_ContentInfo *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (CMS_ContentInfo_it())); } int i2d_CMS_ContentInfo(CMS_ContentInfo *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (CMS_ContentInfo_it())); } CMS_ContentInfo *CMS_ContentInfo_new(void) { return (CMS_ContentInfo *)ASN1_item_new((CMS_ContentInfo_it())); } void CMS_ContentInfo_free(CMS_ContentInfo *a) { ASN1_item_free((ASN1_VALUE *)a, (CMS_ContentInfo_it())); }
int CMS_ContentInfo_print_ctx(BIO *out, CMS_ContentInfo *x, int indent, const ASN1_PCTX *pctx) { return ASN1_item_print(out, (ASN1_VALUE *)x, indent, (CMS_ContentInfo_it()), pctx); }
const ASN1_OBJECT *CMS_get0_type(const CMS_ContentInfo *cms)
{
...
if (cms != ((void *)0)) {
cms->contentType = OBJ_nid2obj(21);
...
if (!cont) {
ERR_put_error(46,(111),(127),"crypto\\cms\\cms_lib.c",64);
return ((void *)0);
}
...
break;
default:
ERR_put_error(46,(111),(156),"crypto\\cms\\cms_lib.c",94);
return ((void *)0);
}
if (cmsbio)
...
unsigned char *cont;
long contlen;
mbio = BIO_find_type(cmsbio, ( 1|0x0400));
if (!mbio) {
ERR_put_error(46,(110),(105),"crypto\\cms\\cms_lib.c",119);
return 0;
}
contlen = BIO_ctrl(mbio,3,0,(char *)&cont);
BIO_set_flags(mbio, 0x200);
BIO_ctrl(mbio,130,0,((void *)0));
...
default:
ERR_put_error(46,(110),(156),"crypto\\cms\\cms_lib.c",146);
return 0;
}
}
ASN1_OCTET_STRING **CMS_get0_content(CMS_ContentInfo *cms)
...
default:
if (cms->d.other->type == 4)
return &cms->d.other->value.octet_string;
ERR_put_error(46,(129),(152),"crypto\\cms\\cms_lib.c",184);
return ((void *)0);
}
}
...
default:
ERR_put_error(46,(130),(152),"crypto\\cms\\cms_lib.c",218);
return ((void *)0);
}
}
const ASN1_OBJECT *CMS_get0_eContentType(CMS_ContentInfo *cms)
...
ERR_put_error(46,(147),((1|64)),"crypto\\cms\\cms_lib.c",280);
return 0;
}
BIO *cms_DigestAlgorithm_init_bio(X509_ALGOR *digestAlgorithm)
{
...
digest = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(digestoid)));
if (!digest) {
ERR_put_error(46,(116),(149),"crypto\\cms\\cms_lib.c",295);
#line 296 "crypto\\cms\\cms_lib.c"
goto err;
}
mdbio = BIO_new(BIO_f_md());
if (mdbio == ((void *)0) || !BIO_ctrl(mdbio,111,0,(char *)digest)) {
ERR_put_error(46,(116),(119),"crypto\\cms\\cms_lib.c",300);
goto err;
}
return mdbio;
err:
...
for (;;) {
EVP_MD_CTX *mtmp;
chain = BIO_find_type(chain, ( 8|0x0200));
if (chain == ((void *)0)) {
ERR_put_error(46,(115),(131),"crypto\\cms\\cms_lib.c",324);
#line 325 "crypto\\cms\\cms_lib.c"
return 0;
}
BIO_ctrl(chain,120,0,(char *)&mtmp);
if (EVP_MD_type(EVP_MD_CTX_md(mtmp)) == nid
|| EVP_MD_pkey_type(EVP_MD_CTX_md(mtmp)) == nid)
return EVP_MD_CTX_copy_ex(mctx, mtmp);
chain = BIO_next(chain);
}
}
static struct stack_st_CMS_CertificateChoices
...
case 23:
if (cms->d.envelopedData->originatorInfo == ((void *)0))
return ((void *)0);
return &cms->d.envelopedData->originatorInfo->certificates;
default:
ERR_put_error(46,(128),(152),"crypto\\cms\\cms_lib.c",354);
#line 355 "crypto\\cms\\cms_lib.c"
return ((void *)0);
}
}
CMS_CertificateChoices *CMS_add0_CertificateChoices(CMS_ContentInfo *cms)
{
struct stack_st_CMS_CertificateChoices **pcerts;
...
ASN1_item_free(((void*) (1 ? cch : (CMS_CertificateChoices*)0)), (CMS_CertificateChoices_it()));
return ((void *)0);
}
return cch;
}
...
ERR_put_error(46,(164),(175),"crypto\\cms\\cms_lib.c",394);
#line 395 "crypto\\cms\\cms_lib.c"
return 0;
}
}
}
...
static struct stack_st_CMS_RevocationInfoChoice
...
default:
ERR_put_error(46,(132),(152),"crypto\\cms\\cms_lib.c",431);
#line 432 "crypto\\cms\\cms_lib.c"
return ((void *)0);
}
}
CMS_RevocationInfoChoice *CMS_add0_RevocationInfoChoice(CMS_ContentInfo *cms)
{
struct stack_st_CMS_RevocationInfoChoice **pcrls;
...
ASN1_item_free(((void*) (1 ? rch : (CMS_RevocationInfoChoice*)0)), (CMS_RevocationInfoChoice_it()));
return ((void *)0);
}
return rch;
}
...
goto err;
ASN1_item_free(((void*) (1 ? *pias : (CMS_IssuerAndSerialNumber*)0)), (CMS_IssuerAndSerialNumber_it()));
*pias = ias;
return 1;
err:
ASN1_item_free(((void*) (1 ? ias : (CMS_IssuerAndSerialNumber*)0)), (CMS_IssuerAndSerialNumber_it()));
ERR_put_error(46,(176),((1|64)),"crypto\\cms\\cms_lib.c",566);
return 0;
}
int cms_set1_keyid(ASN1_OCTET_STRING **pkeyid, X509 *cert)
{
...
if (cert_keyid == ((void *)0)) {
ERR_put_error(46,(177),(160),"crypto\\cms\\cms_lib.c",576);
return 0;
}
keyid = ASN1_STRING_dup(cert_keyid);
if (!keyid) {
ERR_put_error(46,(177),((1|64)),"crypto\\cms\\cms_lib.c",581);
return 0;
}
