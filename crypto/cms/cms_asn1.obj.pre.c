...
#line 14 "crypto\\cms\\cms_asn1.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\cms\\cms_lcl.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/x509.h"
#line 18 "d:\\07.opensrc\\gmssl\\crypto\\cms\\cms_lcl.h"
...
const ASN1_ITEM * CMS_KEKRecipientInfo_it(void);
const ASN1_ITEM * CMS_KeyAgreeRecipientInfo_it(void);
const ASN1_ITEM * CMS_KeyTransRecipientInfo_it(void);
const ASN1_ITEM * CMS_OriginatorPublicKey_it(void);
const ASN1_ITEM * CMS_OtherKeyAttribute_it(void);
const ASN1_ITEM * CMS_Receipt_it(void);
const ASN1_ITEM * CMS_ReceiptRequest_it(void);
const ASN1_ITEM * CMS_RecipientEncryptedKey_it(void);
const ASN1_ITEM * CMS_RecipientKeyIdentifier_it(void);
const ASN1_ITEM * CMS_RevocationInfoChoice_it(void);
const ASN1_ITEM * CMS_SignedData_it(void);
const ASN1_ITEM * CMS_CompressedData_it(void);
#line 445 "d:\\07.opensrc\\gmssl\\crypto\\cms\\cms_lcl.h"
#line 15 "crypto\\cms\\cms_asn1.c"
static const ASN1_TEMPLATE CMS_IssuerAndSerialNumber_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_IssuerAndSerialNumber *)0)->issuer), "issuer", (X509_NAME_it) },
{ (0), (0), (size_t)&(((CMS_IssuerAndSerialNumber *)0)->serialNumber), "serialNumber", (ASN1_INTEGER_it) }
} ; const ASN1_ITEM * CMS_IssuerAndSerialNumber_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_IssuerAndSerialNumber_seq_tt, sizeof(CMS_IssuerAndSerialNumber_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_IssuerAndSerialNumber), "CMS_IssuerAndSerialNumber" }; return &local_it; }
static const ASN1_TEMPLATE CMS_OtherCertificateFormat_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_OtherCertificateFormat *)0)->otherCertFormat), "otherCertFormat", (ASN1_OBJECT_it) },
{ ((0x1)), (0), (size_t)&(((CMS_OtherCertificateFormat *)0)->otherCert), "otherCert", (ASN1_ANY_it) }
} ; static const ASN1_ITEM * CMS_OtherCertificateFormat_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_OtherCertificateFormat_seq_tt, sizeof(CMS_OtherCertificateFormat_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_OtherCertificateFormat), "CMS_OtherCertificateFormat" }; return &local_it; }
static const ASN1_TEMPLATE CMS_CertificateChoices_ch_tt[] = {
{ (0), (0), (size_t)&(((CMS_CertificateChoices *)0)->d.certificate), "d.certificate", (X509_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (0), (size_t)&(((CMS_CertificateChoices *)0)->d.extendedCertificate), "d.extendedCertificate", (ASN1_SEQUENCE_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (1), (size_t)&(((CMS_CertificateChoices *)0)->d.v1AttrCert), "d.v1AttrCert", (ASN1_SEQUENCE_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (2), (size_t)&(((CMS_CertificateChoices *)0)->d.v2AttrCert), "d.v2AttrCert", (ASN1_SEQUENCE_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (3), (size_t)&(((CMS_CertificateChoices *)0)->d.other), "d.other", (CMS_OtherCertificateFormat_it) }
} ; const ASN1_ITEM * CMS_CertificateChoices_it(void) { static const ASN1_ITEM local_it = { 0x2, (size_t)&(((CMS_CertificateChoices *)0)->type) , CMS_CertificateChoices_ch_tt, sizeof(CMS_CertificateChoices_ch_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_CertificateChoices), "CMS_CertificateChoices" }; return &local_it; }
static const ASN1_TEMPLATE CMS_SignerIdentifier_ch_tt[] = {
{ (0), (0), (size_t)&(((CMS_SignerIdentifier *)0)->d.issuerAndSerialNumber), "d.issuerAndSerialNumber", (CMS_IssuerAndSerialNumber_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (0), (size_t)&(((CMS_SignerIdentifier *)0)->d.subjectKeyIdentifier), "d.subjectKeyIdentifier", (ASN1_OCTET_STRING_it) }
} ; static const ASN1_ITEM * CMS_SignerIdentifier_it(void) { static const ASN1_ITEM local_it = { 0x2, (size_t)&(((CMS_SignerIdentifier *)0)->type) , CMS_SignerIdentifier_ch_tt, sizeof(CMS_SignerIdentifier_ch_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_SignerIdentifier), "CMS_SignerIdentifier" }; return &local_it; }
static const ASN1_TEMPLATE CMS_EncapsulatedContentInfo_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_EncapsulatedContentInfo *)0)->eContentType), "eContentType", (ASN1_OBJECT_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)|(0x1<<11)), (0), (size_t)&(((CMS_EncapsulatedContentInfo *)0)->eContent), "eContent", (ASN1_OCTET_STRING_NDEF_it) }
} ; static const ASN1_ITEM * CMS_EncapsulatedContentInfo_it(void) { static const ASN1_ITEM local_it = { 0x6, 16, CMS_EncapsulatedContentInfo_seq_tt, sizeof(CMS_EncapsulatedContentInfo_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_EncapsulatedContentInfo), "CMS_EncapsulatedContentInfo" }; return &local_it; }
...
static const ASN1_AUX CMS_SignerInfo_aux = {((void *)0), 0, 0, 0, cms_si_cb, 0}; static const ASN1_TEMPLATE CMS_SignerInfo_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_SignerInfo *)0)->version), "version", (LONG_it) },
{ (0), (0), (size_t)&(((CMS_SignerInfo *)0)->sid), "sid", (CMS_SignerIdentifier_it) },
{ (0), (0), (size_t)&(((CMS_SignerInfo *)0)->digestAlgorithm), "digestAlgorithm", (X509_ALGOR_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1 << 1)|(0x1)), (0), (size_t)&(((CMS_SignerInfo *)0)->signedAttrs), "signedAttrs", (X509_ATTRIBUTE_it) },
{ (0), (0), (size_t)&(((CMS_SignerInfo *)0)->signatureAlgorithm), "signatureAlgorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_SignerInfo *)0)->signature), "signature", (ASN1_OCTET_STRING_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1 << 1)|(0x1)), (1), (size_t)&(((CMS_SignerInfo *)0)->unsignedAttrs), "unsignedAttrs", (X509_ATTRIBUTE_it) }
} ; const ASN1_ITEM * CMS_SignerInfo_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_SignerInfo_seq_tt, sizeof(CMS_SignerInfo_seq_tt) / sizeof(ASN1_TEMPLATE), &CMS_SignerInfo_aux, sizeof(CMS_SignerInfo), "CMS_SignerInfo" }; return &local_it; }
static const ASN1_TEMPLATE CMS_OtherRevocationInfoFormat_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_OtherRevocationInfoFormat *)0)->otherRevInfoFormat), "otherRevInfoFormat", (ASN1_OBJECT_it) },
{ ((0x1)), (0), (size_t)&(((CMS_OtherRevocationInfoFormat *)0)->otherRevInfo), "otherRevInfo", (ASN1_ANY_it) }
} ; static const ASN1_ITEM * CMS_OtherRevocationInfoFormat_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_OtherRevocationInfoFormat_seq_tt, sizeof(CMS_OtherRevocationInfoFormat_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_OtherRevocationInfoFormat), "CMS_OtherRevocationInfoFormat" }; return &local_it; }
static const ASN1_TEMPLATE CMS_RevocationInfoChoice_ch_tt[] = {
{ (0), (0), (size_t)&(((CMS_RevocationInfoChoice *)0)->d.crl), "d.crl", (X509_CRL_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (1), (size_t)&(((CMS_RevocationInfoChoice *)0)->d.other), "d.other", (CMS_OtherRevocationInfoFormat_it) }
} ; const ASN1_ITEM * CMS_RevocationInfoChoice_it(void) { static const ASN1_ITEM local_it = { 0x2, (size_t)&(((CMS_RevocationInfoChoice *)0)->type) , CMS_RevocationInfoChoice_ch_tt, sizeof(CMS_RevocationInfoChoice_ch_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_RevocationInfoChoice), "CMS_RevocationInfoChoice" }; return &local_it; }
static const ASN1_TEMPLATE CMS_SignedData_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_SignedData *)0)->version), "version", (LONG_it) },
{ ((0x1 << 1)), (0), (size_t)&(((CMS_SignedData *)0)->digestAlgorithms), "digestAlgorithms", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_SignedData *)0)->encapContentInfo), "encapContentInfo", (CMS_EncapsulatedContentInfo_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1 << 1)|(0x1)), (0), (size_t)&(((CMS_SignedData *)0)->certificates), "certificates", (CMS_CertificateChoices_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1 << 1)|(0x1)), (1), (size_t)&(((CMS_SignedData *)0)->crls), "crls", (CMS_RevocationInfoChoice_it) },
{ ((0x1 << 1)), (0), (size_t)&(((CMS_SignedData *)0)->signerInfos), "signerInfos", (CMS_SignerInfo_it) }
} ; const ASN1_ITEM * CMS_SignedData_it(void) { static const ASN1_ITEM local_it = { 0x6, 16, CMS_SignedData_seq_tt, sizeof(CMS_SignedData_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_SignedData), "CMS_SignedData" }; return &local_it; }
static const ASN1_TEMPLATE CMS_OriginatorInfo_seq_tt[] = {
{ ((0x1 << 3)|(0x2<<6) | (0x1 << 1)|(0x1)), (0), (size_t)&(((CMS_OriginatorInfo *)0)->certificates), "certificates", (CMS_CertificateChoices_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1 << 1)|(0x1)), (1), (size_t)&(((CMS_OriginatorInfo *)0)->crls), "crls", (CMS_RevocationInfoChoice_it) }
} ; static const ASN1_ITEM * CMS_OriginatorInfo_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_OriginatorInfo_seq_tt, sizeof(CMS_OriginatorInfo_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_OriginatorInfo), "CMS_OriginatorInfo" }; return &local_it; }
static const ASN1_TEMPLATE CMS_EncryptedContentInfo_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_EncryptedContentInfo *)0)->contentType), "contentType", (ASN1_OBJECT_it) },
{ (0), (0), (size_t)&(((CMS_EncryptedContentInfo *)0)->contentEncryptionAlgorithm), "contentEncryptionAlgorithm", (X509_ALGOR_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((CMS_EncryptedContentInfo *)0)->encryptedContent), "encryptedContent", (ASN1_OCTET_STRING_NDEF_it) }
} ; static const ASN1_ITEM * CMS_EncryptedContentInfo_it(void) { static const ASN1_ITEM local_it = { 0x6, 16, CMS_EncryptedContentInfo_seq_tt, sizeof(CMS_EncryptedContentInfo_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_EncryptedContentInfo), "CMS_EncryptedContentInfo" }; return &local_it; }
static const ASN1_TEMPLATE CMS_KeyTransRecipientInfo_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_KeyTransRecipientInfo *)0)->version), "version", (LONG_it) },
{ (0), (0), (size_t)&(((CMS_KeyTransRecipientInfo *)0)->rid), "rid", (CMS_SignerIdentifier_it) },
{ (0), (0), (size_t)&(((CMS_KeyTransRecipientInfo *)0)->keyEncryptionAlgorithm), "keyEncryptionAlgorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_KeyTransRecipientInfo *)0)->encryptedKey), "encryptedKey", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * CMS_KeyTransRecipientInfo_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_KeyTransRecipientInfo_seq_tt, sizeof(CMS_KeyTransRecipientInfo_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_KeyTransRecipientInfo), "CMS_KeyTransRecipientInfo" }; return &local_it; }
static const ASN1_TEMPLATE CMS_OtherKeyAttribute_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_OtherKeyAttribute *)0)->keyAttrId), "keyAttrId", (ASN1_OBJECT_it) },
{ ((0x1)), (0), (size_t)&(((CMS_OtherKeyAttribute *)0)->keyAttr), "keyAttr", (ASN1_ANY_it) }
} ; const ASN1_ITEM * CMS_OtherKeyAttribute_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_OtherKeyAttribute_seq_tt, sizeof(CMS_OtherKeyAttribute_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_OtherKeyAttribute), "CMS_OtherKeyAttribute" }; return &local_it; }
static const ASN1_TEMPLATE CMS_RecipientKeyIdentifier_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_RecipientKeyIdentifier *)0)->subjectKeyIdentifier), "subjectKeyIdentifier", (ASN1_OCTET_STRING_it) },
{ ((0x1)), (0), (size_t)&(((CMS_RecipientKeyIdentifier *)0)->date), "date", (ASN1_GENERALIZEDTIME_it) },
{ ((0x1)), (0), (size_t)&(((CMS_RecipientKeyIdentifier *)0)->other), "other", (CMS_OtherKeyAttribute_it) }
} ; const ASN1_ITEM * CMS_RecipientKeyIdentifier_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_RecipientKeyIdentifier_seq_tt, sizeof(CMS_RecipientKeyIdentifier_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_RecipientKeyIdentifier), "CMS_RecipientKeyIdentifier" }; return &local_it; }
static const ASN1_TEMPLATE CMS_KeyAgreeRecipientIdentifier_ch_tt[] = {
{ (0), (0), (size_t)&(((CMS_KeyAgreeRecipientIdentifier *)0)->d.issuerAndSerialNumber), "d.issuerAndSerialNumber", (CMS_IssuerAndSerialNumber_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (0), (size_t)&(((CMS_KeyAgreeRecipientIdentifier *)0)->d.rKeyId), "d.rKeyId", (CMS_RecipientKeyIdentifier_it) }
} ; static const ASN1_ITEM * CMS_KeyAgreeRecipientIdentifier_it(void) { static const ASN1_ITEM local_it = { 0x2, (size_t)&(((CMS_KeyAgreeRecipientIdentifier *)0)->type) , CMS_KeyAgreeRecipientIdentifier_ch_tt, sizeof(CMS_KeyAgreeRecipientIdentifier_ch_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_KeyAgreeRecipientIdentifier), "CMS_KeyAgreeRecipientIdentifier" }; return &local_it; }
...
static const ASN1_AUX CMS_RecipientEncryptedKey_aux = {((void *)0), 0, 0, 0, cms_rek_cb, 0}; static const ASN1_TEMPLATE CMS_RecipientEncryptedKey_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_RecipientEncryptedKey *)0)->rid), "rid", (CMS_KeyAgreeRecipientIdentifier_it) },
{ (0), (0), (size_t)&(((CMS_RecipientEncryptedKey *)0)->encryptedKey), "encryptedKey", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * CMS_RecipientEncryptedKey_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_RecipientEncryptedKey_seq_tt, sizeof(CMS_RecipientEncryptedKey_seq_tt) / sizeof(ASN1_TEMPLATE), &CMS_RecipientEncryptedKey_aux, sizeof(CMS_RecipientEncryptedKey), "CMS_RecipientEncryptedKey" }; return &local_it; }
static const ASN1_TEMPLATE CMS_OriginatorPublicKey_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_OriginatorPublicKey *)0)->algorithm), "algorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_OriginatorPublicKey *)0)->publicKey), "publicKey", (ASN1_BIT_STRING_it) }
} ; const ASN1_ITEM * CMS_OriginatorPublicKey_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_OriginatorPublicKey_seq_tt, sizeof(CMS_OriginatorPublicKey_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_OriginatorPublicKey), "CMS_OriginatorPublicKey" }; return &local_it; }
static const ASN1_TEMPLATE CMS_OriginatorIdentifierOrKey_ch_tt[] = {
{ (0), (0), (size_t)&(((CMS_OriginatorIdentifierOrKey *)0)->d.issuerAndSerialNumber), "d.issuerAndSerialNumber", (CMS_IssuerAndSerialNumber_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (0), (size_t)&(((CMS_OriginatorIdentifierOrKey *)0)->d.subjectKeyIdentifier), "d.subjectKeyIdentifier", (ASN1_OCTET_STRING_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (1), (size_t)&(((CMS_OriginatorIdentifierOrKey *)0)->d.originatorKey), "d.originatorKey", (CMS_OriginatorPublicKey_it) }
} ; static const ASN1_ITEM * CMS_OriginatorIdentifierOrKey_it(void) { static const ASN1_ITEM local_it = { 0x2, (size_t)&(((CMS_OriginatorIdentifierOrKey *)0)->type) , CMS_OriginatorIdentifierOrKey_ch_tt, sizeof(CMS_OriginatorIdentifierOrKey_ch_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_OriginatorIdentifierOrKey), "CMS_OriginatorIdentifierOrKey" }; return &local_it; }
...
if (kari->ctx == ((void *)0))
return 0;
EVP_CIPHER_CTX_set_flags(kari->ctx, 0x1);
kari->pctx = ((void *)0);
} else if (operation == 3) {
...
static const ASN1_AUX CMS_KeyAgreeRecipientInfo_aux = {((void *)0), 0, 0, 0, cms_kari_cb, 0}; static const ASN1_TEMPLATE CMS_KeyAgreeRecipientInfo_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_KeyAgreeRecipientInfo *)0)->version), "version", (LONG_it) },
{ ((0x2 << 3)|(0x2<<6) | 0), (0), (size_t)&(((CMS_KeyAgreeRecipientInfo *)0)->originator), "originator", (CMS_OriginatorIdentifierOrKey_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (1), (size_t)&(((CMS_KeyAgreeRecipientInfo *)0)->ukm), "ukm", (ASN1_OCTET_STRING_it) },
{ (0), (0), (size_t)&(((CMS_KeyAgreeRecipientInfo *)0)->keyEncryptionAlgorithm), "keyEncryptionAlgorithm", (X509_ALGOR_it) },
{ ((0x2 << 1)), (0), (size_t)&(((CMS_KeyAgreeRecipientInfo *)0)->recipientEncryptedKeys), "recipientEncryptedKeys", (CMS_RecipientEncryptedKey_it) }
} ; const ASN1_ITEM * CMS_KeyAgreeRecipientInfo_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_KeyAgreeRecipientInfo_seq_tt, sizeof(CMS_KeyAgreeRecipientInfo_seq_tt) / sizeof(ASN1_TEMPLATE), &CMS_KeyAgreeRecipientInfo_aux, sizeof(CMS_KeyAgreeRecipientInfo), "CMS_KeyAgreeRecipientInfo" }; return &local_it; }
static const ASN1_TEMPLATE CMS_KEKIdentifier_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_KEKIdentifier *)0)->keyIdentifier), "keyIdentifier", (ASN1_OCTET_STRING_it) },
{ ((0x1)), (0), (size_t)&(((CMS_KEKIdentifier *)0)->date), "date", (ASN1_GENERALIZEDTIME_it) },
{ ((0x1)), (0), (size_t)&(((CMS_KEKIdentifier *)0)->other), "other", (CMS_OtherKeyAttribute_it) }
} ; static const ASN1_ITEM * CMS_KEKIdentifier_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_KEKIdentifier_seq_tt, sizeof(CMS_KEKIdentifier_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_KEKIdentifier), "CMS_KEKIdentifier" }; return &local_it; }
static const ASN1_TEMPLATE CMS_KEKRecipientInfo_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_KEKRecipientInfo *)0)->version), "version", (LONG_it) },
{ (0), (0), (size_t)&(((CMS_KEKRecipientInfo *)0)->kekid), "kekid", (CMS_KEKIdentifier_it) },
{ (0), (0), (size_t)&(((CMS_KEKRecipientInfo *)0)->keyEncryptionAlgorithm), "keyEncryptionAlgorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_KEKRecipientInfo *)0)->encryptedKey), "encryptedKey", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * CMS_KEKRecipientInfo_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_KEKRecipientInfo_seq_tt, sizeof(CMS_KEKRecipientInfo_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_KEKRecipientInfo), "CMS_KEKRecipientInfo" }; return &local_it; }
static const ASN1_TEMPLATE CMS_PasswordRecipientInfo_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_PasswordRecipientInfo *)0)->version), "version", (LONG_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((CMS_PasswordRecipientInfo *)0)->keyDerivationAlgorithm), "keyDerivationAlgorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_PasswordRecipientInfo *)0)->keyEncryptionAlgorithm), "keyEncryptionAlgorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_PasswordRecipientInfo *)0)->encryptedKey), "encryptedKey", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * CMS_PasswordRecipientInfo_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_PasswordRecipientInfo_seq_tt, sizeof(CMS_PasswordRecipientInfo_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_PasswordRecipientInfo), "CMS_PasswordRecipientInfo" }; return &local_it; }
static const ASN1_TEMPLATE CMS_OtherRecipientInfo_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_OtherRecipientInfo *)0)->oriType), "oriType", (ASN1_OBJECT_it) },
{ ((0x1)), (0), (size_t)&(((CMS_OtherRecipientInfo *)0)->oriValue), "oriValue", (ASN1_ANY_it) }
} ; static const ASN1_ITEM * CMS_OtherRecipientInfo_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_OtherRecipientInfo_seq_tt, sizeof(CMS_OtherRecipientInfo_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_OtherRecipientInfo), "CMS_OtherRecipientInfo" }; return &local_it; }
...
CRYPTO_clear_free(kekri->key, kekri->keylen, "crypto\\cms\\cms_asn1.c", 210);
} else if (ri->type == 3) {
CMS_PasswordRecipientInfo *pwri = ri->d.pwri;
CRYPTO_clear_free(pwri->pass, pwri->passlen, "crypto\\cms\\cms_asn1.c", 213);
}
}
return 1;
}
static const ASN1_AUX CMS_RecipientInfo_aux = {((void *)0), 0, 0, 0, cms_ri_cb, 0}; static const ASN1_TEMPLATE CMS_RecipientInfo_ch_tt[] = {
{ (0), (0), (size_t)&(((CMS_RecipientInfo *)0)->d.ktri), "d.ktri", (CMS_KeyTransRecipientInfo_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (1), (size_t)&(((CMS_RecipientInfo *)0)->d.kari), "d.kari", (CMS_KeyAgreeRecipientInfo_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (2), (size_t)&(((CMS_RecipientInfo *)0)->d.kekri), "d.kekri", (CMS_KEKRecipientInfo_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (3), (size_t)&(((CMS_RecipientInfo *)0)->d.pwri), "d.pwri", (CMS_PasswordRecipientInfo_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (4), (size_t)&(((CMS_RecipientInfo *)0)->d.ori), "d.ori", (CMS_OtherRecipientInfo_it) }
} ; const ASN1_ITEM * CMS_RecipientInfo_it(void) { static const ASN1_ITEM local_it = { 0x2, (size_t)&(((CMS_RecipientInfo *)0)->type) , CMS_RecipientInfo_ch_tt, sizeof(CMS_RecipientInfo_ch_tt) / sizeof(ASN1_TEMPLATE), &CMS_RecipientInfo_aux, sizeof(CMS_RecipientInfo), "CMS_RecipientInfo" }; return &local_it; }
static const ASN1_TEMPLATE CMS_EnvelopedData_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_EnvelopedData *)0)->version), "version", (LONG_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((CMS_EnvelopedData *)0)->originatorInfo), "originatorInfo", (CMS_OriginatorInfo_it) },
{ ((0x1 << 1)), (0), (size_t)&(((CMS_EnvelopedData *)0)->recipientInfos), "recipientInfos", (CMS_RecipientInfo_it) },
{ (0), (0), (size_t)&(((CMS_EnvelopedData *)0)->encryptedContentInfo), "encryptedContentInfo", (CMS_EncryptedContentInfo_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1 << 1)|(0x1)), (1), (size_t)&(((CMS_EnvelopedData *)0)->unprotectedAttrs), "unprotectedAttrs", (X509_ATTRIBUTE_it) }
} ; const ASN1_ITEM * CMS_EnvelopedData_it(void) { static const ASN1_ITEM local_it = { 0x6, 16, CMS_EnvelopedData_seq_tt, sizeof(CMS_EnvelopedData_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_EnvelopedData), "CMS_EnvelopedData" }; return &local_it; }
static const ASN1_TEMPLATE CMS_DigestedData_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_DigestedData *)0)->version), "version", (LONG_it) },
{ (0), (0), (size_t)&(((CMS_DigestedData *)0)->digestAlgorithm), "digestAlgorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_DigestedData *)0)->encapContentInfo), "encapContentInfo", (CMS_EncapsulatedContentInfo_it) },
{ (0), (0), (size_t)&(((CMS_DigestedData *)0)->digest), "digest", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * CMS_DigestedData_it(void) { static const ASN1_ITEM local_it = { 0x6, 16, CMS_DigestedData_seq_tt, sizeof(CMS_DigestedData_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_DigestedData), "CMS_DigestedData" }; return &local_it; }
static const ASN1_TEMPLATE CMS_EncryptedData_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_EncryptedData *)0)->version), "version", (LONG_it) },
{ (0), (0), (size_t)&(((CMS_EncryptedData *)0)->encryptedContentInfo), "encryptedContentInfo", (CMS_EncryptedContentInfo_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1 << 1)|(0x1)), (1), (size_t)&(((CMS_EncryptedData *)0)->unprotectedAttrs), "unprotectedAttrs", (X509_ATTRIBUTE_it) }
} ; const ASN1_ITEM * CMS_EncryptedData_it(void) { static const ASN1_ITEM local_it = { 0x6, 16, CMS_EncryptedData_seq_tt, sizeof(CMS_EncryptedData_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_EncryptedData), "CMS_EncryptedData" }; return &local_it; }
static const ASN1_TEMPLATE CMS_AuthenticatedData_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_AuthenticatedData *)0)->version), "version", (LONG_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((CMS_AuthenticatedData *)0)->originatorInfo), "originatorInfo", (CMS_OriginatorInfo_it) },
{ ((0x1 << 1)), (0), (size_t)&(((CMS_AuthenticatedData *)0)->recipientInfos), "recipientInfos", (CMS_RecipientInfo_it) },
{ (0), (0), (size_t)&(((CMS_AuthenticatedData *)0)->macAlgorithm), "macAlgorithm", (X509_ALGOR_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (1), (size_t)&(((CMS_AuthenticatedData *)0)->digestAlgorithm), "digestAlgorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_AuthenticatedData *)0)->encapContentInfo), "encapContentInfo", (CMS_EncapsulatedContentInfo_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1 << 1)|(0x1)), (2), (size_t)&(((CMS_AuthenticatedData *)0)->authAttrs), "authAttrs", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_AuthenticatedData *)0)->mac), "mac", (ASN1_OCTET_STRING_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1 << 1)|(0x1)), (3), (size_t)&(((CMS_AuthenticatedData *)0)->unauthAttrs), "unauthAttrs", (X509_ALGOR_it) }
} ; static const ASN1_ITEM * CMS_AuthenticatedData_it(void) { static const ASN1_ITEM local_it = { 0x6, 16, CMS_AuthenticatedData_seq_tt, sizeof(CMS_AuthenticatedData_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_AuthenticatedData), "CMS_AuthenticatedData" }; return &local_it; }
static const ASN1_TEMPLATE CMS_CompressedData_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_CompressedData *)0)->version), "version", (LONG_it) },
{ (0), (0), (size_t)&(((CMS_CompressedData *)0)->compressionAlgorithm), "compressionAlgorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((CMS_CompressedData *)0)->encapContentInfo), "encapContentInfo", (CMS_EncapsulatedContentInfo_it) },
} ; const ASN1_ITEM * CMS_CompressedData_it(void) { static const ASN1_ITEM local_it = { 0x6, 16, CMS_CompressedData_seq_tt, sizeof(CMS_CompressedData_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_CompressedData), "CMS_CompressedData" }; return &local_it; }
static const ASN1_TEMPLATE cms_default_tt = { ((0x2 << 3)|(0x2<<6) | 0), (0), (size_t)&(((CMS_ContentInfo *)0)->d.other), "d.other", (ASN1_ANY_it) };
static const ASN1_ADB_TABLE CMS_ContentInfo_adbtbl[] = {
{21, { ((0x2 << 3)|(0x2<<6) | (0x1<<11)), (0), (size_t)&(((CMS_ContentInfo *)0)->d.data), "d.data", (ASN1_OCTET_STRING_NDEF_it) }},
{22, { ((0x2 << 3)|(0x2<<6) | (0x1<<11)), (0), (size_t)&(((CMS_ContentInfo *)0)->d.signedData), "d.signedData", (CMS_SignedData_it) }},
{23, { ((0x2 << 3)|(0x2<<6) | (0x1<<11)), (0), (size_t)&(((CMS_ContentInfo *)0)->d.envelopedData), "d.envelopedData", (CMS_EnvelopedData_it) }},
{25, { ((0x2 << 3)|(0x2<<6) | (0x1<<11)), (0), (size_t)&(((CMS_ContentInfo *)0)->d.digestedData), "d.digestedData", (CMS_DigestedData_it) }},
{26, { ((0x2 << 3)|(0x2<<6) | (0x1<<11)), (0), (size_t)&(((CMS_ContentInfo *)0)->d.encryptedData), "d.encryptedData", (CMS_EncryptedData_it) }},
{205, { ((0x2 << 3)|(0x2<<6) | (0x1<<11)), (0), (size_t)&(((CMS_ContentInfo *)0)->d.authenticatedData), "d.authenticatedData", (CMS_AuthenticatedData_it) }},
{786, { ((0x2 << 3)|(0x2<<6) | (0x1<<11)), (0), (size_t)&(((CMS_ContentInfo *)0)->d.compressedData), "d.compressedData", (CMS_CompressedData_it) }},
} ; static const ASN1_ITEM *CMS_ContentInfo_adb(void) { static const ASN1_ADB internal_adb = { 0, (size_t)&(((CMS_ContentInfo *)0)->contentType), 0, CMS_ContentInfo_adbtbl, sizeof(CMS_ContentInfo_adbtbl) / sizeof(ASN1_ADB_TABLE), &cms_default_tt, ((void *)0) }; return (const ASN1_ITEM *) &internal_adb; } void dummy_function(void);
...
static const ASN1_AUX CMS_ContentInfo_aux = {((void *)0), 0, 0, 0, cms_cb, 0}; static const ASN1_TEMPLATE CMS_ContentInfo_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_ContentInfo *)0)->contentType), "contentType", (ASN1_OBJECT_it) },
{ (0x1<<8), -1, 0, "CMS_ContentInfo", CMS_ContentInfo_adb }
} ; const ASN1_ITEM * CMS_ContentInfo_it(void) { static const ASN1_ITEM local_it = { 0x6, 16, CMS_ContentInfo_seq_tt, sizeof(CMS_ContentInfo_seq_tt) / sizeof(ASN1_TEMPLATE), &CMS_ContentInfo_aux, sizeof(CMS_ContentInfo), "CMS_ContentInfo" }; return &local_it; }
static const ASN1_TEMPLATE CMS_Attributes_Sign_item_tt =
{ ((0x3 << 1)), (0), 0, "CMS_ATTRIBUTES", (X509_ATTRIBUTE_it) }
; const ASN1_ITEM * CMS_Attributes_Sign_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &CMS_Attributes_Sign_item_tt, 0, ((void *)0), 0, "CMS_Attributes_Sign" }; return &local_it; }
static const ASN1_TEMPLATE CMS_Attributes_Verify_item_tt =
{ ((0x2 << 1) | (0x1 << 3) | (0x0<<6)), (17), 0, "CMS_ATTRIBUTES", (X509_ATTRIBUTE_it) }
#line 335 "crypto\\cms\\cms_asn1.c"
; const ASN1_ITEM * CMS_Attributes_Verify_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &CMS_Attributes_Verify_item_tt, 0, ((void *)0), 0, "CMS_Attributes_Verify" }; return &local_it; }
static const ASN1_TEMPLATE CMS_ReceiptsFrom_ch_tt[] = {
{ ((0x1 << 3)|(0x2<<6) | 0), (0), (size_t)&(((CMS_ReceiptsFrom *)0)->d.allOrFirstTier), "d.allOrFirstTier", (LONG_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x2 << 1)), (1), (size_t)&(((CMS_ReceiptsFrom *)0)->d.receiptList), "d.receiptList", (GENERAL_NAMES_it) }
} ; static const ASN1_ITEM * CMS_ReceiptsFrom_it(void) { static const ASN1_ITEM local_it = { 0x2, (size_t)&(((CMS_ReceiptsFrom *)0)->type) , CMS_ReceiptsFrom_ch_tt, sizeof(CMS_ReceiptsFrom_ch_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_ReceiptsFrom), "CMS_ReceiptsFrom" }; return &local_it; }
static const ASN1_TEMPLATE CMS_ReceiptRequest_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_ReceiptRequest *)0)->signedContentIdentifier), "signedContentIdentifier", (ASN1_OCTET_STRING_it) },
{ (0), (0), (size_t)&(((CMS_ReceiptRequest *)0)->receiptsFrom), "receiptsFrom", (CMS_ReceiptsFrom_it) },
{ ((0x2 << 1)), (0), (size_t)&(((CMS_ReceiptRequest *)0)->receiptsTo), "receiptsTo", (GENERAL_NAMES_it) }
} ; const ASN1_ITEM * CMS_ReceiptRequest_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_ReceiptRequest_seq_tt, sizeof(CMS_ReceiptRequest_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_ReceiptRequest), "CMS_ReceiptRequest" }; return &local_it; }
static const ASN1_TEMPLATE CMS_Receipt_seq_tt[] = {
{ (0), (0), (size_t)&(((CMS_Receipt *)0)->version), "version", (LONG_it) },
{ (0), (0), (size_t)&(((CMS_Receipt *)0)->contentType), "contentType", (ASN1_OBJECT_it) },
{ (0), (0), (size_t)&(((CMS_Receipt *)0)->signedContentIdentifier), "signedContentIdentifier", (ASN1_OCTET_STRING_it) },
{ (0), (0), (size_t)&(((CMS_Receipt *)0)->originatorSignatureValue), "originatorSignatureValue", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * CMS_Receipt_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_Receipt_seq_tt, sizeof(CMS_Receipt_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_Receipt), "CMS_Receipt" }; return &local_it; }
typedef struct {
X509_ALGOR *keyInfo;
...
{ (0), (0), (size_t)&(((CMS_SharedInfo *)0)->keyInfo), "keyInfo", (X509_ALGOR_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((CMS_SharedInfo *)0)->entityUInfo), "entityUInfo", (ASN1_OCTET_STRING_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (2), (size_t)&(((CMS_SharedInfo *)0)->suppPubInfo), "suppPubInfo", (ASN1_OCTET_STRING_it) },
} ; static const ASN1_ITEM * CMS_SharedInfo_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, CMS_SharedInfo_seq_tt, sizeof(CMS_SharedInfo_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(CMS_SharedInfo), "CMS_SharedInfo" }; return &local_it; }
int CMS_SharedInfo_encode(unsigned char **pder, X509_ALGOR *kekalg,
ASN1_OCTET_STRING *ukm, int keylen)
{
union {
