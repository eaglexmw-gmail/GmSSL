#line 1 "crypto\\pkcs7\\pk7_attr.c"
...
#line 11 "crypto\\pkcs7\\pk7_attr.c"
...
#line 12 "crypto\\pkcs7\\pk7_attr.c"
...
#line 13 "crypto\\pkcs7\\pk7_attr.c"
...
#line 14 "crypto\\pkcs7\\pk7_attr.c"
...
#line 15 "crypto\\pkcs7\\pk7_attr.c"
...
#line 16 "crypto\\pkcs7\\pk7_attr.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/pkcs7.h"
#line 17 "crypto\\pkcs7\\pk7_attr.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/x509.h"
#line 18 "crypto\\pkcs7\\pk7_attr.c"
...
#line 19 "crypto\\pkcs7\\pk7_attr.c"
int PKCS7_add_attrib_smimecap(PKCS7_SIGNER_INFO *si,
struct stack_st_X509_ALGOR *cap)
{
ASN1_STRING *seq;
if ((seq = ASN1_STRING_new()) == ((void *)0)) {
ERR_put_error(33,(118),((1|64)),"crypto\\pkcs7\\pk7_attr.c",26);
return 0;
}
...
if (cap == ((void *)0) || (cap->type != 16))
return ((void *)0);
p = cap->value.sequence->data;
return (struct stack_st_X509_ALGOR *)
ASN1_item_d2i(((void *)0), &p, cap->value.sequence->length,
(X509_ALGORS_it()));
}
int PKCS7_simple_smimecap(struct stack_st_X509_ALGOR *sk, int nid, int arg)
{
ASN1_INTEGER *nbit = ((void *)0);
X509_ALGOR *alg;
if ((alg = X509_ALGOR_new()) == ((void *)0)) {
ERR_put_error(33,(119),((1|64)),"crypto\\pkcs7\\pk7_attr.c",56);
return 0;
}
...
if ((nbit = ASN1_INTEGER_new()) == ((void *)0)) {
goto err;
}
...
return 1;
err:
ERR_put_error(33,(119),((1|64)),"crypto\\pkcs7\\pk7_attr.c",80);
...
ERR_put_error(33,(135),((1|64)),"crypto\\pkcs7\\pk7_attr.c",100);
#line 101 "crypto\\pkcs7\\pk7_attr.c"
return 0;
}
