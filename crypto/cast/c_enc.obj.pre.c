#line 1 "crypto\\cast\\c_enc.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/cast.h"
...
#line 14 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/cast.h"
...
#line 52 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/cast.h"
#line 54 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/cast.h"
#line 11 "crypto\\cast\\c_enc.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\cast\\cast_lcl.h"
...
#line 11 "d:\\07.opensrc\\gmssl\\crypto\\cast\\cast_lcl.h"
...
#line 14 "d:\\07.opensrc\\gmssl\\crypto\\cast\\cast_lcl.h"
#line 15 "d:\\07.opensrc\\gmssl\\crypto\\cast\\cast_lcl.h"
#line 109 "d:\\07.opensrc\\gmssl\\crypto\\cast\\cast_lcl.h"
#line 134 "d:\\07.opensrc\\gmssl\\crypto\\cast\\cast_lcl.h"
#line 156 "d:\\07.opensrc\\gmssl\\crypto\\cast\\cast_lcl.h"
#line 168 "d:\\07.opensrc\\gmssl\\crypto\\cast\\cast_lcl.h"
...
#line 12 "crypto\\cast\\c_enc.c"
void CAST_encrypt(unsigned int *data, const CAST_KEY *key)
{
register unsigned int l, r, t;
const register unsigned int *k;
k = &(key->data[0]);
l = data[0];
r = data[1];
{ unsigned int a,b,c,d; t=(k[0*2] + r)&0xffffffff; t=(_lrotl(t,(k[0*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[1*2] ^ l)&0xffffffff; t=(_lrotl(t,(k[1*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a - b)&0xffffffffL) + c)&0xffffffffL) ^ d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[2*2] - r)&0xffffffff; t=(_lrotl(t,(k[2*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a + b)&0xffffffffL) ^ c)&0xffffffffL) - d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[3*2] + l)&0xffffffff; t=(_lrotl(t,(k[3*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[4*2] ^ r)&0xffffffff; t=(_lrotl(t,(k[4*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a - b)&0xffffffffL) + c)&0xffffffffL) ^ d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[5*2] - l)&0xffffffff; t=(_lrotl(t,(k[5*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a + b)&0xffffffffL) ^ c)&0xffffffffL) - d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[6*2] + r)&0xffffffff; t=(_lrotl(t,(k[6*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[7*2] ^ l)&0xffffffff; t=(_lrotl(t,(k[7*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a - b)&0xffffffffL) + c)&0xffffffffL) ^ d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[8*2] - r)&0xffffffff; t=(_lrotl(t,(k[8*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a + b)&0xffffffffL) ^ c)&0xffffffffL) - d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[9*2] + l)&0xffffffff; t=(_lrotl(t,(k[9*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[10*2] ^ r)&0xffffffff; t=(_lrotl(t,(k[10*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a - b)&0xffffffffL) + c)&0xffffffffL) ^ d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[11*2] - l)&0xffffffff; t=(_lrotl(t,(k[11*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a + b)&0xffffffffL) ^ c)&0xffffffffL) - d)&0xffffffffL; };
if (!key->short_key) {
{ unsigned int a,b,c,d; t=(k[12*2] + r)&0xffffffff; t=(_lrotl(t,(k[12*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[13*2] ^ l)&0xffffffff; t=(_lrotl(t,(k[13*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a - b)&0xffffffffL) + c)&0xffffffffL) ^ d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[14*2] - r)&0xffffffff; t=(_lrotl(t,(k[14*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a + b)&0xffffffffL) ^ c)&0xffffffffL) - d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[15*2] + l)&0xffffffff; t=(_lrotl(t,(k[15*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
}
...
r = data[1];
if (!key->short_key) {
{ unsigned int a,b,c,d; t=(k[15*2] + r)&0xffffffff; t=(_lrotl(t,(k[15*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[14*2] - l)&0xffffffff; t=(_lrotl(t,(k[14*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a + b)&0xffffffffL) ^ c)&0xffffffffL) - d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[13*2] ^ r)&0xffffffff; t=(_lrotl(t,(k[13*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a - b)&0xffffffffL) + c)&0xffffffffL) ^ d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[12*2] + l)&0xffffffff; t=(_lrotl(t,(k[12*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
}
{ unsigned int a,b,c,d; t=(k[11*2] - r)&0xffffffff; t=(_lrotl(t,(k[11*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a + b)&0xffffffffL) ^ c)&0xffffffffL) - d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[10*2] ^ l)&0xffffffff; t=(_lrotl(t,(k[10*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a - b)&0xffffffffL) + c)&0xffffffffL) ^ d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[9*2] + r)&0xffffffff; t=(_lrotl(t,(k[9*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[8*2] - l)&0xffffffff; t=(_lrotl(t,(k[8*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a + b)&0xffffffffL) ^ c)&0xffffffffL) - d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[7*2] ^ r)&0xffffffff; t=(_lrotl(t,(k[7*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a - b)&0xffffffffL) + c)&0xffffffffL) ^ d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[6*2] + l)&0xffffffff; t=(_lrotl(t,(k[6*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[5*2] - r)&0xffffffff; t=(_lrotl(t,(k[5*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a + b)&0xffffffffL) ^ c)&0xffffffffL) - d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[4*2] ^ l)&0xffffffff; t=(_lrotl(t,(k[4*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a - b)&0xffffffffL) + c)&0xffffffffL) ^ d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[3*2] + r)&0xffffffff; t=(_lrotl(t,(k[3*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[2*2] - l)&0xffffffff; t=(_lrotl(t,(k[2*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a + b)&0xffffffffL) ^ c)&0xffffffffL) - d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[1*2] ^ r)&0xffffffff; t=(_lrotl(t,(k[1*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; l^=(((((a - b)&0xffffffffL) + c)&0xffffffffL) ^ d)&0xffffffffL; };
{ unsigned int a,b,c,d; t=(k[0*2] + l)&0xffffffff; t=(_lrotl(t,(k[0*2+1]))); a=CAST_S_table0[(t>> 8)&0xff]; b=CAST_S_table1[(t )&0xff]; c=CAST_S_table2[(t>>24)&0xff]; d=CAST_S_table3[(t>>16)&0xff]; r^=(((((a ^ b)&0xffffffffL) - c)&0xffffffffL) + d)&0xffffffffL; };
data[1] = l & 0xffffffffL;
data[0] = r & 0xffffffffL;
}
void CAST_cbc_encrypt(const unsigned char *in, unsigned char *out,
