#line 1 "crypto\\pkcs12\\p12_npas.c"
...
#line 11 "crypto\\pkcs12\\p12_npas.c"
...
#line 12 "crypto\\pkcs12\\p12_npas.c"
...
#line 13 "crypto\\pkcs12\\p12_npas.c"
...
#line 14 "crypto\\pkcs12\\p12_npas.c"
...
#line 15 "crypto\\pkcs12\\p12_npas.c"
...
#line 16 "crypto\\pkcs12\\p12_npas.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\pkcs12\\p12_lcl.h"
...
#line 17 "crypto\\pkcs12\\p12_npas.c"
static int newpass_p12(PKCS12 *p12, const char *oldpass, const char *newpass);
static int newpass_bags(struct stack_st_PKCS12_SAFEBAG *bags, const char *oldpass,
const char *newpass);
...
{
if (!p12) {
ERR_put_error(35,(128),(105),"crypto\\pkcs12\\p12_npas.c",38);
#line 39 "crypto\\pkcs12\\p12_npas.c"
return 0;
}
if (!PKCS12_verify_mac(p12, oldpass, -1)) {
ERR_put_error(35,(128),(113),"crypto\\pkcs12\\p12_npas.c",45);
return 0;
}
if (!newpass_p12(p12, oldpass, newpass)) {
ERR_put_error(35,(128),(114),"crypto\\pkcs12\\p12_npas.c",50);
return 0;
}
return 1;
}
static int newpass_p12(PKCS12 *p12, const char *oldpass, const char *newpass)
{
struct stack_st_PKCS7 *asafes = ((void *)0), *newsafes = ((void *)0);
struct stack_st_PKCS12_SAFEBAG *bags = ((void *)0);
int i, bagnid, pbe_nid = 0, pbe_iter = 0, pbe_saltlen = 0;
PKCS7 *p7, *p7new;
ASN1_OCTET_STRING *p12_data_tmp = ((void *)0), *macoct = ((void *)0);
unsigned char mac[64];
unsigned int maclen;
int rv = 0;
if ((asafes = PKCS12_unpack_authsafes(p12)) == ((void *)0))
goto err;
if ((newsafes = sk_PKCS7_new_null()) == ((void *)0))
goto err;
...
p7new = PKCS12_pack_p7encdata(pbe_nid, newpass, -1, ((void *)0),
...
if ((p12->authsafes->d.data = ASN1_OCTET_STRING_new()) == ((void *)0))
goto err;
...
if (PKCS12_SAFEBAG_get_nid(bag) != 151)
return 1;
...
{
PBEPARAM *pbe;
pbe = ASN1_TYPE_unpack_sequence((PBEPARAM_it()), alg->parameter);
if (!pbe)
return 0;
