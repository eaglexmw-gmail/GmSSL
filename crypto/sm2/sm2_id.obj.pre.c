...
#line 58 "crypto\\sm2\\sm2_id.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/err.h"
#line 59 "crypto\\sm2\\sm2_id.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/evp.h"
#line 60 "crypto\\sm2\\sm2_id.c"
...
#line 61 "crypto\\sm2\\sm2_id.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/x509.h"
#line 62 "crypto\\sm2\\sm2_id.c"
...
ERR_put_error(16,(280),((3|64)),"crypto\\sm2\\sm2_id.c",79);
return 0;
}
...
if (*outlen < len) {
ERR_put_error(16,(280),(103),"crypto\\sm2\\sm2_id.c",92);
return 0;
}
if (!(bn_ctx = BN_CTX_new())) {
ERR_put_error(16,(280),((1|64)),"crypto\\sm2\\sm2_id.c",97);
goto  end;
}
BN_CTX_start(bn_ctx);
p = BN_CTX_get(bn_ctx);
...
y = BN_CTX_get(bn_ctx);
if (!y) {
ERR_put_error(16,(280),((1|64)),"crypto\\sm2\\sm2_id.c",106);
goto end;
}
memset(out, 0, len);
if (EC_METHOD_get_field_type(EC_GROUP_method_of(group)) == 406) {
if (!EC_GROUP_get_curve_GFp(group, p, x, y, bn_ctx)) {
ERR_put_error(16,(280),(16),"crypto\\sm2\\sm2_id.c",115);
goto end;
}
} else {
if (!EC_GROUP_get_curve_GF2m(group, p, x, y, bn_ctx)) {
ERR_put_error(16,(280),(16),"crypto\\sm2\\sm2_id.c",120);
goto end;
}
}
BN_bn2bin(x, out + nbytes - ((BN_num_bits(x)+7)/8));
out += nbytes;
if (!BN_bn2bin(y, out + nbytes - ((BN_num_bits(y)+7)/8))) {
ERR_put_error(16,(280),(3),"crypto\\sm2\\sm2_id.c",130);
goto end;
}
out += nbytes;
if (EC_METHOD_get_field_type(EC_GROUP_method_of(group)) == 406) {
...
ERR_put_error(16,(280),(16),"crypto\\sm2\\sm2_id.c",139);
goto end;
}
} else {
if (!EC_POINT_get_affine_coordinates_GF2m(group,
EC_GROUP_get0_generator(group), x, y, bn_ctx)) {
ERR_put_error(16,(280),(16),"crypto\\sm2\\sm2_id.c",145);
goto end;
}
}
if (!BN_bn2bin(x, out + nbytes - ((BN_num_bits(x)+7)/8))) {
ERR_put_error(16,(280),(3),"crypto\\sm2\\sm2_id.c",151);
goto end;
}
out += nbytes;
if (!BN_bn2bin(y, out + nbytes - ((BN_num_bits(y)+7)/8))) {
ERR_put_error(16,(280),(3),"crypto\\sm2\\sm2_id.c",157);
goto end;
}
out += nbytes;
if (EC_METHOD_get_field_type(EC_GROUP_method_of(group)) == 406) {
...
ERR_put_error(16,(280),(16),"crypto\\sm2\\sm2_id.c",166);
goto end;
}
} else {
if (!EC_POINT_get_affine_coordinates_GF2m(group,
EC_KEY_get0_public_key(ec_key), x, y, bn_ctx)) {
ERR_put_error(16,(280),(16),"crypto\\sm2\\sm2_id.c",172);
goto end;
}
}
if (!BN_bn2bin(x, out + nbytes - ((BN_num_bits(x)+7)/8))) {
ERR_put_error(16,(280),(3),"crypto\\sm2\\sm2_id.c",178);
goto end;
}
out += nbytes;
if (!BN_bn2bin(y, out + nbytes - ((BN_num_bits(y)+7)/8))) {
ERR_put_error(16,(280),(3),"crypto\\sm2\\sm2_id.c",184);
goto end;
}
*outlen = len;
ret = 1;
...
ERR_put_error(16,(277),((3|64)),"crypto\\sm2\\sm2_id.c",210);
return 0;
}
if (EVP_MD_size(md) != 32) {
ERR_put_error(16,(277),(138),"crypto\\sm2\\sm2_id.c",216);
return 0;
}
#line 220 "crypto\\sm2\\sm2_id.c"
if (strlen(id) != idlen) {
ERR_put_error(16,(277),(161),"crypto\\sm2\\sm2_id.c",222);
return 0;
}
if (idlen > (65535/8) || idlen <= 0) {
ERR_put_error(16,(277),(151),"crypto\\sm2\\sm2_id.c",226);
return 0;
}
if (!out) {
...
ERR_put_error(16,(277),(103),"crypto\\sm2\\sm2_id.c",235);
return 0;
}
size = sizeof(pkdata);
if (!SM2_get_public_key_data(ec_key, pkdata, &size)) {
ERR_put_error(16,(277),(126),"crypto\\sm2\\sm2_id.c",243);
goto end;
}
...
|| !EVP_DigestInit_ex(md_ctx, md, ((void *)0))
...
ERR_put_error(16,(277),(6),"crypto\\sm2\\sm2_id.c",259);
goto end;
}
*outlen = len;
ret = 1;
...
unsigned int outlen;
if (!id_md || !msg_md || !msg || msglen <= 0 || msglen > 2147483647 ||
!id || idlen <= 0 || idlen > 2147483647 || !poutlen || !ec_key) {
ERR_put_error(16,(278),((3|64)),"crypto\\sm2\\sm2_id.c",287);
return 0;
}
if (EVP_MD_size(msg_md) <= 0) {
ERR_put_error(16,(278),(155),"crypto\\sm2\\sm2_id.c",292);
return 0;
}
...
ERR_put_error(16,(278),(103),"crypto\\sm2\\sm2_id.c",301);
return 0;
}
if (!SM2_compute_id_digest(id_md, id, idlen, za, &zalen, ec_key)) {
ERR_put_error(16,(278),(16),"crypto\\sm2\\sm2_id.c",306);
goto end;
}
if (!(md_ctx = EVP_MD_CTX_new())
|| !EVP_DigestInit_ex(md_ctx, msg_md, ((void *)0))
|| !EVP_DigestUpdate(md_ctx, za, zalen)
|| !EVP_DigestUpdate(md_ctx, msg, msglen)
|| !EVP_DigestFinal_ex(md_ctx, out, &outlen)) {
ERR_put_error(16,(278),(6),"crypto\\sm2\\sm2_id.c",316);
goto end;
}
*poutlen = outlen;
ret = 1;
