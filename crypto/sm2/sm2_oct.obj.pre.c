...
#line 53 "crypto\\sm2\\sm2_oct.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/err.h"
#line 54 "crypto\\sm2\\sm2_oct.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/asn1.h"
#line 55 "crypto\\sm2\\sm2_oct.c"
...
#line 56 "crypto\\sm2\\sm2_oct.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/objects.h"
#line 57 "crypto\\sm2\\sm2_oct.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/obj_mac.h"
#line 58 "crypto\\sm2\\sm2_oct.c"
...
size_t siz;
if (!group || !cv || !pout) {
ERR_put_error(66,(107),((3|64)),"crypto\\sm2\\sm2_oct.c",73);
#line 74 "crypto\\sm2\\sm2_oct.c"
return 0;
}
nbytes = (EC_GROUP_get_degree(group) + 7)/8;
if (!cv->xCoordinate || ((BN_num_bits(cv->xCoordinate)+7)/8) > nbytes
|| !cv->yCoordinate || ((BN_num_bits(cv->yCoordinate)+7)/8) > nbytes
|| ASN1_STRING_length(cv->hash) <= 0
|| ASN1_STRING_length(cv->hash) > 64
|| ASN1_STRING_length(cv->ciphertext) <= 0) {
ERR_put_error(66,(107),(103),"crypto\\sm2\\sm2_oct.c",84);
return 0;
}
if (*pout) {
p = *pout;
...
if (!(buf = CRYPTO_malloc(buflen, "crypto\\sm2\\sm2_oct.c", 97))) {
ERR_put_error(66,(107),((1|64)),"crypto\\sm2\\sm2_oct.c",99);
#line 100 "crypto\\sm2\\sm2_oct.c"
return 0;
}
p = buf;
}
if (!(point = EC_POINT_new(group)) || !(bn_ctx = BN_CTX_new())) {
ERR_put_error(66,(107),((1|64)),"crypto\\sm2\\sm2_oct.c",108);
goto end;
}
...
ERR_put_error(66,(107),(16),"crypto\\sm2\\sm2_oct.c",126);
goto end;
}
(void)((siz == 1 + 2 * nbytes) ? 0 : (OPENSSL_die("assertion failed: " "siz == 1 + 2 * nbytes", "crypto\\sm2\\sm2_oct.c", 129), 1));
p += siz;
outlen += siz;
...
int nbytes;
if (!group || !pin) {
ERR_put_error(66,(108),((3|64)),"crypto\\sm2\\sm2_oct.c",173);
#line 174 "crypto\\sm2\\sm2_oct.c"
return ((void *)0);
}
nbytes = (EC_GROUP_get_degree(group) + 7)/8;
if (len <= 1 + nbytes * 2 + EVP_MD_size(md)) {
ERR_put_error(66,(108),(103),"crypto\\sm2\\sm2_oct.c",181);
#line 182 "crypto\\sm2\\sm2_oct.c"
return ((void *)0);
}
if (pout && *pout) {
cv = *pout;
...
ERR_put_error(66,(108),((1|64)),"crypto\\sm2\\sm2_oct.c",190);
#line 191 "crypto\\sm2\\sm2_oct.c"
goto end;
}
}
if (!(point = EC_POINT_new(group))
|| !(bn_ctx = BN_CTX_new())) {
ERR_put_error(66,(108),((1|64)),"crypto\\sm2\\sm2_oct.c",198);
#line 199 "crypto\\sm2\\sm2_oct.c"
goto end;
}
p = *pin;
if (!EC_POINT_oct2point(group, point, p, 1 + nbytes * 2, bn_ctx)) {
ERR_put_error(66,(108),(103),"crypto\\sm2\\sm2_oct.c",207);
#line 208 "crypto\\sm2\\sm2_oct.c"
goto end;
}
p += 1 + nbytes * 2;
len -= 1 + nbytes * 2;
...
ERR_put_error(66,(108),((1|64)),"crypto\\sm2\\sm2_oct.c",216);
#line 217 "crypto\\sm2\\sm2_oct.c"
goto end;
}
}
if (!cv->yCoordinate) {
if (!(cv->yCoordinate = BN_new())) {
ERR_put_error(66,(108),((1|64)),"crypto\\sm2\\sm2_oct.c",223);
#line 224 "crypto\\sm2\\sm2_oct.c"
goto end;
}
}
if (EC_METHOD_get_field_type(EC_GROUP_method_of(group)) == 406) {
...
cv->xCoordinate, cv->yCoordinate, bn_ctx)) {
ERR_put_error(66,(108),(16),"crypto\\sm2\\sm2_oct.c",231);
goto end;
}
} else {
if (!EC_POINT_get_affine_coordinates_GF2m(group, point,
cv->xCoordinate, cv->yCoordinate, bn_ctx)) {
ERR_put_error(66,(108),(16),"crypto\\sm2\\sm2_oct.c",237);
goto end;
}
}
if (!cv->ciphertext) {
if (!(cv->ciphertext = ASN1_OCTET_STRING_new())) {
ERR_put_error(66,(108),((1|64)),"crypto\\sm2\\sm2_oct.c",246);
#line 247 "crypto\\sm2\\sm2_oct.c"
goto end;
}
}
if (!ASN1_OCTET_STRING_set(cv->ciphertext, p, len - EVP_MD_size(md))) {
ERR_put_error(66,(108),(13),"crypto\\sm2\\sm2_oct.c",252);
goto end;
}
p += len - EVP_MD_size(md);
if (!cv->hash) {
if (!(cv->hash = ASN1_OCTET_STRING_new())) {
ERR_put_error(66,(108),((1|64)),"crypto\\sm2\\sm2_oct.c",261);
#line 262 "crypto\\sm2\\sm2_oct.c"
goto end;
}
}
if (!ASN1_OCTET_STRING_set(cv->hash, p, EVP_MD_size(md))) {
ERR_put_error(66,(108),(13),"crypto\\sm2\\sm2_oct.c",267);
goto end;
}
p += EVP_MD_size(md);
*pin = p;
