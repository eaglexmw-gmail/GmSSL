...
#line 58 "crypto\\sm2\\sm2_enc.c"
SM2CiphertextValue *SM2_do_encrypt(const EVP_MD *md,
const unsigned char *in, size_t inlen, EC_KEY *ec_key)
{
SM2CiphertextValue *ret = ((void *)0);
SM2CiphertextValue *cv = ((void *)0);
const EC_GROUP *group;
const EC_POINT *pub_key;
KDF_FUNC kdf;
EC_POINT *ephem_point = ((void *)0);
EC_POINT *share_point = ((void *)0);
BIGNUM *n = ((void *)0);
BIGNUM *h = ((void *)0);
BIGNUM *k = ((void *)0);
BN_CTX *bn_ctx = ((void *)0);
EVP_MD_CTX *md_ctx = ((void *)0);
unsigned char buf[(661 + 7)/4 + 1];
int nbytes;
size_t len;
size_t i;
unsigned int hashlen;
if (!md || !in || !ec_key) {
ERR_put_error(66,(102),((3|64)),"crypto\\sm2\\sm2_enc.c",83);
return 0;
}
if (inlen <= 0 || inlen > 65535) {
ERR_put_error(66,(102),(107),"crypto\\sm2\\sm2_enc.c",88);
return 0;
}
if (!(kdf = KDF_get_x9_63(md))) {
ERR_put_error(66,(102),(104),"crypto\\sm2\\sm2_enc.c",93);
return 0;
}
if (!(group = EC_KEY_get0_group(ec_key))
|| !(pub_key = EC_KEY_get0_public_key(ec_key))) {
ERR_put_error(66,(102),(105),"crypto\\sm2\\sm2_enc.c",99);
return 0;
}
...
ERR_put_error(66,(102),((1|64)),"crypto\\sm2\\sm2_enc.c",112);
goto end;
}
if (!ASN1_OCTET_STRING_set(cv->ciphertext, ((void *)0), (int)inlen)
|| !ASN1_OCTET_STRING_set(cv->hash, ((void *)0), EVP_MD_size(md))) {
ERR_put_error(66,(102),(13),"crypto\\sm2\\sm2_enc.c",118);
goto end;
}
if (!EC_GROUP_get_order(group, n, bn_ctx)) {
ERR_put_error(16,(279),(123),"crypto\\sm2\\sm2_enc.c",124);
goto end;
}
if (!EC_GROUP_get_cofactor(group, h, bn_ctx)) {
ERR_put_error(16,(279),(123),"crypto\\sm2\\sm2_enc.c",129);
goto end;
}
nbytes = (EC_GROUP_get_degree(group) + 7) / 8;
if (!EC_POINT_mul(group, share_point, ((void *)0), pub_key, h, bn_ctx)) {
ERR_put_error(66,(102),(16),"crypto\\sm2\\sm2_enc.c",137);
goto end;
}
if (EC_POINT_is_at_infinity(group, share_point)) {
ERR_put_error(66,(102),(108),"crypto\\sm2\\sm2_enc.c",142);
goto end;
}
do
{
...
if (!EC_POINT_mul(group, ephem_point, k, ((void *)0), ((void *)0), bn_ctx)) {
ERR_put_error(66,(102),(16),"crypto\\sm2\\sm2_enc.c",157);
goto end;
}
if (!EC_POINT_mul(group, share_point, ((void *)0), pub_key, k, bn_ctx)) {
ERR_put_error(66,(102),(16),"crypto\\sm2\\sm2_enc.c",163);
goto end;
}
if (!(len = EC_POINT_point2oct(group, share_point,
POINT_CONVERSION_UNCOMPRESSED, buf, sizeof(buf), bn_ctx))) {
ERR_put_error(66,(102),(16),"crypto\\sm2\\sm2_enc.c",170);
goto end;
}
size = cv->ciphertext->length;
kdf(buf + 1, len - 1, cv->ciphertext->data, &size);
if (size != inlen) {
ERR_put_error(66,(102),(109),"crypto\\sm2\\sm2_enc.c",177);
goto end;
}
...
ERR_put_error(66,(102),(16),"crypto\\sm2\\sm2_enc.c",188);
goto end;
}
} else {
if (!EC_POINT_get_affine_coordinates_GF2m(group, ephem_point,
cv->xCoordinate, cv->yCoordinate, bn_ctx)) {
ERR_put_error(66,(102),(16),"crypto\\sm2\\sm2_enc.c",194);
goto end;
}
}
for (i = 0; i < inlen; i++) {
...
if (!EVP_DigestInit_ex(md_ctx, md, ((void *)0))
...
ERR_put_error(66,(102),(6),"crypto\\sm2\\sm2_enc.c",211);
goto end;
}
ret = cv;
cv = ((void *)0);
...
SM2CiphertextValue *cv = ((void *)0);
int clen;
if (!(md = EVP_get_digestbyname(OBJ_nid2sn(type)))) {
ERR_put_error(66,(103),(104),"crypto\\sm2\\sm2_enc.c",240);
return 0;
}
if (!(clen = SM2_ciphertext_size(ec_key, inlen))) {
ERR_put_error(66,(103),(66),"crypto\\sm2\\sm2_enc.c",245);
return 0;
}
if (!out) {
*outlen = clen;
...
ERR_put_error(66,(103),(100),"crypto\\sm2\\sm2_enc.c",252);
return 0;
}
RAND_seed(in, inlen);
if (!(cv = SM2_do_encrypt(md, in, inlen, ec_key))) {
ERR_put_error(66,(103),(66),"crypto\\sm2\\sm2_enc.c",258);
*outlen = 0;
return 0;
}
if ((clen = i2d_SM2CiphertextValue(cv, &out)) <= 0) {
ERR_put_error(66,(103),(66),"crypto\\sm2\\sm2_enc.c",264);
goto end;
}
*outlen = clen;
ret = 1;
...
SM2CiphertextValue *cv = ((void *)0);
if (!(md = EVP_get_digestbyname(OBJ_nid2sn(type)))) {
ERR_put_error(66,(100),(104),"crypto\\sm2\\sm2_enc.c",286);
*outlen = 0;
return 0;
}
if (!in) {
ERR_put_error(66,(100),((3|64)),"crypto\\sm2\\sm2_enc.c",292);
*outlen = 0;
return 0;
}
if (inlen <= 0 || inlen > 2147483647) {
ERR_put_error(66,(100),(106),"crypto\\sm2\\sm2_enc.c",297);
*outlen = 0;
return 0;
}
p = in;
if (!(cv = d2i_SM2CiphertextValue(((void *)0), &p, (long)inlen))) {
ERR_put_error(66,(100),(103),"crypto\\sm2\\sm2_enc.c",305);
return 0;
}
if (p != in + inlen) {
ERR_put_error(66,(100),(103),"crypto\\sm2\\sm2_enc.c",309);
goto end;
}
if (!out) {
...
ERR_put_error(66,(100),(101),"crypto\\sm2\\sm2_enc.c",329);
goto end;
}
ret = 1;
end:
...
ERR_put_error(66,(101),((3|64)),"crypto\\sm2\\sm2_enc.c",360);
return 0;
}
if (!(kdf = KDF_get_x9_63(md))) {
ERR_put_error(66,(101),(104),"crypto\\sm2\\sm2_enc.c",365);
return 0;
}
if (!cv->xCoordinate || !cv->yCoordinate || !cv->hash || !cv->ciphertext) {
ERR_put_error(66,(101),(103),"crypto\\sm2\\sm2_enc.c",370);
return 0;
}
if (cv->hash->length != EVP_MD_size(md)) {
ERR_put_error(66,(101),(103),"crypto\\sm2\\sm2_enc.c",375);
return 0;
}
if (cv->ciphertext->length <= 0
|| cv->ciphertext->length > 65535) {
ERR_put_error(66,(101),(103),"crypto\\sm2\\sm2_enc.c",381);
return 0;
}
if (!(group = EC_KEY_get0_group(ec_key))
|| !(pri_key = EC_KEY_get0_private_key(ec_key))) {
ERR_put_error(66,(101),(105),"crypto\\sm2\\sm2_enc.c",387);
return 0;
}
if (!out) {
...
ERR_put_error(66,(101),((1|64)),"crypto\\sm2\\sm2_enc.c",410);
goto end;
}
if (!EC_GROUP_get_order(group, n, bn_ctx)) {
ERR_put_error(66,(101),(16),"crypto\\sm2\\sm2_enc.c",416);
goto end;
}
if (!EC_GROUP_get_cofactor(group, h, bn_ctx)) {
ERR_put_error(66,(101),(16),"crypto\\sm2\\sm2_enc.c",421);
goto end;
}
nbytes = (EC_GROUP_get_degree(group) + 7) / 8;
if (EC_METHOD_get_field_type(EC_GROUP_method_of(group)) == 406) {
...
cv->xCoordinate, cv->yCoordinate, bn_ctx)) {
ERR_put_error(66,(101),(103),"crypto\\sm2\\sm2_enc.c",431);
goto end;
}
} else {
if (!EC_POINT_set_affine_coordinates_GF2m(group, point,
cv->xCoordinate, cv->yCoordinate, bn_ctx)) {
ERR_put_error(66,(101),(103),"crypto\\sm2\\sm2_enc.c",437);
goto end;
}
}
if (!EC_POINT_mul(group, tmp_point, ((void *)0), point, h, bn_ctx)) {
ERR_put_error(66,(101),(16),"crypto\\sm2\\sm2_enc.c",444);
goto end;
}
if (EC_POINT_is_at_infinity(group, tmp_point)) {
ERR_put_error(66,(101),(103),"crypto\\sm2\\sm2_enc.c",449);
goto end;
}
if (!EC_POINT_mul(group, point, ((void *)0), point, pri_key, bn_ctx)) {
ERR_put_error(66,(101),(16),"crypto\\sm2\\sm2_enc.c",455);
goto end;
}
if (!(len = EC_POINT_point2oct(group, point,
POINT_CONVERSION_UNCOMPRESSED, buf, sizeof(buf), bn_ctx))) {
ERR_put_error(66,(101),(16),"crypto\\sm2\\sm2_enc.c",461);
goto end;
}
*outlen = cv->ciphertext->length;
...
ERR_put_error(66,(101),(6),"crypto\\sm2\\sm2_enc.c",481);
goto end;
}
if (OPENSSL_memcmp(cv->hash->data, mac, maclen) != 0) {
ERR_put_error(66,(101),(103),"crypto\\sm2\\sm2_enc.c",486);
goto end;
}
ret = 1;
end:
