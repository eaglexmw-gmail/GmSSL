...
#line 53 "crypto\\sm2\\sm2_exch.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/kdf.h"
#line 54 "crypto\\sm2\\sm2_exch.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\sm2\\sm2_lcl.h"
...
int do_checksum;
EC_KEY *ec_key;
unsigned char id_dgst[64];
unsigned int id_dgstlen;
EC_KEY *remote_pubkey;
unsigned char remote_id_dgst[64];
...
BIGNUM *t;
EC_POINT *point;
unsigned char pt_buf[1 + (661+7)/4];
...
ERR_put_error(16,(282),((3|64)),"crypto\\sm2\\sm2_exch.c",66);
return 0;
}
...
ERR_put_error(16,(282),(3),"crypto\\sm2\\sm2_exch.c",126);
goto end;
}
if (!EC_GROUP_get_order(EC_KEY_get0_group(ec_key), ctx->order, ctx->bn_ctx)) {
ERR_put_error(16,(282),(16),"crypto\\sm2\\sm2_exch.c",131);
goto end;
}
w = (BN_num_bits(ctx->order) + 1)/2 - 1;
if (!(BN_set_word((ctx->two_pow_w),1))) {
ERR_put_error(16,(282),(3),"crypto\\sm2\\sm2_exch.c",138);
goto end;
}
if (!BN_lshift(ctx->two_pow_w, ctx->two_pow_w, w)) {
ERR_put_error(16,(282),(3),"crypto\\sm2\\sm2_exch.c",143);
goto end;
}
if (!(ctx->point = EC_POINT_new(ctx->group))) {
ERR_put_error(16,(282),(16),"crypto\\sm2\\sm2_exch.c",148);
goto end;
}
ret = 1;
end:
...
ERR_put_error(16,(284),(191),"crypto\\sm2\\sm2_exch.c",184);
return 0;
}
h = BN_new();
r = BN_new();
x = BN_new();
if (!h || !r || !x) {
ERR_put_error(16,(284),(0),"crypto\\sm2\\sm2_exch.c",193);
goto end;
}
do {
if (!BN_rand_range(r, ctx->order)) {
ERR_put_error(16,(284),(186),"crypto\\sm2\\sm2_exch.c",204);
goto end;
}
} while (BN_is_zero(r));
if (!EC_POINT_mul(ctx->group, ctx->point, r, ((void *)0), ((void *)0), ctx->bn_ctx)) {
ERR_put_error(16,(284),(16),"crypto\\sm2\\sm2_exch.c",212);
goto end;
}
if (EC_METHOD_get_field_type(EC_GROUP_method_of(ctx->group)) == 406) {
if (!EC_POINT_get_affine_coordinates_GFp(ctx->group, ctx->point, x, ((void *)0), ctx->bn_ctx)) {
ERR_put_error(16,(284),(16),"crypto\\sm2\\sm2_exch.c",219);
goto end;
}
} else {
if (!EC_POINT_get_affine_coordinates_GF2m(ctx->group, ctx->point, x, ((void *)0), ctx->bn_ctx)) {
ERR_put_error(16,(284),(16),"crypto\\sm2\\sm2_exch.c",224);
goto end;
}
}
if (!ctx->t) {
ERR_put_error(16,(284),(191),"crypto\\sm2\\sm2_exch.c",237);
goto end;
}
if (!BN_nnmod(x, x, ctx->two_pow_w, ctx->bn_ctx)) {
ERR_put_error(16,(284),(3),"crypto\\sm2\\sm2_exch.c",242);
goto end;
}
if (!BN_add(x, x, ctx->two_pow_w)) {
ERR_put_error(16,(284),(3),"crypto\\sm2\\sm2_exch.c",247);
goto end;
}
if (!BN_mod_mul(ctx->t, x, r, ctx->order, ctx->bn_ctx)) {
ERR_put_error(16,(284),(3),"crypto\\sm2\\sm2_exch.c",252);
goto end;
}
if (!BN_mod_add(ctx->t, ctx->t, prikey, ctx->order, ctx->bn_ctx)) {
ERR_put_error(16,(284),(3),"crypto\\sm2\\sm2_exch.c",257);
goto end;
}
if (!EC_GROUP_get_cofactor(ctx->group, h, ctx->bn_ctx)) {
ERR_put_error(16,(284),(16),"crypto\\sm2\\sm2_exch.c",262);
goto end;
}
if (!BN_mul(ctx->t, ctx->t, h, ctx->bn_ctx)) {
ERR_put_error(16,(284),(3),"crypto\\sm2\\sm2_exch.c",267);
goto end;
}
...
BIGNUM *x = ((void *)0);
unsigned char share_pt_buf[1 + (661+7)/4 + 64 * 2 + 100];
unsigned char remote_pt_buf[1 + (661+7)/4 + 111];
...
x = BN_new();
if (!md_ctx || !x) {
ERR_put_error(16,(281),(0),"crypto\\sm2\\sm2_exch.c",307);
goto end;
}
if (!EC_POINT_oct2point(ctx->group, ctx->point,
remote_point, remote_point_len, ctx->bn_ctx)) {
ERR_put_error(16,(281),(0),"crypto\\sm2\\sm2_exch.c",320);
goto end;
}
if (!(len = EC_POINT_point2oct(ctx->group, ctx->point, POINT_CONVERSION_UNCOMPRESSED,
remote_pt_buf, sizeof(remote_pt_buf), ctx->bn_ctx))) {
ERR_put_error(16,(281),(0),"crypto\\sm2\\sm2_exch.c",326);
goto end;
}
if (EC_METHOD_get_field_type(EC_GROUP_method_of(ctx->group)) == 406) {
if (!EC_POINT_get_affine_coordinates_GFp(ctx->group, ctx->point, x, ((void *)0), ctx->bn_ctx)) {
ERR_put_error(16,(281),(16),"crypto\\sm2\\sm2_exch.c",332);
goto end;
}
} else {
if (!EC_POINT_get_affine_coordinates_GF2m(ctx->group, ctx->point, x, ((void *)0), ctx->bn_ctx)) {
ERR_put_error(16,(281),(16),"crypto\\sm2\\sm2_exch.c",337);
goto end;
}
}
if (!BN_nnmod(x, x, ctx->two_pow_w, ctx->bn_ctx)) {
ERR_put_error(16,(281),(3),"crypto\\sm2\\sm2_exch.c",345);
goto end;
}
if (!BN_add(x, x, ctx->two_pow_w)) {
ERR_put_error(16,(281),(3),"crypto\\sm2\\sm2_exch.c",350);
goto end;
}
if (!EC_POINT_mul(ctx->group, ctx->point, ((void *)0), ctx->point, x, ctx->bn_ctx)) {
ERR_put_error(16,(281),(16),"crypto\\sm2\\sm2_exch.c",364);
goto end;
}
if (!EC_POINT_add(ctx->group, ctx->point, ctx->point,
EC_KEY_get0_public_key(ctx->remote_pubkey), ctx->bn_ctx)) {
ERR_put_error(16,(281),(16),"crypto\\sm2\\sm2_exch.c",370);
goto end;
}
if (!EC_POINT_mul(ctx->group, ctx->point, ((void *)0), ctx->point, ctx->t, ctx->bn_ctx)) {
ERR_put_error(16,(281),(16),"crypto\\sm2\\sm2_exch.c",375);
goto end;
}
if (EC_POINT_is_at_infinity(ctx->group, ctx->point)) {
ERR_put_error(16,(281),(0),"crypto\\sm2\\sm2_exch.c",380);
goto end;
}
if (!(len = EC_POINT_point2oct(ctx->group, ctx->point, POINT_CONVERSION_UNCOMPRESSED,
share_pt_buf, sizeof(share_pt_buf), ctx->bn_ctx))) {
ERR_put_error(16,(281),(0),"crypto\\sm2\\sm2_exch.c",388);
goto end;
}
if (ctx->is_initiator) {
...
ERR_put_error(16,(281),(0),"crypto\\sm2\\sm2_exch.c",408);
goto end;
}
if (ctx->do_checksum) {
if (!EVP_DigestInit_ex(md_ctx, ctx->checksum_md, ((void *)0))) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",418);
goto end;
}
bnlen = ((BN_num_bits(ctx->order)+7)/8);
if (!EVP_DigestUpdate(md_ctx, share_pt_buf + 1, bnlen)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",425);
goto end;
}
if (ctx->is_initiator) {
if (!EVP_DigestUpdate(md_ctx, ctx->id_dgst, ctx->id_dgstlen)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",433);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, ctx->remote_id_dgst, ctx->remote_id_dgstlen)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",437);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, ctx->pt_buf + 1, bnlen * 2)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",441);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, remote_pt_buf + 1, bnlen * 2)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",445);
goto end;
}
} else {
if (!EVP_DigestUpdate(md_ctx, ctx->remote_id_dgst, ctx->remote_id_dgstlen)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",452);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, ctx->id_dgst, ctx->id_dgstlen)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",456);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, remote_pt_buf + 1, bnlen * 2)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",460);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, ctx->pt_buf + 1, bnlen * 2)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",464);
goto end;
}
}
if (!EVP_DigestFinal_ex(md_ctx, dgst, &dgstlen)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",470);
goto end;
}
if (!EVP_DigestInit_ex(md_ctx, ctx->checksum_md, ((void *)0))) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",479);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, "\x02", 1)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",484);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, share_pt_buf + 1 + bnlen, bnlen)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",489);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, dgst, dgstlen)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",494);
goto end;
}
if (ctx->is_initiator) {
if (!EVP_DigestFinal_ex(md_ctx, ctx->checksum, &len)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",501);
goto end;
}
} else {
if (!EVP_DigestFinal_ex(md_ctx, checksum, &len)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",507);
goto end;
}
*checksumlen = len;
}
if (!EVP_DigestInit_ex(md_ctx, ctx->checksum_md, ((void *)0))) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",518);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, "\x03", 1)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",523);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, share_pt_buf + 1 + bnlen, bnlen)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",528);
goto end;
}
if (!EVP_DigestUpdate(md_ctx, dgst, dgstlen)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",533);
goto end;
}
if (ctx->is_initiator) {
if (!EVP_DigestFinal_ex(md_ctx, checksum, &len)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",539);
goto end;
}
*checksumlen = len;
} else {
if (!EVP_DigestFinal_ex(md_ctx, ctx->checksum, &len)) {
ERR_put_error(16,(281),(6),"crypto\\sm2\\sm2_exch.c",546);
goto end;
}
}
}
...
ERR_put_error(16,(283),(162),"crypto\\sm2\\sm2_exch.c",567);
return 0;
}
if (memcmp(ctx->checksum, checksum, checksumlen)) {
ERR_put_error(16,(283),(163),"crypto\\sm2\\sm2_exch.c",571);
return 0;
}
}
return 1;
