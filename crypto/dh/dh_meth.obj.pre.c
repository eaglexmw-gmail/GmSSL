#line 1 "crypto\\dh\\dh_meth.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\dh\\dh_locl.h"
...
#line 11 "d:\\07.opensrc\\gmssl\\crypto\\dh\\dh_locl.h"
struct dh_st {
int pad;
int version;
BIGNUM *p;
...
#line 13 "crypto\\dh\\dh_meth.c"
DH_METHOD *DH_meth_new(const char *name, int flags)
{
DH_METHOD *dhm = CRYPTO_zalloc(sizeof(*dhm), "crypto\\dh\\dh_meth.c", 16);
if (dhm != ((void *)0)) {
dhm->flags = flags;
dhm->name = CRYPTO_strdup(name, "crypto\\dh\\dh_meth.c", 21);
if (dhm->name != ((void *)0))
return dhm;
CRYPTO_free(dhm, "crypto\\dh\\dh_meth.c", 25);
}
ERR_put_error(5,(118),((1|64)),"crypto\\dh\\dh_meth.c",28);
return ((void *)0);
}
void DH_meth_free(DH_METHOD *dhm)
{
if (dhm != ((void *)0)) {
CRYPTO_free(dhm->name, "crypto\\dh\\dh_meth.c", 35);
CRYPTO_free(dhm, "crypto\\dh\\dh_meth.c", 36);
}
}
DH_METHOD *DH_meth_dup(const DH_METHOD *dhm)
{
DH_METHOD *ret = CRYPTO_malloc(sizeof(*ret), "crypto\\dh\\dh_meth.c", 42);
if (ret != ((void *)0)) {
memcpy(ret, dhm, sizeof(*dhm));
ret->name = CRYPTO_strdup(dhm->name, "crypto\\dh\\dh_meth.c", 47);
if (ret->name != ((void *)0))
return ret;
CRYPTO_free(ret, "crypto\\dh\\dh_meth.c", 51);
}
ERR_put_error(5,(117),((1|64)),"crypto\\dh\\dh_meth.c",54);
return ((void *)0);
}
const char *DH_meth_get0_name(const DH_METHOD *dhm)
{
...
int DH_meth_set1_name(DH_METHOD *dhm, const char *name)
{
char *tmpname = CRYPTO_strdup(name, "crypto\\dh\\dh_meth.c", 65);
if (tmpname == ((void *)0)) {
ERR_put_error(5,(119),((1|64)),"crypto\\dh\\dh_meth.c",68);
return 0;
}
CRYPTO_free(dhm->name, "crypto\\dh\\dh_meth.c", 72);
dhm->name = tmpname;
return 1;
}
int DH_meth_get_flags(DH_METHOD *dhm)
