#line 1 "crypto\\dsa\\dsa_meth.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\dsa\\dsa_locl.h"
...
#line 11 "d:\\07.opensrc\\gmssl\\crypto\\dsa\\dsa_locl.h"
struct dsa_st
{
    int pad;
    long version;
...
#line 21 "crypto\\dsa\\dsa_meth.c"
DSA_METHOD *DSA_meth_new(const char *name, int flags)
{
    DSA_METHOD *dsam = CRYPTO_zalloc(sizeof(*dsam), "crypto\\dsa\\dsa_meth.c", 24);
    if (dsam != ((void *)0))
    {
        dsam->flags = flags;
        dsam->name = CRYPTO_strdup(name, "crypto\\dsa\\dsa_meth.c", 29);
        if (dsam->name != ((void *)0))
            return dsam;
        CRYPTO_free(dsam, "crypto\\dsa\\dsa_meth.c", 33);
    }
    ERR_put_error(10,(128),((1|64)),"crypto\\dsa\\dsa_meth.c",36);
    return ((void *)0);
}
void DSA_meth_free(DSA_METHOD *dsam)
{
    if (dsam != ((void *)0))
    {
        CRYPTO_free(dsam->name, "crypto\\dsa\\dsa_meth.c", 43);
        CRYPTO_free(dsam, "crypto\\dsa\\dsa_meth.c", 44);
    }
}
DSA_METHOD *DSA_meth_dup(const DSA_METHOD *dsam)
{
    DSA_METHOD *ret = CRYPTO_malloc(sizeof(*ret), "crypto\\dsa\\dsa_meth.c", 50);
    if (ret != ((void *)0))
    {
        memcpy(ret, dsam, sizeof(*dsam));
        ret->name = CRYPTO_strdup(dsam->name, "crypto\\dsa\\dsa_meth.c", 55);
        if (ret->name != ((void *)0))
            return ret;
        CRYPTO_free(ret, "crypto\\dsa\\dsa_meth.c", 59);
    }
    ERR_put_error(10,(127),((1|64)),"crypto\\dsa\\dsa_meth.c",62);
    return ((void *)0);
}
const char *DSA_meth_get0_name(const DSA_METHOD *dsam)
{
...
int DSA_meth_set1_name(DSA_METHOD *dsam, const char *name)
{
    char *tmpname = CRYPTO_strdup(name, "crypto\\dsa\\dsa_meth.c", 73);
    if (tmpname == ((void *)0))
    {
        ERR_put_error(10,(129),((1|64)),"crypto\\dsa\\dsa_meth.c",76);
        return 0;
    }
    CRYPTO_free(dsam->name, "crypto\\dsa\\dsa_meth.c", 80);
    dsam->name = tmpname;
    return 1;
}
int DSA_meth_get_flags(DSA_METHOD *dsam)
