...
#line 56 "crypto\\otp\\otp_lib.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/crypto.h"
#line 57 "crypto\\otp\\otp_lib.c"
...
#line 59 "crypto\\otp\\otp_lib.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/e_os2.h"
#line 60 "crypto\\otp\\otp_lib.c"
...
#line 61 "crypto\\otp\\otp_lib.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
...
#line 13 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
typedef __int64 i64;
typedef unsigned __int64 u64;
#line 27 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
typedef unsigned int u32;
typedef unsigned char u8;
#line 40 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
#line 41 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
#line 77 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
#pragma intrinsic(_byteswap_uint64,_byteswap_ulong)
#line 87 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
#line 88 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
#line 89 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
#line 96 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
typedef struct {
u64 hi, lo;
} u128;
...
#line 124 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
u128 Htable[16];
void (*gmult) (u64 Xi[2], const u128 Htable[16]);
void (*ghash) (u64 Xi[2], const u128 Htable[16], const u8 *inp,
size_t len);
#line 129 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
...
#line 162 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
#line 164 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
...
#line 188 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
#line 189 "d:\\07.opensrc\\gmssl\\crypto\\otp\\../modes/modes_lcl.h"
#line 62 "crypto\\otp\\otp_lib.c"
...
(params->type != 1148 && params->type != 1150) || 
...
CMAC_CTX *cmctx = ((void *)0);
unsigned char s[64];
size_t slen;
uint32_t od;
int i, n;
(void)((sizeof(time_t) == 8) ? 0 : (OPENSSL_die("assertion failed: " "sizeof(time_t) == 8", "crypto\\otp\\otp_lib.c", 101), 1));
if (!check_params(params)) {
ERR_put_error(57,(100),(100),"crypto\\otp\\otp_lib.c",104);
return 0;
}
...
if (!(id = CRYPTO_malloc(idlen, "crypto\\otp\\otp_lib.c", 112))) {
ERR_put_error(57,(100),((1|64)),"crypto\\otp\\otp_lib.c",113);
goto end;
}
memset(id, 0, idlen);
t = time(((void *)0)) + params->offset;
t /= params->te;
memcpy(id, &t, sizeof(t));
memcpy(id + sizeof(t), event, eventlen);
memcpy(id + sizeof(t) + eventlen, params->option, params->option_size);
if (params->type == 1148) {
md = EVP_get_digestbyname(OBJ_nid2sn(params->type));
if (!(mdctx = EVP_MD_CTX_new())) {
ERR_put_error(57,(100),((1|64)),"crypto\\otp\\otp_lib.c",130);
goto end;
}
if (!EVP_DigestInit_ex(mdctx, md, ((void *)0))) {
ERR_put_error(57,(100),(6),"crypto\\otp\\otp_lib.c",134);
goto end;
}
if (!EVP_DigestUpdate(mdctx, key, keylen)) {
ERR_put_error(57,(100),(6),"crypto\\otp\\otp_lib.c",138);
goto end;
}
if (!EVP_DigestUpdate(mdctx, id, idlen)) {
ERR_put_error(57,(100),(6),"crypto\\otp\\otp_lib.c",142);
goto end;
}
if (!EVP_DigestFinal_ex(mdctx, s, (unsigned int *)&slen)) {
ERR_put_error(57,(100),(6),"crypto\\otp\\otp_lib.c",146);
goto end;
}
} else if (params->type == 1150) {
cipher = EVP_get_cipherbyname(OBJ_nid2sn(params->type));
if (!(cmctx = CMAC_CTX_new())) {
ERR_put_error(57,(100),((1|64)),"crypto\\otp\\otp_lib.c",152);
goto end;
}
if (!CMAC_Init(cmctx, key, keylen, cipher, ((void *)0))) {
ERR_put_error(57,(100),(101),"crypto\\otp\\otp_lib.c",156);
goto end;
}
if (!CMAC_Update(cmctx, id, idlen)) {
ERR_put_error(57,(100),(101),"crypto\\otp\\otp_lib.c",160);
goto end;
}
if (!CMAC_Final(cmctx, s, &slen)) {
ERR_put_error(57,(100),(101),"crypto\\otp\\otp_lib.c",164);
goto end;
}
} else {
goto end;
}
(void)((slen % 4 == 0) ? 0 : (OPENSSL_die("assertion failed: " "slen % 4 == 0", "crypto\\otp\\otp_lib.c", 170), 1));
od = 0;
n = (int)slen;
for (i = 0; i < n/4; i++) {
od += _byteswap_ulong((u32)(*(const u32 *)(&s[i * 4])));
}
*otp = od % pow_table[params->otp_digits];
ret = 1;
end:
CRYPTO_free(id, "crypto\\otp\\otp_lib.c", 182);
