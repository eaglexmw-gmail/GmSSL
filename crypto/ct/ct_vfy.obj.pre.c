...
#line 14 "crypto\\ct\\ct_vfy.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/evp.h"
#line 15 "crypto\\ct\\ct_vfy.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/x509.h"
#line 16 "crypto\\ct\\ct_vfy.c"
...
((p[0]=(unsigned char)(((sct->entry_type)>> 8)&0xff), p[1]=(unsigned char)(((sct->entry_type) )&0xff)),p+=2);
...
return 0;
p = tmpbuf;
((p[0]=(unsigned char)(((derlen)>>16)&0xff), p[1]=(unsigned char)(((derlen)>> 8)&0xff), p[2]=(unsigned char)(((derlen) )&0xff)),p+=3);
...
ERR_put_error(50,(128),(106),"crypto\\ct\\ct_vfy.c",104);
return 0;
}
if (sct->version != SCT_VERSION_V1) {
ERR_put_error(50,(128),(115),"crypto\\ct\\ct_vfy.c",108);
return 0;
}
if (sct->log_id_len != sctx->pkeyhashlen ||
memcmp(sct->log_id, sctx->pkeyhash, sctx->pkeyhashlen) != 0) {
ERR_put_error(50,(128),(114),"crypto\\ct\\ct_vfy.c",113);
return 0;
}
if (sct->timestamp > sctx->epoch_time_in_ms) {
ERR_put_error(50,(128),(116),"crypto\\ct\\ct_vfy.c",117);
return 0;
}
ctx = EVP_MD_CTX_new();
if (ctx == ((void *)0))
...
if (ret == 0)
ERR_put_error(50,(128),(107),"crypto\\ct\\ct_vfy.c",135);
end:
EVP_MD_CTX_free(ctx);
return ret;
}
