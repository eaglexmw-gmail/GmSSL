...
#line 15 "crypto\\ct\\ct_b64.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/evp.h"
#line 16 "crypto\\ct\\ct_b64.c"
...
outlen = (inlen / 4) * 3;
outbuf = CRYPTO_malloc(outlen, "crypto\\ct\\ct_b64.c", 36);
if (outbuf == ((void *)0)) {
ERR_put_error(50,(124),((1|64)),"crypto\\ct\\ct_b64.c",38);
goto err;
}
outlen = EVP_DecodeBlock(outbuf, (unsigned char *)in, inlen);
if (outlen < 0) {
ERR_put_error(50,(124),(108),"crypto\\ct\\ct_b64.c",44);
goto err;
}
while (in[--inlen] == '=') {
--outlen;
...
return outlen;
err:
CRYPTO_free(outbuf, "crypto\\ct\\ct_b64.c", 56);
return -1;
}
...
int declen;
if (sct == ((void *)0)) {
ERR_put_error(50,(127),((1|64)),"crypto\\ct\\ct_b64.c",71);
return ((void *)0);
}
if (!SCT_set_version(sct, version)) {
ERR_put_error(50,(127),(115),"crypto\\ct\\ct_b64.c",80);
goto err;
}
declen = ct_base64_decode(logid_base64, &dec);
if (declen < 0) {
ERR_put_error(50,(127),(118),"crypto\\ct\\ct_b64.c",86);
goto err;
}
...
if (declen < 0) {
ERR_put_error(50,(127),(118),"crypto\\ct\\ct_b64.c",95);
goto err;
}
...
if (declen < 0) {
ERR_put_error(50,(127),(118),"crypto\\ct\\ct_b64.c",103);
goto err;
}
p = dec;
if (o2i_SCT_signature(sct, &p, declen) <= 0)
goto err;
CRYPTO_free(dec, "crypto\\ct\\ct_b64.c", 110);
dec = ((void *)0);
...
return sct;
err:
CRYPTO_free(dec, "crypto\\ct\\ct_b64.c", 121);
SCT_free(sct);
return ((void *)0);
}
...
if (ct_log == ((void *)0)) {
ERR_put_error(50,(118),((7)),"crypto\\ct\\ct_b64.c",140);
return 0;
}
if (pkey_der_len <= 0) {
ERR_put_error(50,(118),(110),"crypto\\ct\\ct_b64.c",145);
return 0;
}
p = pkey_der;
pkey = d2i_PUBKEY(((void *)0), &p, pkey_der_len);
CRYPTO_free(pkey_der, "crypto\\ct\\ct_b64.c", 151);
if (pkey == ((void *)0)) {
ERR_put_error(50,(118),(110),"crypto\\ct\\ct_b64.c",153);
return 0;
}
