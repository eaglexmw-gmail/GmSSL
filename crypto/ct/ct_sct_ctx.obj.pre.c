...
#line 15 "crypto\\ct\\ct_sct_ctx.c"
...
#line 16 "crypto\\ct\\ct_sct_ctx.c"
...
#line 17 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/err.h"
...
#line 18 "crypto\\ct\\ct_sct_ctx.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/obj_mac.h"
#line 19 "crypto\\ct\\ct_sct_ctx.c"
...
#line 20 "crypto\\ct\\ct_sct_ctx.c"
...
#line 22 "crypto\\ct\\ct_sct_ctx.c"
SCT_CTX *SCT_CTX_new(void)
{
SCT_CTX *sctx = CRYPTO_zalloc(sizeof(*sctx), "crypto\\ct\\ct_sct_ctx.c", 25);
if (sctx == ((void *)0))
ERR_put_error(50,(126),((1|64)),"crypto\\ct\\ct_sct_ctx.c",28);
return sctx;
}
void SCT_CTX_free(SCT_CTX *sctx)
{
...
CRYPTO_free(sctx->pkeyhash, "crypto\\ct\\ct_sct_ctx.c", 38);
CRYPTO_free(sctx->ihash, "crypto\\ct\\ct_sct_ctx.c", 39);
CRYPTO_free(sctx->certder, "crypto\\ct\\ct_sct_ctx.c", 40);
CRYPTO_free(sctx->preder, "crypto\\ct\\ct_sct_ctx.c", 41);
CRYPTO_free(sctx, "crypto\\ct\\ct_sct_ctx.c", 42);
}
...
if (presigner == ((void *)0))
return 1;
preidx = ct_x509_get_ext(presigner, 90,
&pre_akid_ext_is_dup);
certidx = ct_x509_get_ext(cert, 90,
...
if (preext == ((void *)0) || certext == ((void *)0))
return 0;
preextdata = X509_EXTENSION_get_data(preext);
if (preextdata == ((void *)0) ||
...
int poison_idx = ct_x509_get_ext(cert, 952, &poison_ext_is_dup);
...
idx = ct_x509_get_ext(cert, 951, &sct_ext_is_dup);
if (sct_ext_is_dup)
goto err;
...
X509_free(pretmp);
CRYPTO_free(sctx->certder, "crypto\\ct\\ct_sct_ctx.c", 178);
sctx->certder = certder;
sctx->certderlen = certderlen;
CRYPTO_free(sctx->preder, "crypto\\ct\\ct_sct_ctx.c", 182);
sctx->preder = preder;
sctx->prederlen = prederlen;
return 1;
err:
CRYPTO_free(certder, "crypto\\ct\\ct_sct_ctx.c", 188);
CRYPTO_free(preder, "crypto\\ct\\ct_sct_ctx.c", 189);
X509_free(pretmp);
return 0;
}
...
{
int ret = 0;
unsigned char *md = ((void *)0), *der = ((void *)0);
int der_len;
unsigned int md_len;
if (*hash != ((void *)0) && *hash_len >= 32) {
md = *hash;
} else {
md = CRYPTO_malloc(32, "crypto\\ct\\ct_sct_ctx.c", 206);
if (md == ((void *)0))
goto err;
}
...
if (der_len <= 0)
goto err;
if (!EVP_Digest(der, der_len, md, &md_len, EVP_sha256(), ((void *)0)))
goto err;
if (md != *hash) {
CRYPTO_free(*hash, "crypto\\ct\\ct_sct_ctx.c", 220);
*hash = md;
*hash_len = 32;
}
md = ((void *)0);
ret = 1;
err:
CRYPTO_free(md, "crypto\\ct\\ct_sct_ctx.c", 228);
CRYPTO_free(der, "crypto\\ct\\ct_sct_ctx.c", 229);
return ret;
}
int SCT_CTX_set1_issuer(SCT_CTX *sctx, const X509 *issuer)
{
