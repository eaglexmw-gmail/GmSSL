...
#line 19 "crypto\\ct\\ct_policy.c"
static const time_t SCT_CLOCK_DRIFT_TOLERANCE = 300;
CT_POLICY_EVAL_CTX *CT_POLICY_EVAL_CTX_new(void)
{
CT_POLICY_EVAL_CTX *ctx = CRYPTO_zalloc(sizeof(CT_POLICY_EVAL_CTX), "crypto\\ct\\ct_policy.c", 30);
if (ctx == ((void *)0)) {
ERR_put_error(50,(133),((1|64)),"crypto\\ct\\ct_policy.c",33);
return ((void *)0);
}
...
CRYPTO_free(ctx, "crypto\\ct\\ct_policy.c", 50);
}
int CT_POLICY_EVAL_CTX_set1_cert(CT_POLICY_EVAL_CTX *ctx, X509 *cert)
{
if (!X509_up_ref(cert))
