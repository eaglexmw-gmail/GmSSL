...
#line 16 "crypto\\ct\\ct_sct.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/evp.h"
#line 17 "crypto\\ct\\ct_sct.c"
...
#line 18 "crypto\\ct\\ct_sct.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/x509.h"
#line 19 "crypto\\ct\\ct_sct.c"
...
#line 21 "crypto\\ct\\ct_sct.c"
SCT *SCT_new(void)
{
SCT *sct = CRYPTO_zalloc(sizeof(*sct), "crypto\\ct\\ct_sct.c", 24);
if (sct == ((void *)0)) {
ERR_put_error(50,(100),((1|64)),"crypto\\ct\\ct_sct.c",27);
return ((void *)0);
}
...
if (sct == ((void *)0))
return;
CRYPTO_free(sct->log_id, "crypto\\ct\\ct_sct.c", 41);
CRYPTO_free(sct->ext, "crypto\\ct\\ct_sct.c", 42);
CRYPTO_free(sct->sig, "crypto\\ct\\ct_sct.c", 43);
CRYPTO_free(sct->sct, "crypto\\ct\\ct_sct.c", 44);
CRYPTO_free(sct, "crypto\\ct\\ct_sct.c", 45);
}
void SCT_LIST_free(struct stack_st_SCT *a)
{
...
ERR_put_error(50,(104),(103),"crypto\\ct\\ct_sct.c",56);
return 0;
}
sct->version = version;
...
return 1;
default:
ERR_put_error(50,(102),(102),"crypto\\ct\\ct_sct.c",74);
return 0;
}
}
int SCT_set0_log_id(SCT *sct, unsigned char *log_id, size_t log_id_len)
{
if (sct->version == SCT_VERSION_V1 && log_id_len != 32) {
ERR_put_error(50,(101),(100),"crypto\\ct\\ct_sct.c",82);
return 0;
}
CRYPTO_free(sct->log_id, "crypto\\ct\\ct_sct.c", 86);
sct->log_id = log_id;
...
{
if (sct->version == SCT_VERSION_V1 && log_id_len != 32) {
ERR_put_error(50,(115),(100),"crypto\\ct\\ct_sct.c",96);
return 0;
}
CRYPTO_free(sct->log_id, "crypto\\ct\\ct_sct.c", 100);
sct->log_id = ((void *)0);
sct->log_id_len = 0;
sct->validation_status = SCT_VALIDATION_STATUS_NOT_SET;
if (log_id != ((void *)0) && log_id_len > 0) {
sct->log_id = CRYPTO_memdup((log_id), log_id_len, "crypto\\ct\\ct_sct.c", 106);
if (sct->log_id == ((void *)0)) {
ERR_put_error(50,(115),((1|64)),"crypto\\ct\\ct_sct.c",108);
return 0;
}
sct->log_id_len = log_id_len;
}
...
return 1;
default:
ERR_put_error(50,(103),(101),"crypto\\ct\\ct_sct.c",137);
return 0;
}
}
void SCT_set0_extensions(SCT *sct, unsigned char *ext, size_t ext_len)
{
CRYPTO_free(sct->ext, "crypto\\ct\\ct_sct.c", 144);
sct->ext = ext;
sct->ext_len = ext_len;
sct->validation_status = SCT_VALIDATION_STATUS_NOT_SET;
}
...
{
CRYPTO_free(sct->ext, "crypto\\ct\\ct_sct.c", 152);
sct->ext = ((void *)0);
sct->ext_len = 0;
sct->validation_status = SCT_VALIDATION_STATUS_NOT_SET;
if (ext != ((void *)0) && ext_len > 0) {
sct->ext = CRYPTO_memdup((ext), ext_len, "crypto\\ct\\ct_sct.c", 158);
if (sct->ext == ((void *)0)) {
ERR_put_error(50,(114),((1|64)),"crypto\\ct\\ct_sct.c",160);
return 0;
}
sct->ext_len = ext_len;
}
...
void SCT_set0_signature(SCT *sct, unsigned char *sig, size_t sig_len)
{
CRYPTO_free(sct->sig, "crypto\\ct\\ct_sct.c", 170);
sct->sig = sig;
sct->sig_len = sig_len;
sct->validation_status = SCT_VALIDATION_STATUS_NOT_SET;
}
...
{
CRYPTO_free(sct->sig, "crypto\\ct\\ct_sct.c", 178);
sct->sig = ((void *)0);
sct->sig_len = 0;
sct->validation_status = SCT_VALIDATION_STATUS_NOT_SET;
if (sig != ((void *)0) && sig_len > 0) {
sct->sig = CRYPTO_memdup((sig), sig_len, "crypto\\ct\\ct_sct.c", 184);
if (sct->sig == ((void *)0)) {
ERR_put_error(50,(116),((1|64)),"crypto\\ct\\ct_sct.c",186);
return 0;
}
sct->sig_len = sig_len;
}
...
int SCT_signature_is_complete(const SCT *sct)
{
return SCT_get_signature_nid(sct) != 0 &&
...
int SCT_LIST_validate(const struct stack_st_SCT *scts, CT_POLICY_EVAL_CTX *ctx)
{
