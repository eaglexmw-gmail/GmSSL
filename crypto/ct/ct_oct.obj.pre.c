...
#line 21 "crypto\\ct\\ct_oct.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\ct\\ct_locl.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/ct.h"
#line 12 "d:\\07.opensrc\\gmssl\\crypto\\ct\\ct_locl.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/evp.h"
#line 13 "d:\\07.opensrc\\gmssl\\crypto\\ct\\ct_locl.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/x509.h"
#line 14 "d:\\07.opensrc\\gmssl\\crypto\\ct\\ct_locl.h"
...
#line 15 "d:\\07.opensrc\\gmssl\\crypto\\ct\\ct_locl.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/safestack.h"
#line 16 "d:\\07.opensrc\\gmssl\\crypto\\ct\\ct_locl.h"
struct sct_st {
...
ERR_put_error(50,(112),(103),"crypto\\ct\\ct_oct.c",31);
return -1;
}
if (len <= 4) {
ERR_put_error(50,(112),(107),"crypto\\ct\\ct_oct.c",42);
return -1;
}
p = *in;
sct->hash_alg = *p++;
...
ERR_put_error(50,(112),(107),"crypto\\ct\\ct_oct.c",51);
return -1;
}
((siglen=(((unsigned int)((p)[0]))<< 8)| (((unsigned int)((p)[1])) )),p+=2);
len_remaining -= (p - *in);
if (siglen > len_remaining) {
ERR_put_error(50,(112),(107),"crypto\\ct\\ct_oct.c",58);
return -1;
}
...
const unsigned char *p;
if (len == 0 || len > 65535) {
ERR_put_error(50,(110),(104),"crypto\\ct\\ct_oct.c",76);
goto err;
}
...
size_t len2;
if (len < 43) {
ERR_put_error(50,(110),(104),"crypto\\ct\\ct_oct.c",99);
goto err;
}
len -= 43;
p++;
sct->log_id = CRYPTO_memdup((p), 32, "crypto\\ct\\ct_oct.c", 104);
if (sct->log_id == ((void *)0))
goto err;
sct->log_id_len = 32;
p += 32;
(sct->timestamp =((uint64_t)(*((p)++)))<<56, sct->timestamp|=((uint64_t)(*((p)++)))<<48, sct->timestamp|=((uint64_t)(*((p)++)))<<40, sct->timestamp|=((uint64_t)(*((p)++)))<<32, sct->timestamp|=((uint64_t)(*((p)++)))<<24, sct->timestamp|=((uint64_t)(*((p)++)))<<16, sct->timestamp|=((uint64_t)(*((p)++)))<< 8, sct->timestamp|=((uint64_t)(*((p)++))));
((len2=(((unsigned int)((p)[0]))<< 8)| (((unsigned int)((p)[1])) )),p+=2);
if (len < len2) {
ERR_put_error(50,(110),(104),"crypto\\ct\\ct_oct.c",114);
goto err;
}
if (len2 > 0) {
sct->ext = CRYPTO_memdup((p), len2, "crypto\\ct\\ct_oct.c", 118);
if (sct->ext == ((void *)0))
goto err;
}
sct->ext_len = len2;
...
if (sig_len <= 0) {
ERR_put_error(50,(110),(104),"crypto\\ct\\ct_oct.c",128);
goto err;
}
len -= sig_len;
*in = p + len;
} else {
sct->sct = CRYPTO_memdup((p), len, "crypto\\ct\\ct_oct.c", 135);
if (sct->sct == ((void *)0))
goto err;
sct->sct_len = len;
*in = p + len;
...
ERR_put_error(50,(109),(107),"crypto\\ct\\ct_oct.c",159);
goto err;
}
if (sct->version != SCT_VERSION_V1) {
ERR_put_error(50,(109),(103),"crypto\\ct\\ct_oct.c",164);
goto err;
}
len = 4 + sct->sig_len;
if (out != ((void *)0)) {
...
p = CRYPTO_malloc(len, "crypto\\ct\\ct_oct.c", 180);
if (p == ((void *)0)) {
ERR_put_error(50,(109),((1|64)),"crypto\\ct\\ct_oct.c",182);
goto err;
}
*out = p;
}
*p++ = sct->hash_alg;
*p++ = sct->sig_alg;
((p[0]=(unsigned char)(((sct->sig_len)>> 8)&0xff), p[1]=(unsigned char)(((sct->sig_len) )&0xff)),p+=2);
memcpy(p, sct->sig, sct->sig_len);
}
return len;
err:
CRYPTO_free(p, "crypto\\ct\\ct_oct.c", 196);
return -1;
}
int i2o_SCT(const SCT *sct, unsigned char **out)
{
...
ERR_put_error(50,(107),(106),"crypto\\ct\\ct_oct.c",206);
goto err;
}
if (sct->version == SCT_VERSION_V1)
...
p = CRYPTO_malloc(len, "crypto\\ct\\ct_oct.c", 227);
if (p == ((void *)0)) {
ERR_put_error(50,(107),((1|64)),"crypto\\ct\\ct_oct.c",229);
goto err;
}
*out = p;
}
if (sct->version == SCT_VERSION_V1) {
*p++ = sct->version;
memcpy(p, sct->log_id, 32);
p += 32;
(*((p)++)=(unsigned char)(((sct->timestamp)>>56)&0xff), *((p)++)=(unsigned char)(((sct->timestamp)>>48)&0xff), *((p)++)=(unsigned char)(((sct->timestamp)>>40)&0xff), *((p)++)=(unsigned char)(((sct->timestamp)>>32)&0xff), *((p)++)=(unsigned char)(((sct->timestamp)>>24)&0xff), *((p)++)=(unsigned char)(((sct->timestamp)>>16)&0xff), *((p)++)=(unsigned char)(((sct->timestamp)>> 8)&0xff), *((p)++)=(unsigned char)(((sct->timestamp) )&0xff));
((p[0]=(unsigned char)(((sct->ext_len)>> 8)&0xff), p[1]=(unsigned char)(((sct->ext_len) )&0xff)),p+=2);
if (sct->ext_len > 0) {
...
return len;
err:
CRYPTO_free(p, "crypto\\ct\\ct_oct.c", 253);
return -1;
}
struct stack_st_SCT *o2i_SCT_LIST(struct stack_st_SCT **a, const unsigned char **pp,
size_t len)
{
struct stack_st_SCT *sk = ((void *)0);
size_t list_len, sct_len;
if (len < 2 || len > 65535) {
ERR_put_error(50,(111),(105),"crypto\\ct\\ct_oct.c",264);
return ((void *)0);
}
((list_len=(((unsigned int)((*pp)[0]))<< 8)| (((unsigned int)((*pp)[1])) )),*pp+=2);
if (list_len != len - 2) {
ERR_put_error(50,(111),(105),"crypto\\ct\\ct_oct.c",270);
return ((void *)0);
}
...
SCT *sct;
sk = *a;
while ((sct = sk_SCT_pop(sk)) != ((void *)0))
SCT_free(sct);
}
while (list_len > 0) {
SCT *sct;
if (list_len < 2) {
ERR_put_error(50,(111),(105),"crypto\\ct\\ct_oct.c",291);
goto err;
}
((sct_len=(((unsigned int)((*pp)[0]))<< 8)| (((unsigned int)((*pp)[1])) )),*pp+=2);
list_len -= 2;
if (sct_len == 0 || sct_len > list_len) {
ERR_put_error(50,(111),(105),"crypto\\ct\\ct_oct.c",298);
goto err;
}
list_len -= sct_len;
if ((sct = o2i_SCT(((void *)0), pp, sct_len)) == ((void *)0))
goto err;
...
size_t len2;
unsigned char *p = ((void *)0), *p2;
if (pp != ((void *)0)) {
if (*pp == ((void *)0)) {
if ((len = i2o_SCT_LIST(a, ((void *)0))) == -1) {
ERR_put_error(50,(108),(105),"crypto\\ct\\ct_oct.c",330);
return -1;
}
if ((*pp = CRYPTO_malloc(len, "crypto\\ct\\ct_oct.c", 333)) == ((void *)0)) {
ERR_put_error(50,(108),((1|64)),"crypto\\ct\\ct_oct.c",334);
return -1;
}
is_pp_new = 1;
}
...
goto err;
((p2[0]=(unsigned char)(((sct_len)>> 8)&0xff), p2[1]=(unsigned char)(((sct_len) )&0xff)),p2+=2);
} else {
if ((sct_len = i2o_SCT(sk_SCT_value(a, i), ((void *)0))) == -1)
goto err;
}
len2 += 2 + sct_len;
}
...
if (pp != ((void *)0)) {
p = *pp;
((p[0]=(unsigned char)(((len2 - 2)>> 8)&0xff), p[1]=(unsigned char)(((len2 - 2) )&0xff)),p+=2);
if (!is_pp_new)
*pp += len2;
}
return len2;
err:
if (is_pp_new) {
CRYPTO_free(*pp, "crypto\\ct\\ct_oct.c", 370);
*pp = ((void *)0);
}
return -1;
}
...
const unsigned char *p;
p = *pp;
if (d2i_ASN1_OCTET_STRING(&oct, &p, len) == ((void *)0))
return ((void *)0);
p = oct->data;
if ((sk = o2i_SCT_LIST(a, &p, oct->length)) != ((void *)0))
*pp += len;
ASN1_OCTET_STRING_free(oct);
return sk;
}
int i2d_SCT_LIST(const struct stack_st_SCT *a, unsigned char **out)
{
ASN1_OCTET_STRING oct;
int len;
oct.data = ((void *)0);
...
CRYPTO_free(oct.data, "crypto\\ct\\ct_oct.c", 405);
return len;
}
