...
{ in+=l; tin0=tin1=0; switch (l) { case 8: tin1 =((DES_LONG)(*(--(in))))<<24L; case 7: tin1|=((DES_LONG)(*(--(in))))<<16L; case 6: tin1|=((DES_LONG)(*(--(in))))<< 8L; case 5: tin1|=((DES_LONG)(*(--(in)))); case 4: tin0 =((DES_LONG)(*(--(in))))<<24L; case 3: tin0|=((DES_LONG)(*(--(in))))<<16L; case 2: tin0|=((DES_LONG)(*(--(in))))<< 8L; case 1: tin0|=((DES_LONG)(*(--(in)))); } };
tin0 ^= tout0;
tin[0] = tin0;
tin1 ^= tout1;
tin[1] = tin1;
