                     ...
                     DES_key_schedule *ks, int enc)
{
    ...
    (l =((DES_LONG)(*((in)++))), l|=((DES_LONG)(*((in)++)))<< 8L, l|=((DES_LONG)(*((in)++)))<<16L, l|=((DES_LONG)(*((in)++)))<<24L);
    ll[0] = l;
    (l =((DES_LONG)(*((in)++))), l|=((DES_LONG)(*((in)++)))<< 8L, l|=((DES_LONG)(*((in)++)))<<16L, l|=((DES_LONG)(*((in)++)))<<24L);
    ll[1] = l;
