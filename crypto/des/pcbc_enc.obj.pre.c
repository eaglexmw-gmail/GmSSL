...
if (length >= 8) {
(sin0 =((DES_LONG)(*((in)++))) , sin0|=((DES_LONG)(*((in)++)))<< 8L, sin0|=((DES_LONG)(*((in)++)))<<16L, sin0|=((DES_LONG)(*((in)++)))<<24L);
(sin1 =((DES_LONG)(*((in)++))) , sin1|=((DES_LONG)(*((in)++)))<< 8L, sin1|=((DES_LONG)(*((in)++)))<<16L, sin1|=((DES_LONG)(*((in)++)))<<24L);
} else
{ in+=length; sin0=sin1=0; switch (length) { case 8: sin1 =((DES_LONG)(*(--(in))))<<24L; case 7: sin1|=((DES_LONG)(*(--(in))))<<16L; case 6: sin1|=((DES_LONG)(*(--(in))))<< 8L; case 5: sin1|=((DES_LONG)(*(--(in)))); case 4: sin0 =((DES_LONG)(*(--(in))))<<24L; case 3: sin0|=((DES_LONG)(*(--(in))))<<16L; case 2: sin0|=((DES_LONG)(*(--(in))))<< 8L; case 1: sin0|=((DES_LONG)(*(--(in)))); } };
tin[0] = sin0 ^ xor0;
tin[1] = sin1 ^ xor1;
DES_encrypt1((DES_LONG *)tin, schedule, 1);
tout0 = tin[0];
tout1 = tin[1];
xor0 = sin0 ^ tout0;
xor1 = sin1 ^ tout1;
...
tin[0] = sin0;
tin[1] = sin1;
DES_encrypt1((DES_LONG *)tin, schedule, 0);
tout0 = tin[0] ^ xor0;
tout1 = tin[1] ^ xor1;
if (length >= 8) {
(*((out)++)=(unsigned char)(((tout0) )&0xff), *((out)++)=(unsigned char)(((tout0)>> 8L)&0xff), *((out)++)=(unsigned char)(((tout0)>>16L)&0xff), *((out)++)=(unsigned char)(((tout0)>>24L)&0xff));
...
{ out+=length; switch (length) { case 8: *(--(out))=(unsigned char)(((tout1)>>24L)&0xff); case 7: *(--(out))=(unsigned char)(((tout1)>>16L)&0xff); case 6: *(--(out))=(unsigned char)(((tout1)>> 8L)&0xff); case 5: *(--(out))=(unsigned char)(((tout1) )&0xff); case 4: *(--(out))=(unsigned char)(((tout0)>>24L)&0xff); case 3: *(--(out))=(unsigned char)(((tout0)>>16L)&0xff); case 2: *(--(out))=(unsigned char)(((tout0)>> 8L)&0xff); case 1: *(--(out))=(unsigned char)(((tout0) )&0xff); } };
xor0 = tout0 ^ sin0;
xor1 = tout1 ^ sin1;
}
}
