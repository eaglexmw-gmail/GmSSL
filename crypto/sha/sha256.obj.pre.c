...
#line 17 "crypto\\sha\\sha256.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslv.h"
#line 18 "crypto\\sha\\sha256.c"
int SHA224_Init(SHA256_CTX *c)
{
memset(c, 0, sizeof(*c));
c->h[0] = 0xc1059ed8UL;
...
#line 187 "D:\\07.OpenSrc\\GmSSL\\crypto\\include\\internal/md32_common.h"
#line 191 "D:\\07.OpenSrc\\GmSSL\\crypto\\include\\internal/md32_common.h"
#line 192 "D:\\07.OpenSrc\\GmSSL\\crypto\\include\\internal/md32_common.h"
#line 199 "D:\\07.OpenSrc\\GmSSL\\crypto\\include\\internal/md32_common.h"
#line 206 "D:\\07.OpenSrc\\GmSSL\\crypto\\include\\internal/md32_common.h"
...
do { unsigned long ll; unsigned int nn; switch ((c)->md_len) { case 28: for (nn=0;nn<28/4;nn++) { ll=(c)->h[nn]; (void)(*(((md))++)=(unsigned char)(((ll)>>24)&0xff), *(((md))++)=(unsigned char)(((ll)>>16)&0xff), *(((md))++)=(unsigned char)(((ll)>> 8)&0xff), *(((md))++)=(unsigned char)(((ll) )&0xff), ll); } break; case 32: for (nn=0;nn<32/4;nn++) { ll=(c)->h[nn]; (void)(*(((md))++)=(unsigned char)(((ll)>>24)&0xff), *(((md))++)=(unsigned char)(((ll)>>16)&0xff), *(((md))++)=(unsigned char)(((ll)>> 8)&0xff), *(((md))++)=(unsigned char)(((ll) )&0xff), ll); } break; default: if ((c)->md_len > 32) return 0; for (nn=0;nn<(c)->md_len/4;nn++) { ll=(c)->h[nn]; (void)(*(((md))++)=(unsigned char)(((ll)>>24)&0xff), *(((md))++)=(unsigned char)(((ll)>>16)&0xff), *(((md))++)=(unsigned char)(((ll)>> 8)&0xff), *(((md))++)=(unsigned char)(((ll) )&0xff), ll); } break; } } while (0);
