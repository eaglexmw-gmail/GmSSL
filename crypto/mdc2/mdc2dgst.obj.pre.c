...
#line 11 "crypto\\mdc2\\mdc2dgst.c"
...
#line 12 "crypto\\mdc2\\mdc2dgst.c"
...
#line 13 "crypto\\mdc2\\mdc2dgst.c"
...
#line 14 "crypto\\mdc2\\mdc2dgst.c"
...
#line 15 "crypto\\mdc2\\mdc2dgst.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/mdc2.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 114 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 116 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 118 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
...
#line 155 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 176 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 14 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/mdc2.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/des.h"
#line 18 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/mdc2.h"
...
#line 41 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/mdc2.h"
#line 43 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/mdc2.h"
#line 16 "crypto\\mdc2\\mdc2dgst.c"
...
size_t i;
for (i = 0; i < len; i += 8) {
(tin0 =((DES_LONG)(*((in)++))) , tin0|=((DES_LONG)(*((in)++)))<< 8L, tin0|=((DES_LONG)(*((in)++)))<<16L, tin0|=((DES_LONG)(*((in)++)))<<24L);
d[0] = dd[0] = tin0;
(tin1 =((DES_LONG)(*((in)++))) , tin1|=((DES_LONG)(*((in)++)))<< 8L, tin1|=((DES_LONG)(*((in)++)))<<16L, tin1|=((DES_LONG)(*((in)++)))<<24L);
d[1] = dd[1] = tin1;
...
tin1 ^= d[1];
p = c->h;
(*((p)++)=(unsigned char)(((tin0) )&0xff), *((p)++)=(unsigned char)(((tin0)>> 8L)&0xff), *((p)++)=(unsigned char)(((tin0)>>16L)&0xff), *((p)++)=(unsigned char)(((tin0)>>24L)&0xff));
(*((p)++)=(unsigned char)(((ttin1) )&0xff), *((p)++)=(unsigned char)(((ttin1)>> 8L)&0xff), *((p)++)=(unsigned char)(((ttin1)>>16L)&0xff), *((p)++)=(unsigned char)(((ttin1)>>24L)&0xff));
p = c->hh;
(*((p)++)=(unsigned char)(((ttin0) )&0xff), *((p)++)=(unsigned char)(((ttin0)>> 8L)&0xff), *((p)++)=(unsigned char)(((ttin0)>>16L)&0xff), *((p)++)=(unsigned char)(((ttin0)>>24L)&0xff));
(*((p)++)=(unsigned char)(((tin1) )&0xff), *((p)++)=(unsigned char)(((tin1)>> 8L)&0xff), *((p)++)=(unsigned char)(((tin1)>>16L)&0xff), *((p)++)=(unsigned char)(((tin1)>>24L)&0xff));
}
}
int MDC2_Final(unsigned char *md, MDC2_CTX *c)
{
...
if (j == 2)
c->data[i++] = 0x80;
memset(&(c->data[i]), 0, 8 - i);
mdc2_body(c, c->data, 8);
}
memcpy(md, (char *)c->h, 8);
memcpy(&(md[8]), (char *)c->hh, 8);
return 1;
}
