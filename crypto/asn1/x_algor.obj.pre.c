...
#line 12 "crypto\\asn1\\x_algor.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/asn1.h"
#line 13 "crypto\\asn1\\x_algor.c"
...
#line 15 "crypto\\asn1\\x_algor.c"
static const ASN1_TEMPLATE X509_ALGOR_seq_tt[] = {
{ (0), (0), (size_t)&(((X509_ALGOR *)0)->algorithm), "algorithm", (ASN1_OBJECT_it) },
{ ((0x1)), (0), (size_t)&(((X509_ALGOR *)0)->parameter), "parameter", (ASN1_ANY_it) }
} ; const ASN1_ITEM * X509_ALGOR_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_ALGOR_seq_tt, sizeof(X509_ALGOR_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(X509_ALGOR), "X509_ALGOR" }; return &local_it; }
static const ASN1_TEMPLATE X509_ALGORS_item_tt =
{ ((0x2 << 1)), (0), 0, "algorithms", (X509_ALGOR_it) }
; const ASN1_ITEM * X509_ALGORS_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &X509_ALGORS_item_tt, 0, ((void *)0), 0, "X509_ALGORS" }; return &local_it; }
X509_ALGOR *d2i_X509_ALGOR(X509_ALGOR **a, const unsigned char **in, long len) { return (X509_ALGOR *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_ALGOR_it())); } int i2d_X509_ALGOR(X509_ALGOR *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (X509_ALGOR_it())); } X509_ALGOR *X509_ALGOR_new(void) { return (X509_ALGOR *)ASN1_item_new((X509_ALGOR_it())); } void X509_ALGOR_free(X509_ALGOR *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_ALGOR_it())); }
X509_ALGORS *d2i_X509_ALGORS(X509_ALGORS **a, const unsigned char **in, long len) { return (X509_ALGORS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_ALGORS_it())); } int i2d_X509_ALGORS(X509_ALGORS *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (X509_ALGORS_it())); }
X509_ALGOR * X509_ALGOR_dup(X509_ALGOR *x) { return ASN1_item_dup((X509_ALGOR_it()), x); }
