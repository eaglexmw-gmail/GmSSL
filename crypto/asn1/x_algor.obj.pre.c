...
const ASN1_ITEM * X509_ALGOR_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, X509_ALGOR_seq_tt, sizeof(X509_ALGOR_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(X509_ALGOR), "X509_ALGOR" };
    return &local_it;
}
...
const ASN1_ITEM * X509_ALGORS_it(void)
{
    static const ASN1_ITEM local_it = { 0x0, -1, &X509_ALGORS_item_tt, 0, ((void *)0), 0, "X509_ALGORS" };
    return &local_it;
}
X509_ALGOR *d2i_X509_ALGOR(X509_ALGOR **a, const unsigned char **in, long len)
{
