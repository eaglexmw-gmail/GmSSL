...
#line 17 "crypto\\asn1\\bio_asn1.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\internal/bio.h"
...
#line 11 "D:\\07.OpenSrc\\GmSSL\\include\\internal/bio.h"
...
#line 18 "crypto\\asn1\\bio_asn1.c"
...
#line 19 "crypto\\asn1\\bio_asn1.c"
typedef enum
{
    ASN1_STATE_START,
    ASN1_STATE_PRE_COPY,
...
{
    BIO_ASN1_BUF_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "crypto\\asn1\\bio_asn1.c", 98);
    if (ctx == ((void *)0))
        return 0;
    if (!asn1_bio_init(ctx, 20))
    {
        CRYPTO_free(ctx, "crypto\\asn1\\bio_asn1.c", 103);
        return 0;
    }
    BIO_set_data(b, ctx);
    BIO_set_init(b, 1);
...
static int asn1_bio_init(BIO_ASN1_BUF_CTX *ctx, int size)
{
    ctx->buf = CRYPTO_malloc(size, "crypto\\asn1\\bio_asn1.c", 114);
    if (ctx->buf == ((void *)0))
        return 0;
    ctx->bufsize = size;
    ctx->asn1_class = 0x00;
...
static int asn1_bio_free(BIO *b)
{
    ...
    if (ctx == ((void *)0))
        return 0;
    CRYPTO_free(ctx->buf, "crypto\\asn1\\bio_asn1.c", 135);
    CRYPTO_free(ctx, "crypto\\asn1\\bio_asn1.c", 136);
...
static int asn1_bio_write(BIO *b, const char *in, int inl)
{
    ...
    ctx = BIO_get_data(b);
    next = BIO_next(b);
    if (in == ((void *)0) || inl < 0 || ctx == ((void *)0) || next == ((void *)0))
        return 0;
    wrlen = 0;
    ret = -1;
    for (;;)
    {
        ...
        case ASN1_STATE_HEADER:
            ...
            (void)((ctx->buflen <= ctx->bufsize) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buflen <= ctx->bufsize", "crypto\\asn1\\bio_asn1.c", 181), 1));
            p = ctx->buf;
