...
#line 11 "crypto\\asn1\\bio_ndef.c"
...
#line 12 "crypto\\asn1\\bio_ndef.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/bio.h"
#line 13 "crypto\\asn1\\bio_ndef.c"
...
#line 14 "crypto\\asn1\\bio_ndef.c"
...
BIO *BIO_new_NDEF(BIO *out, ASN1_VALUE *val, const ASN1_ITEM *it)
{
    ...
    if (!aux || !aux->asn1_cb)
    {
        ERR_put_error(13,(208),(202),"crypto\\asn1\\bio_ndef.c",60);
        return ((void *)0);
    }
    ndef_aux = CRYPTO_zalloc(sizeof(*ndef_aux), "crypto\\asn1\\bio_ndef.c", 63);
...
err:
    BIO_free(asn_bio);
    CRYPTO_free(ndef_aux, "crypto\\asn1\\bio_ndef.c", 100);
    return ((void *)0);
}
static int ndef_prefix(BIO *b, unsigned char **pbuf, int *plen, void *parg)
{
    ...
    p = CRYPTO_malloc(derlen, "crypto\\asn1\\bio_ndef.c", 116);
    if (p == ((void *)0))
        return 0;
    ndef_aux->derbuf = p;
    *pbuf = p;
                            ...
                            void *parg)
{
    ...
    if (!parg)
        return 0;
    ndef_aux = *(NDEF_SUPPORT **)parg;
    CRYPTO_free(ndef_aux->derbuf, "crypto\\asn1\\bio_ndef.c", 142);
                            ...
                            void *parg)
{
    ...
    if (!ndef_prefix_free(b, pbuf, plen, parg))
        return 0;
    CRYPTO_free(*pndef_aux, "crypto\\asn1\\bio_ndef.c", 156);
    *pndef_aux = ((void *)0);
    return 1;
}
static int ndef_suffix(BIO *b, unsigned char **pbuf, int *plen, void *parg)
{
    ...
    if (aux->asn1_cb(11,
        ...
        return 0;
    derlen = ASN1_item_ndef_i2d(ndef_aux->val, ((void *)0), ndef_aux->it);
    p = CRYPTO_malloc(derlen, "crypto\\asn1\\bio_ndef.c", 185);
    if (p == ((void *)0))
        return 0;
    ndef_aux->derbuf = p;
    *pbuf = p;
