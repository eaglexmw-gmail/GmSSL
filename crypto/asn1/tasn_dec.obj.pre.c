...
#line 17 "crypto\\asn1\\tasn_dec.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\internal/numbers.h"
#line 38 "D:\\07.OpenSrc\\GmSSL\\include\\internal/numbers.h"
#line 68 "D:\\07.OpenSrc\\GmSSL\\include\\internal/numbers.h"
#line 18 "crypto\\asn1\\tasn_dec.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\asn1\\asn1_locl.h"
...
struct stack_st_MIME_PARAM; typedef int (*sk_MIME_PARAM_compfunc)(const MIME_PARAM * const *a, const MIME_PARAM *const *b); typedef void (*sk_MIME_PARAM_freefunc)(MIME_PARAM *a); typedef MIME_PARAM * (*sk_MIME_PARAM_copyfunc)(const MIME_PARAM *a); static __inline int sk_MIME_PARAM_num(const struct stack_st_MIME_PARAM *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __inline MIME_PARAM *sk_MIME_PARAM_value(const struct stack_st_MIME_PARAM *sk, int idx) { return (MIME_PARAM *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __inline struct stack_st_MIME_PARAM *sk_MIME_PARAM_new(sk_MIME_PARAM_compfunc compare) { return (struct stack_st_MIME_PARAM *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __inline struct stack_st_MIME_PARAM *sk_MIME_PARAM_new_null(void) { return (struct stack_st_MIME_PARAM *)OPENSSL_sk_new_null(); } static __inline void sk_MIME_PARAM_free(struct stack_st_MIME_PARAM *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __inline void sk_MIME_PARAM_zero(struct stack_st_MIME_PARAM *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __inline MIME_PARAM *sk_MIME_PARAM_delete(struct stack_st_MIME_PARAM *sk, int i) { return (MIME_PARAM *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __inline MIME_PARAM *sk_MIME_PARAM_delete_ptr(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr) { return (MIME_PARAM *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline int sk_MIME_PARAM_push(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline int sk_MIME_PARAM_unshift(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline MIME_PARAM *sk_MIME_PARAM_pop(struct stack_st_MIME_PARAM *sk) { return (MIME_PARAM *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __inline MIME_PARAM *sk_MIME_PARAM_shift(struct stack_st_MIME_PARAM *sk) { return (MIME_PARAM *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __inline void sk_MIME_PARAM_pop_free(struct stack_st_MIME_PARAM *sk, sk_MIME_PARAM_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __inline int sk_MIME_PARAM_insert(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __inline MIME_PARAM *sk_MIME_PARAM_set(struct stack_st_MIME_PARAM *sk, int idx, MIME_PARAM *ptr) { return (MIME_PARAM *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __inline int sk_MIME_PARAM_find(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline int sk_MIME_PARAM_find_ex(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline void sk_MIME_PARAM_sort(struct stack_st_MIME_PARAM *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __inline int sk_MIME_PARAM_is_sorted(const struct stack_st_MIME_PARAM *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __inline struct stack_st_MIME_PARAM * sk_MIME_PARAM_dup(const struct stack_st_MIME_PARAM *sk) { return (struct stack_st_MIME_PARAM *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __inline struct stack_st_MIME_PARAM *sk_MIME_PARAM_deep_copy(const struct stack_st_MIME_PARAM *sk, sk_MIME_PARAM_copyfunc copyfunc, sk_MIME_PARAM_freefunc freefunc) { return (struct stack_st_MIME_PARAM *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __inline sk_MIME_PARAM_compfunc sk_MIME_PARAM_set_cmp_func(struct stack_st_MIME_PARAM *sk, sk_MIME_PARAM_compfunc compare) { return (sk_MIME_PARAM_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
typedef struct mime_header_st MIME_HEADER;
struct stack_st_MIME_HEADER; typedef int (*sk_MIME_HEADER_compfunc)(const MIME_HEADER * const *a, const MIME_HEADER *const *b); typedef void (*sk_MIME_HEADER_freefunc)(MIME_HEADER *a); typedef MIME_HEADER * (*sk_MIME_HEADER_copyfunc)(const MIME_HEADER *a); static __inline int sk_MIME_HEADER_num(const struct stack_st_MIME_HEADER *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __inline MIME_HEADER *sk_MIME_HEADER_value(const struct stack_st_MIME_HEADER *sk, int idx) { return (MIME_HEADER *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __inline struct stack_st_MIME_HEADER *sk_MIME_HEADER_new(sk_MIME_HEADER_compfunc compare) { return (struct stack_st_MIME_HEADER *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __inline struct stack_st_MIME_HEADER *sk_MIME_HEADER_new_null(void) { return (struct stack_st_MIME_HEADER *)OPENSSL_sk_new_null(); } static __inline void sk_MIME_HEADER_free(struct stack_st_MIME_HEADER *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __inline void sk_MIME_HEADER_zero(struct stack_st_MIME_HEADER *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __inline MIME_HEADER *sk_MIME_HEADER_delete(struct stack_st_MIME_HEADER *sk, int i) { return (MIME_HEADER *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __inline MIME_HEADER *sk_MIME_HEADER_delete_ptr(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr) { return (MIME_HEADER *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline int sk_MIME_HEADER_push(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline int sk_MIME_HEADER_unshift(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline MIME_HEADER *sk_MIME_HEADER_pop(struct stack_st_MIME_HEADER *sk) { return (MIME_HEADER *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __inline MIME_HEADER *sk_MIME_HEADER_shift(struct stack_st_MIME_HEADER *sk) { return (MIME_HEADER *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __inline void sk_MIME_HEADER_pop_free(struct stack_st_MIME_HEADER *sk, sk_MIME_HEADER_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __inline int sk_MIME_HEADER_insert(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __inline MIME_HEADER *sk_MIME_HEADER_set(struct stack_st_MIME_HEADER *sk, int idx, MIME_HEADER *ptr) { return (MIME_HEADER *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __inline int sk_MIME_HEADER_find(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline int sk_MIME_HEADER_find_ex(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline void sk_MIME_HEADER_sort(struct stack_st_MIME_HEADER *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __inline int sk_MIME_HEADER_is_sorted(const struct stack_st_MIME_HEADER *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __inline struct stack_st_MIME_HEADER * sk_MIME_HEADER_dup(const struct stack_st_MIME_HEADER *sk) { return (struct stack_st_MIME_HEADER *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __inline struct stack_st_MIME_HEADER *sk_MIME_HEADER_deep_copy(const struct stack_st_MIME_HEADER *sk, sk_MIME_HEADER_copyfunc copyfunc, sk_MIME_HEADER_freefunc freefunc) { return (struct stack_st_MIME_HEADER *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __inline sk_MIME_HEADER_compfunc sk_MIME_HEADER_set_cmp_func(struct stack_st_MIME_HEADER *sk, sk_MIME_HEADER_compfunc compare) { return (sk_MIME_HEADER_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
int tag, int aclass, char opt, ASN1_TLC *ctx)
{
const ASN1_TEMPLATE *tt, *errtt = ((void *)0);
const ASN1_EXTERN_FUNCS *ef;
const ASN1_AUX *aux = it->funcs;
ASN1_aux_cb *asn1_cb;
const unsigned char *p = ((void *)0), *q;
...
if (it->templates) {
if ((tag != -1) || opt) {
ERR_put_error(13,(120),(170),"crypto\\asn1\\tasn_dec.c",159);
#line 160 "crypto\\asn1\\tasn_dec.c"
goto err;
}
...
case 0x5:
p = *in;
ret = asn1_check_tlen(((void *)0), &otag, &oclass, ((void *)0), ((void *)0),
&p, len, -1, 0, 1, ctx);
if (!ret) {
ERR_put_error(13,(120),(58),"crypto\\asn1\\tasn_dec.c",174);
goto err;
}
if (oclass != 0x00) {
if (opt)
return -1;
ERR_put_error(13,(120),(139),"crypto\\asn1\\tasn_dec.c",183);
goto err;
}
if (!(ASN1_tag2bit(otag) & it->utype)) {
if (opt)
return -1;
ERR_put_error(13,(120),(140),"crypto\\asn1\\tasn_dec.c",191);
goto err;
}
...
case 0x2:
if (asn1_cb && !asn1_cb(4, pval, it, ((void *)0)))
goto auxerr;
if (*pval) {
...
ERR_put_error(13,(120),(58),"crypto\\asn1\\tasn_dec.c",214);
goto err;
}
p = *in;
...
asn1_template_free(pchptr, tt);
errtt = tt;
ERR_put_error(13,(120),(58),"crypto\\asn1\\tasn_dec.c",237);
goto err;
}
if (i == it->tcount) {
if (opt) {
...
ERR_put_error(13,(120),(143),"crypto\\asn1\\tasn_dec.c",249);
goto err;
}
asn1_set_choice_selector(pval, i, it);
if (asn1_cb && !asn1_cb(5, pval, it, ((void *)0)))
goto auxerr;
*in = p;
return 1;
case 0x6:
...
ret = asn1_check_tlen(&len, ((void *)0), ((void *)0), &seq_eoc, &cst,
&p, len, tag, aclass, opt, ctx);
if (!ret) {
ERR_put_error(13,(120),(58),"crypto\\asn1\\tasn_dec.c",274);
goto err;
} else if (ret == -1)
return -1;
if (aux && (aux->flags & 4)) {
...
seq_nolen = seq_eoc;
if (!cst) {
ERR_put_error(13,(120),(149),"crypto\\asn1\\tasn_dec.c",286);
goto err;
}
if (!*pval && !ASN1_item_ex_new(pval, it)) {
ERR_put_error(13,(120),(58),"crypto\\asn1\\tasn_dec.c",291);
goto err;
}
if (asn1_cb && !asn1_cb(4, pval, it, ((void *)0)))
goto auxerr;
...
if (!seq_eoc) {
ERR_put_error(13,(120),(159),"crypto\\asn1\\tasn_dec.c",325);
goto err;
}
len -= p - q;
seq_eoc = 0;
...
ERR_put_error(13,(120),(137),"crypto\\asn1\\tasn_dec.c",364);
goto err;
}
if (!seq_nolen && len) {
ERR_put_error(13,(120),(148),"crypto\\asn1\\tasn_dec.c",369);
goto err;
}
...
errtt = seqtt;
ERR_put_error(13,(120),(121),"crypto\\asn1\\tasn_dec.c",389);
goto err;
}
}
...
auxerr:
ERR_put_error(13,(120),(100),"crypto\\asn1\\tasn_dec.c",405);
err:
if (errtt)
...
q = p;
if (!ret) {
ERR_put_error(13,(132),(58),"crypto\\asn1\\tasn_dec.c",448);
return 0;
} else if (ret == -1)
return -1;
if (!cst) {
ERR_put_error(13,(132),(120),"crypto\\asn1\\tasn_dec.c",454);
#line 455 "crypto\\asn1\\tasn_dec.c"
return 0;
}
ret = asn1_template_noexp_d2i(val, &p, len, tt, 0, ctx);
if (!ret) {
ERR_put_error(13,(132),(58),"crypto\\asn1\\tasn_dec.c",460);
return 0;
}
len -= p - q;
if (exp_eoc) {
if (!asn1_check_eoc(&p, len)) {
ERR_put_error(13,(132),(137),"crypto\\asn1\\tasn_dec.c",468);
goto err;
}
} else {
if (len) {
ERR_put_error(13,(132),(119),"crypto\\asn1\\tasn_dec.c",477);
#line 478 "crypto\\asn1\\tasn_dec.c"
goto err;
}
}
} else
...
ret = asn1_check_tlen(&len, ((void *)0), ((void *)0), &sk_eoc, ((void *)0),
&p, len, sktag, skaclass, opt, ctx);
if (!ret) {
ERR_put_error(13,(131),(58),"crypto\\asn1\\tasn_dec.c",536);
return 0;
} else if (ret == -1)
return -1;
if (!*val)
...
struct stack_st_ASN1_VALUE *sktmp = (struct stack_st_ASN1_VALUE *)*val;
ASN1_VALUE *vtmp;
...
if (!*val) {
ERR_put_error(13,(131),((1|64)),"crypto\\asn1\\tasn_dec.c",555);
goto err;
}
while (len > 0) {
ASN1_VALUE *skfield;
...
if (asn1_check_eoc(&p, len)) {
if (!sk_eoc) {
ERR_put_error(13,(131),(159),"crypto\\asn1\\tasn_dec.c",567);
#line 568 "crypto\\asn1\\tasn_dec.c"
goto err;
}
len -= p - q;
sk_eoc = 0;
...
(tt->item()), -1, 0, 0, ctx)) {
ERR_put_error(13,(131),(58),"crypto\\asn1\\tasn_dec.c",578);
#line 579 "crypto\\asn1\\tasn_dec.c"
ASN1_item_free(skfield, (tt->item()));
goto err;
}
len -= p - q;
if (!sk_ASN1_VALUE_push((struct stack_st_ASN1_VALUE *)*val, skfield)) {
ERR_put_error(13,(131),((1|64)),"crypto\\asn1\\tasn_dec.c",585);
ASN1_item_free(skfield, (tt->item()));
goto err;
}
}
if (sk_eoc) {
ERR_put_error(13,(131),(137),"crypto\\asn1\\tasn_dec.c",591);
goto err;
}
} else if (flags & (0x1 << 3)) {
...
ctx);
if (!ret) {
ERR_put_error(13,(131),(58),"crypto\\asn1\\tasn_dec.c",600);
goto err;
} else if (ret == -1)
return -1;
} else {
...
-1, 0, opt, ctx);
if (!ret) {
ERR_put_error(13,(131),(58),"crypto\\asn1\\tasn_dec.c",609);
goto err;
} else if (ret == -1)
return -1;
}
...
long len;
if (!pval) {
ERR_put_error(13,(108),(125),"crypto\\asn1\\tasn_dec.c",635);
return 0;               
}
if (it->itype == 0x5) {
utype = tag;
...
unsigned char oclass;
if (tag >= 0) {
ERR_put_error(13,(108),(127),"crypto\\asn1\\tasn_dec.c",649);
return 0;
}
if (opt) {
ERR_put_error(13,(108),(126),"crypto\\asn1\\tasn_dec.c",654);
#line 655 "crypto\\asn1\\tasn_dec.c"
return 0;
}
p = *in;
...
&p, inlen, -1, 0, 0, ctx);
if (!ret) {
ERR_put_error(13,(108),(58),"crypto\\asn1\\tasn_dec.c",661);
return 0;
}
if (oclass != 0x00)
utype = -3;
...
if (!ret) {
ERR_put_error(13,(108),(58),"crypto\\asn1\\tasn_dec.c",676);
return 0;
} else if (ret == -1)
return -1;
ret = 0;
...
ERR_put_error(13,(108),(156),"crypto\\asn1\\tasn_dec.c",694);
#line 695 "crypto\\asn1\\tasn_dec.c"
return 0;
}
cont = *in;
if (inf) {
...
|| utype == 6 || utype == 2
|| utype == 10) {
ERR_put_error(13,(108),(195),"crypto\\asn1\\tasn_dec.c",712);
return 0;
}
free_cont = 1;
...
ERR_put_error(13,(108),((1|64)),"crypto\\asn1\\tasn_dec.c",730);
goto err;
}
buf.data[len] = 0;
...
err:
if (free_cont)
CRYPTO_free(buf.data, "crypto\\asn1\\tasn_dec.c", 750);
return ret;
}
static int asn1_ex_c2i(ASN1_VALUE **pval, const unsigned char *cont, int len,
int utype, char *free_cont, const ASN1_ITEM *it)
...
case 5:
if (len) {
ERR_put_error(13,(204),(144),"crypto\\asn1\\tasn_dec.c",792);
goto err;
}
*pval = (ASN1_VALUE *)1;
break;
case 1:
if (len != 1) {
ERR_put_error(13,(204),(106),"crypto\\asn1\\tasn_dec.c",800);
goto err;
} else {
ASN1_BOOLEAN *tbool;
...
default:
if (utype == 30 && (len & 1)) {
ERR_put_error(13,(204),(214),"crypto\\asn1\\tasn_dec.c",842);
goto err;
}
if (utype == 28 && (len & 3)) {
ERR_put_error(13,(204),(215),"crypto\\asn1\\tasn_dec.c",847);
#line 848 "crypto\\asn1\\tasn_dec.c"
goto err;
}
if (!*pval) {
stmp = ASN1_STRING_type_new(utype);
if (stmp == ((void *)0)) {
ERR_put_error(13,(204),((1|64)),"crypto\\asn1\\tasn_dec.c",854);
goto err;
}
...
if (*free_cont) {
CRYPTO_free(stmp->data, "crypto\\asn1\\tasn_dec.c", 864);
stmp->data = (unsigned char *)cont; 
stmp->length = len;
*free_cont = 0;
} else {
if (!ASN1_STRING_set(stmp, cont, len)) {
ERR_put_error(13,(204),((1|64)),"crypto\\asn1\\tasn_dec.c",870);
...
-1, 0, 0, ((void *)0))) {
ERR_put_error(13,(190),(58),"crypto\\asn1\\tasn_dec.c",928);
return 0;
}
if (inf) {
if (expected_eoc == 0xffffffffui32) {
ERR_put_error(13,(190),(58),"crypto\\asn1\\tasn_dec.c",933);
return 0;
}
expected_eoc++;
} else {
...
if (expected_eoc) {
ERR_put_error(13,(190),(137),"crypto\\asn1\\tasn_dec.c",943);
return 0;
}
*in = p;
return 1;
}
#line 965 "crypto\\asn1\\tasn_dec.c"
static int asn1_collect(BUF_MEM *buf, const unsigned char **in, long len,
char inf, int tag, int aclass, int depth)
{
const unsigned char *p, *q;
...
if (asn1_check_eoc(&p, len)) {
if (!inf) {
ERR_put_error(13,(106),(159),"crypto\\asn1\\tasn_dec.c",990);
return 0;
}
inf = 0;
break;
...
ERR_put_error(13,(106),(58),"crypto\\asn1\\tasn_dec.c",999);
return 0;
}
if (cst) {
if (depth >= 5) {
ERR_put_error(13,(106),(197),"crypto\\asn1\\tasn_dec.c",1006);
return 0;
}
...
if (inf) {
ERR_put_error(13,(106),(137),"crypto\\asn1\\tasn_dec.c",1016);
return 0;
}
*in = p;
return 1;
...
ERR_put_error(13,(140),((1|64)),"crypto\\asn1\\tasn_dec.c",1029);
return 0;
}
...
ERR_put_error(13,(104),(155),"crypto\\asn1\\tasn_dec.c",1092);
if (ctx) (ctx)->valid = 0;
return 0;
}
}
...
if (i & 0x80) {
ERR_put_error(13,(104),(102),"crypto\\asn1\\tasn_dec.c",1100);
if (ctx) (ctx)->valid = 0;
return 0;
}
if (exptag >= 0) {
...
return -1;
if (ctx) (ctx)->valid = 0;
ERR_put_error(13,(104),(168),"crypto\\asn1\\tasn_dec.c",1112);
return 0;
}
if (ctx) (ctx)->valid = 0;
}
