...
typedef int (*sk_MIME_PARAM_compfunc)(const MIME_PARAM * const *a, const MIME_PARAM *const *b);
typedef void (*sk_MIME_PARAM_freefunc)(MIME_PARAM *a);
typedef MIME_PARAM * (*sk_MIME_PARAM_copyfunc)(const MIME_PARAM *a);
static __inline int sk_MIME_PARAM_num(const struct stack_st_MIME_PARAM *sk)
{
    return OPENSSL_sk_num((const OPENSSL_STACK *)sk);
}
static __inline MIME_PARAM *sk_MIME_PARAM_value(const struct stack_st_MIME_PARAM *sk, int idx)
{
    return (MIME_PARAM *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx);
}
static __inline struct stack_st_MIME_PARAM *sk_MIME_PARAM_new(sk_MIME_PARAM_compfunc compare)
{
    return (struct stack_st_MIME_PARAM *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare);
}
static __inline struct stack_st_MIME_PARAM *sk_MIME_PARAM_new_null(void)
{
    return (struct stack_st_MIME_PARAM *)OPENSSL_sk_new_null();
}
static __inline void sk_MIME_PARAM_free(struct stack_st_MIME_PARAM *sk)
{
    OPENSSL_sk_free((OPENSSL_STACK *)sk);
}
static __inline void sk_MIME_PARAM_zero(struct stack_st_MIME_PARAM *sk)
{
    OPENSSL_sk_zero((OPENSSL_STACK *)sk);
}
static __inline MIME_PARAM *sk_MIME_PARAM_delete(struct stack_st_MIME_PARAM *sk, int i)
{
    return (MIME_PARAM *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i);
}
static __inline MIME_PARAM *sk_MIME_PARAM_delete_ptr(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr)
{
    return (MIME_PARAM *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_MIME_PARAM_push(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr)
{
    return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_MIME_PARAM_unshift(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr)
{
    return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline MIME_PARAM *sk_MIME_PARAM_pop(struct stack_st_MIME_PARAM *sk)
{
    return (MIME_PARAM *)OPENSSL_sk_pop((OPENSSL_STACK *)sk);
}
static __inline MIME_PARAM *sk_MIME_PARAM_shift(struct stack_st_MIME_PARAM *sk)
{
    return (MIME_PARAM *)OPENSSL_sk_shift((OPENSSL_STACK *)sk);
}
static __inline void sk_MIME_PARAM_pop_free(struct stack_st_MIME_PARAM *sk, sk_MIME_PARAM_freefunc freefunc)
{
    OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc);
}
static __inline int sk_MIME_PARAM_insert(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr, int idx)
{
    return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx);
}
static __inline MIME_PARAM *sk_MIME_PARAM_set(struct stack_st_MIME_PARAM *sk, int idx, MIME_PARAM *ptr)
{
    return (MIME_PARAM *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr);
}
static __inline int sk_MIME_PARAM_find(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr)
{
    return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_MIME_PARAM_find_ex(struct stack_st_MIME_PARAM *sk, MIME_PARAM *ptr)
{
    return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline void sk_MIME_PARAM_sort(struct stack_st_MIME_PARAM *sk)
{
    OPENSSL_sk_sort((OPENSSL_STACK *)sk);
}
static __inline int sk_MIME_PARAM_is_sorted(const struct stack_st_MIME_PARAM *sk)
{
    return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_MIME_PARAM * sk_MIME_PARAM_dup(const struct stack_st_MIME_PARAM *sk)
{
    return (struct stack_st_MIME_PARAM *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_MIME_PARAM *sk_MIME_PARAM_deep_copy(const struct stack_st_MIME_PARAM *sk, sk_MIME_PARAM_copyfunc copyfunc, sk_MIME_PARAM_freefunc freefunc)
{
    return (struct stack_st_MIME_PARAM *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc);
}
static __inline sk_MIME_PARAM_compfunc sk_MIME_PARAM_set_cmp_func(struct stack_st_MIME_PARAM *sk, sk_MIME_PARAM_compfunc compare)
{
    return (sk_MIME_PARAM_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare);
}
typedef struct mime_header_st MIME_HEADER;
struct stack_st_MIME_HEADER;
typedef int (*sk_MIME_HEADER_compfunc)(const MIME_HEADER * const *a, const MIME_HEADER *const *b);
typedef void (*sk_MIME_HEADER_freefunc)(MIME_HEADER *a);
typedef MIME_HEADER * (*sk_MIME_HEADER_copyfunc)(const MIME_HEADER *a);
static __inline int sk_MIME_HEADER_num(const struct stack_st_MIME_HEADER *sk)
{
    return OPENSSL_sk_num((const OPENSSL_STACK *)sk);
}
static __inline MIME_HEADER *sk_MIME_HEADER_value(const struct stack_st_MIME_HEADER *sk, int idx)
{
    return (MIME_HEADER *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx);
}
static __inline struct stack_st_MIME_HEADER *sk_MIME_HEADER_new(sk_MIME_HEADER_compfunc compare)
{
    return (struct stack_st_MIME_HEADER *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare);
}
static __inline struct stack_st_MIME_HEADER *sk_MIME_HEADER_new_null(void)
{
    return (struct stack_st_MIME_HEADER *)OPENSSL_sk_new_null();
}
static __inline void sk_MIME_HEADER_free(struct stack_st_MIME_HEADER *sk)
{
    OPENSSL_sk_free((OPENSSL_STACK *)sk);
}
static __inline void sk_MIME_HEADER_zero(struct stack_st_MIME_HEADER *sk)
{
    OPENSSL_sk_zero((OPENSSL_STACK *)sk);
}
static __inline MIME_HEADER *sk_MIME_HEADER_delete(struct stack_st_MIME_HEADER *sk, int i)
{
    return (MIME_HEADER *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i);
}
static __inline MIME_HEADER *sk_MIME_HEADER_delete_ptr(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr)
{
    return (MIME_HEADER *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_MIME_HEADER_push(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr)
{
    return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_MIME_HEADER_unshift(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr)
{
    return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline MIME_HEADER *sk_MIME_HEADER_pop(struct stack_st_MIME_HEADER *sk)
{
    return (MIME_HEADER *)OPENSSL_sk_pop((OPENSSL_STACK *)sk);
}
static __inline MIME_HEADER *sk_MIME_HEADER_shift(struct stack_st_MIME_HEADER *sk)
{
    return (MIME_HEADER *)OPENSSL_sk_shift((OPENSSL_STACK *)sk);
}
static __inline void sk_MIME_HEADER_pop_free(struct stack_st_MIME_HEADER *sk, sk_MIME_HEADER_freefunc freefunc)
{
    OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc);
}
static __inline int sk_MIME_HEADER_insert(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr, int idx)
{
    return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx);
}
static __inline MIME_HEADER *sk_MIME_HEADER_set(struct stack_st_MIME_HEADER *sk, int idx, MIME_HEADER *ptr)
{
    return (MIME_HEADER *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr);
}
static __inline int sk_MIME_HEADER_find(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr)
{
    return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_MIME_HEADER_find_ex(struct stack_st_MIME_HEADER *sk, MIME_HEADER *ptr)
{
    return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline void sk_MIME_HEADER_sort(struct stack_st_MIME_HEADER *sk)
{
    OPENSSL_sk_sort((OPENSSL_STACK *)sk);
}
static __inline int sk_MIME_HEADER_is_sorted(const struct stack_st_MIME_HEADER *sk)
{
    return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_MIME_HEADER * sk_MIME_HEADER_dup(const struct stack_st_MIME_HEADER *sk)
{
    return (struct stack_st_MIME_HEADER *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_MIME_HEADER *sk_MIME_HEADER_deep_copy(const struct stack_st_MIME_HEADER *sk, sk_MIME_HEADER_copyfunc copyfunc, sk_MIME_HEADER_freefunc freefunc)
{
    return (struct stack_st_MIME_HEADER *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc);
}
static __inline sk_MIME_HEADER_compfunc sk_MIME_HEADER_set_cmp_func(struct stack_st_MIME_HEADER *sk, sk_MIME_HEADER_compfunc compare)
{
    return (sk_MIME_HEADER_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare);
}
