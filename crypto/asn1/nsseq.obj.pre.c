...
static const ASN1_AUX NETSCAPE_CERT_SEQUENCE_aux = {((void *)0), 0, 0, 0, nsseq_cb, 0};
...
const ASN1_ITEM * NETSCAPE_CERT_SEQUENCE_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, NETSCAPE_CERT_SEQUENCE_seq_tt, sizeof(NETSCAPE_CERT_SEQUENCE_seq_tt) / sizeof(ASN1_TEMPLATE), &NETSCAPE_CERT_SEQUENCE_aux, sizeof(NETSCAPE_CERT_SEQUENCE), "NETSCAPE_CERT_SEQUENCE" };
    return &local_it;
}
NETSCAPE_CERT_SEQUENCE *d2i_NETSCAPE_CERT_SEQUENCE(NETSCAPE_CERT_SEQUENCE **a, const unsigned char **in, long len)
{
    return (NETSCAPE_CERT_SEQUENCE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (NETSCAPE_CERT_SEQUENCE_it()));
}
int i2d_NETSCAPE_CERT_SEQUENCE(NETSCAPE_CERT_SEQUENCE *a, unsigned char **out)
{
