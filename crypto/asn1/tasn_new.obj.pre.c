...
*pval = CRYPTO_zalloc(it->size, "crypto\\asn1\\tasn_new.c", 97);
if (*pval == ((void *)0))
goto memerr;
}
asn1_set_choice_selector(pval, -1, it);
if (asn1_cb && !asn1_cb(1, pval, it, ((void *)0)))
goto auxerr;
break;
case 0x6:
case 0x1:
...
*pval = CRYPTO_zalloc(it->size, "crypto\\asn1\\tasn_new.c", 122);
if (*pval == ((void *)0))
goto memerr;
}
...
return 1;
memerr:
ERR_put_error(13,(121),((1|64)),"crypto\\asn1\\tasn_new.c",145);
return 0;
auxerr:
ERR_put_error(13,(121),(100),"crypto\\asn1\\tasn_new.c",152);
...
if (!skval) {
ERR_put_error(13,(133),((1|64)),"crypto\\asn1\\tasn_new.c",223);
ret = 0;
goto done;
}
...
return 1;
case -4:
typ = CRYPTO_malloc(sizeof(*typ), "crypto\\asn1\\tasn_new.c", 288);
if (typ == ((void *)0))
return 0;
