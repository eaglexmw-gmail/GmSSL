...
int embed)
{
const ASN1_TEMPLATE *tt = ((void *)0), *seqtt;
...
if (asn1_cb)
asn1_cb(3, pval, it, ((void *)0));
if (embed == 0) {
CRYPTO_free(*pval, "crypto\\asn1\\tasn_fre.c", 79);
*pval = ((void *)0);
}
break;
case 0x4:
...
asn1_cb(3, pval, it, ((void *)0));
if (embed == 0) {
CRYPTO_free(*pval, "crypto\\asn1\\tasn_fre.c", 119);
*pval = ((void *)0);
}
break;
}
...
asn1_item_embed_free(&vtmp, (tt->item()), embed);
}
sk_ASN1_VALUE_free(sk);
*pval = ((void *)0);
} else {
asn1_item_embed_free(pval, (tt->item()), embed);
}
}
void asn1_primitive_free(ASN1_VALUE **pval, const ASN1_ITEM *it, int embed)
{
...
CRYPTO_free(*pval, "crypto\\asn1\\tasn_fre.c", 199);
break;
default:
