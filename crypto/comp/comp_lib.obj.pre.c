...
#line 11 "crypto\\comp\\comp_lib.c"
...
#line 12 "crypto\\comp\\comp_lib.c"
...
#line 13 "crypto\\comp\\comp_lib.c"
...
#line 14 "crypto\\comp\\comp_lib.c"
...
#line 15 "crypto\\comp\\comp_lib.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\comp\\comp_lcl.h"
...
#line 16 "crypto\\comp\\comp_lib.c"
COMP_CTX *COMP_CTX_new(COMP_METHOD *meth)
{
    COMP_CTX *ret;
    if ((ret = CRYPTO_zalloc(sizeof(*ret), "crypto\\comp\\comp_lib.c", 21)) == ((void *)0))
        return (((void *)0));
    ret->meth = meth;
    if ((ret->meth->init != ((void *)0)) && !ret->meth->init(ret))
    {
        CRYPTO_free(ret, "crypto\\comp\\comp_lib.c", 25);
        ret = ((void *)0);
    }
    return (ret);
}
...
void COMP_CTX_free(COMP_CTX *ctx)
{
    ...
    if (ctx->meth->finish != ((void *)0))
        ctx->meth->finish(ctx);
    CRYPTO_free(ctx, "crypto\\comp\\comp_lib.c", 54);
}
int COMP_compress_block(COMP_CTX *ctx, unsigned char *out, int olen,
                        unsigned char *in, int ilen)
{
...
int COMP_CTX_get_type(const COMP_CTX* comp)
{
    return comp->meth ? comp->meth->type : 0;
}
