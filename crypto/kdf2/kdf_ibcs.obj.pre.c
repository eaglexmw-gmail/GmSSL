...
static void *ibcs_sm3kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_sm3(), in, inlen, out, outlen);
}
#line 105 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_md5kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_md5(), in, inlen, out, outlen);
}
#line 108 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_blake2b512kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_blake2b512(), in, inlen, out, outlen);
}
static void *ibcs_blake2s256kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_blake2s256(), in, inlen, out, outlen);
}
#line 112 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_sha1kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_sha1(), in, inlen, out, outlen);
}
static void *ibcs_sha224kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_sha224(), in, inlen, out, outlen);
}
static void *ibcs_sha256kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_sha256(), in, inlen, out, outlen);
}
#line 118 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_sha384kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_sha384(), in, inlen, out, outlen);
}
static void *ibcs_sha512kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_sha512(), in, inlen, out, outlen);
}
#line 122 "crypto\\kdf2\\kdf_ibcs.c"
#line 123 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_mdc2kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_mdc2(), in, inlen, out, outlen);
}
#line 126 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_ripemd160kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_ripemd160(), in, inlen, out, outlen);
}
#line 129 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_whirlpoolkdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return ibcs_kdf(EVP_whirlpool(), in, inlen, out, outlen);
}
