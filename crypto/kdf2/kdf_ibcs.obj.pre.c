...
#line 51 "crypto\\kdf2\\kdf_ibcs.c"
...
#line 52 "crypto\\kdf2\\kdf_ibcs.c"
...
#line 53 "crypto\\kdf2\\kdf_ibcs.c"
...
#line 54 "crypto\\kdf2\\kdf_ibcs.c"
...
#line 55 "crypto\\kdf2\\kdf_ibcs.c"
...
if (!EVP_Digest(in, inlen, state + dgstlen, &dgstlen, md, ((void *)0))) {
ERR_put_error(53,(100),(100),"crypto\\kdf2\\kdf_ibcs.c",70);
return ((void *)0);
}
rlen = *outlen;
pout = out;
...
size_t len;
if (!EVP_Digest(state, dgstlen, state, &dgstlen, md, ((void *)0))) {
ERR_put_error(53,(100),(100),"crypto\\kdf2\\kdf_ibcs.c",80);
return ((void *)0);
}
if (!EVP_Digest(state, dgstlen*2, dgst, &dgstlen, md, ((void *)0))) {
ERR_put_error(53,(100),(100),"crypto\\kdf2\\kdf_ibcs.c",84);
return ((void *)0);
}
...
static void *ibcs_sm3kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_sm3(), in, inlen, out, outlen); }
#line 105 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_md5kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_md5(), in, inlen, out, outlen); }
#line 108 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_blake2b512kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_blake2b512(), in, inlen, out, outlen); }
static void *ibcs_blake2s256kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_blake2s256(), in, inlen, out, outlen); }
#line 112 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_sha1kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_sha1(), in, inlen, out, outlen); }
static void *ibcs_sha224kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_sha224(), in, inlen, out, outlen); }
static void *ibcs_sha256kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_sha256(), in, inlen, out, outlen); }
#line 118 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_sha384kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_sha384(), in, inlen, out, outlen); }
static void *ibcs_sha512kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_sha512(), in, inlen, out, outlen); }
#line 122 "crypto\\kdf2\\kdf_ibcs.c"
#line 123 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_mdc2kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_mdc2(), in, inlen, out, outlen); }
#line 126 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_ripemd160kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_ripemd160(), in, inlen, out, outlen); }
#line 129 "crypto\\kdf2\\kdf_ibcs.c"
static void *ibcs_whirlpoolkdf(const void *in, size_t inlen, void *out, size_t *outlen) { return ibcs_kdf(EVP_whirlpool(), in, inlen, out, outlen); }
#line 132 "crypto\\kdf2\\kdf_ibcs.c"
KDF_FUNC KDF_get_ibcs(const EVP_MD *md)
{
switch (EVP_MD_type(md)) {
case 1148:
return ibcs_sm3kdf;
#line 140 "crypto\\kdf2\\kdf_ibcs.c"
case 4:
return ibcs_md5kdf;
#line 144 "crypto\\kdf2\\kdf_ibcs.c"
case 1056:
return ibcs_blake2b512kdf;
case 1057:
return ibcs_blake2s256kdf;
#line 150 "crypto\\kdf2\\kdf_ibcs.c"
case 64:
return ibcs_sha1kdf;
case 675:
...
#line 159 "crypto\\kdf2\\kdf_ibcs.c"
case 673:
return ibcs_sha384kdf;
case 674:
return ibcs_sha512kdf;
#line 165 "crypto\\kdf2\\kdf_ibcs.c"
#line 166 "crypto\\kdf2\\kdf_ibcs.c"
case 95:
return ibcs_mdc2kdf;
#line 170 "crypto\\kdf2\\kdf_ibcs.c"
case 117:
return ibcs_ripemd160kdf;
#line 174 "crypto\\kdf2\\kdf_ibcs.c"
case 804:
return ibcs_whirlpoolkdf;
#line 178 "crypto\\kdf2\\kdf_ibcs.c"
}
return ((void *)0);
}
