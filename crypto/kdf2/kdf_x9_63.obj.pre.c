...
static void *x963_sm3kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_sm3(), in, inlen, out, outlen);
}
static void *x963_md5kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_md5(), in, inlen, out, outlen);
}
#line 119 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_blake2b512kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_blake2b512(), in, inlen, out, outlen);
}
static void *x963_blake2s256kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_blake2s256(), in, inlen, out, outlen);
}
#line 123 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_sha1kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_sha1(), in, inlen, out, outlen);
}
static void *x963_sha224kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_sha224(), in, inlen, out, outlen);
}
static void *x963_sha256kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_sha256(), in, inlen, out, outlen);
}
#line 129 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_sha384kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_sha384(), in, inlen, out, outlen);
}
static void *x963_sha512kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_sha512(), in, inlen, out, outlen);
}
#line 133 "crypto\\kdf2\\kdf_x9_63.c"
#line 134 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_mdc2kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_mdc2(), in, inlen, out, outlen);
}
#line 137 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_ripemd160kdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
    return x963_kdf(EVP_ripemd160(), in, inlen, out, outlen);
}
#line 140 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_whirlpoolkdf(const void *in, size_t inlen, void *out, size_t *outlen)
{
