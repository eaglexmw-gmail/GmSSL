#line 1 "crypto\\kdf2\\kdf_x9_63.c"
...
#line 51 "crypto\\kdf2\\kdf_x9_63.c"
...
#line 52 "crypto\\kdf2\\kdf_x9_63.c"
...
#line 53 "crypto\\kdf2\\kdf_x9_63.c"
...
#line 54 "crypto\\kdf2\\kdf_x9_63.c"
...
#line 55 "crypto\\kdf2\\kdf_x9_63.c"
...
#line 56 "crypto\\kdf2\\kdf_x9_63.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\internal/byteorder.h"
#line 74 "D:\\07.OpenSrc\\GmSSL\\include\\internal/byteorder.h"
#line 76 "D:\\07.OpenSrc\\GmSSL\\include\\internal/byteorder.h"
#line 57 "crypto\\kdf2\\kdf_x9_63.c"
...
ERR_put_error(53,(101),((1|64)),"crypto\\kdf2\\kdf_x9_63.c",73);
goto end;
}
while (rlen > 0) {
...
ERR_put_error(53,(101),(100),"crypto\\kdf2\\kdf_x9_63.c",82);
goto end;
}
if (!EVP_DigestUpdate(ctx, in, inlen)) {
ERR_put_error(53,(101),(100),"crypto\\kdf2\\kdf_x9_63.c",86);
goto end;
}
if (!EVP_DigestUpdate(ctx, &counter_be, sizeof(counter_be))) {
ERR_put_error(53,(101),(100),"crypto\\kdf2\\kdf_x9_63.c",90);
goto end;
}
if (!EVP_DigestFinal(ctx, dgst, &dgstlen)) {
ERR_put_error(53,(101),(100),"crypto\\kdf2\\kdf_x9_63.c",94);
goto end;
}
...
static void *x963_md5kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return x963_kdf(EVP_md5(), in, inlen, out, outlen); }
#line 119 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_blake2b512kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return x963_kdf(EVP_blake2b512(), in, inlen, out, outlen); }
static void *x963_blake2s256kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return x963_kdf(EVP_blake2s256(), in, inlen, out, outlen); }
#line 123 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_sha1kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return x963_kdf(EVP_sha1(), in, inlen, out, outlen); }
static void *x963_sha224kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return x963_kdf(EVP_sha224(), in, inlen, out, outlen); }
static void *x963_sha256kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return x963_kdf(EVP_sha256(), in, inlen, out, outlen); }
#line 129 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_sha384kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return x963_kdf(EVP_sha384(), in, inlen, out, outlen); }
...
#line 133 "crypto\\kdf2\\kdf_x9_63.c"
#line 134 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_mdc2kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return x963_kdf(EVP_mdc2(), in, inlen, out, outlen); }
#line 137 "crypto\\kdf2\\kdf_x9_63.c"
static void *x963_ripemd160kdf(const void *in, size_t inlen, void *out, size_t *outlen) { return x963_kdf(EVP_ripemd160(), in, inlen, out, outlen); }
#line 140 "crypto\\kdf2\\kdf_x9_63.c"
...
#line 143 "crypto\\kdf2\\kdf_x9_63.c"
KDF_FUNC KDF_get_x9_63(const EVP_MD *md)
{
...
case 4:
return x963_md5kdf;
#line 153 "crypto\\kdf2\\kdf_x9_63.c"
case 1056:
return x963_blake2b512kdf;
case 1057:
return x963_blake2s256kdf;
#line 159 "crypto\\kdf2\\kdf_x9_63.c"
case 64:
return x963_sha1kdf;
case 675:
...
#line 168 "crypto\\kdf2\\kdf_x9_63.c"
case 673:
return x963_sha384kdf;
case 674:
return x963_sha512kdf;
#line 174 "crypto\\kdf2\\kdf_x9_63.c"
#line 175 "crypto\\kdf2\\kdf_x9_63.c"
case 95:
return x963_mdc2kdf;
#line 179 "crypto\\kdf2\\kdf_x9_63.c"
case 117:
return x963_ripemd160kdf;
#line 183 "crypto\\kdf2\\kdf_x9_63.c"
case 804:
return x963_whirlpoolkdf;
#line 187 "crypto\\kdf2\\kdf_x9_63.c"
}
return ((void *)0);
}
