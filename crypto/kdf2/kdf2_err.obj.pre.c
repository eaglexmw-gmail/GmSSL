...
#line 12 "crypto\\kdf2\\kdf2_err.c"
...
#line 13 "crypto\\kdf2\\kdf2_err.c"
...
#line 14 "crypto\\kdf2\\kdf2_err.c"
static ERR_STRING_DATA KDF2_str_functs[] = {
{( (((unsigned int)(53) & 0x0FF) << 24L) | (((unsigned int)(100) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "ibcs_kdf"},
{( (((unsigned int)(53) & 0x0FF) << 24L) | (((unsigned int)(101) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "x963_kdf"},
{0, ((void *)0)}
};
static ERR_STRING_DATA KDF2_str_reasons[] = {
{( (((unsigned int)(53) & 0x0FF) << 24L) | (((unsigned int)(0) & 0xFFF) << 12L) | (((unsigned int)(100) & 0xFFF) ) ), "digest failure"},
{0, ((void *)0)}
};
#line 33 "crypto\\kdf2\\kdf2_err.c"
int ERR_load_KDF2_strings(void)
{
if (ERR_func_error_string(KDF2_str_functs[0].error) == ((void *)0)) {
ERR_load_strings(0, KDF2_str_functs);
ERR_load_strings(0, KDF2_str_reasons);
}
#line 43 "crypto\\kdf2\\kdf2_err.c"
return 1;
}
