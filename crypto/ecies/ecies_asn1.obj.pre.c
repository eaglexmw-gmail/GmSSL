#line 1 "crypto\\ecies\\ecies_asn1.c"
...
#line 51 "crypto\\ecies\\ecies_asn1.c"
...
#line 52 "crypto\\ecies\\ecies_asn1.c"
...
#line 53 "crypto\\ecies\\ecies_asn1.c"
...
#line 54 "crypto\\ecies\\ecies_asn1.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/asn1.h"
#line 55 "crypto\\ecies\\ecies_asn1.c"
...
#line 56 "crypto\\ecies\\ecies_asn1.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/objects.h"
#line 57 "crypto\\ecies\\ecies_asn1.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/obj_mac.h"
#line 58 "crypto\\ecies\\ecies_asn1.c"
...
#line 59 "crypto\\ecies\\ecies_asn1.c"
...
#line 60 "crypto\\ecies\\ecies_asn1.c"
...
unsigned char *out, size_t *outlen, EC_KEY *ec_key);
#line 61 "crypto\\ecies\\ecies_asn1.c"
typedef struct ecies_parameters_st {
X509_ALGOR *kdf;
X509_ALGOR *sym;
X509_ALGOR *mac;
} ECIES_PARAMETERS;
static const ASN1_TEMPLATE ECIES_PARAMETERS_seq_tt[] = {
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((ECIES_PARAMETERS *)0)->kdf), "kdf", (X509_ALGOR_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (1), (size_t)&(((ECIES_PARAMETERS *)0)->sym), "sym", (X509_ALGOR_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (2), (size_t)&(((ECIES_PARAMETERS *)0)->mac), "mac", (X509_ALGOR_it) }
} ; const ASN1_ITEM * ECIES_PARAMETERS_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ECIES_PARAMETERS_seq_tt, sizeof(ECIES_PARAMETERS_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(ECIES_PARAMETERS), "ECIES_PARAMETERS" }; return &local_it; }
ECIES_PARAMETERS *d2i_ECIES_PARAMETERS(ECIES_PARAMETERS **a, const unsigned char **in, long len) { return (ECIES_PARAMETERS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ECIES_PARAMETERS_it())); } int i2d_ECIES_PARAMETERS(ECIES_PARAMETERS *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (ECIES_PARAMETERS_it())); } ECIES_PARAMETERS *ECIES_PARAMETERS_new(void) { return (ECIES_PARAMETERS *)ASN1_item_new((ECIES_PARAMETERS_it())); } void ECIES_PARAMETERS_free(ECIES_PARAMETERS *a) { ASN1_item_free((ASN1_VALUE *)a, (ECIES_PARAMETERS_it())); }
ECIES_PARAMETERS * ECIES_PARAMETERS_dup(ECIES_PARAMETERS *x) { return ASN1_item_dup((ECIES_PARAMETERS_it()), x); }
static const ASN1_TEMPLATE ECIES_CIPHERTEXT_VALUE_seq_tt[] = {
{ (0), (0), (size_t)&(((ECIES_CIPHERTEXT_VALUE *)0)->ephem_point), "ephem_point", (ASN1_OCTET_STRING_it) },
{ (0), (0), (size_t)&(((ECIES_CIPHERTEXT_VALUE *)0)->ciphertext), "ciphertext", (ASN1_OCTET_STRING_it) },
{ (0), (0), (size_t)&(((ECIES_CIPHERTEXT_VALUE *)0)->mactag), "mactag", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * ECIES_CIPHERTEXT_VALUE_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ECIES_CIPHERTEXT_VALUE_seq_tt, sizeof(ECIES_CIPHERTEXT_VALUE_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(ECIES_CIPHERTEXT_VALUE), "ECIES_CIPHERTEXT_VALUE" }; return &local_it; }
ECIES_CIPHERTEXT_VALUE *d2i_ECIES_CIPHERTEXT_VALUE(ECIES_CIPHERTEXT_VALUE **a, const unsigned char **in, long len) { return (ECIES_CIPHERTEXT_VALUE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ECIES_CIPHERTEXT_VALUE_it())); } int i2d_ECIES_CIPHERTEXT_VALUE(ECIES_CIPHERTEXT_VALUE *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (ECIES_CIPHERTEXT_VALUE_it())); } ECIES_CIPHERTEXT_VALUE *ECIES_CIPHERTEXT_VALUE_new(void) { return (ECIES_CIPHERTEXT_VALUE *)ASN1_item_new((ECIES_CIPHERTEXT_VALUE_it())); } void ECIES_CIPHERTEXT_VALUE_free(ECIES_CIPHERTEXT_VALUE *a) { ASN1_item_free((ASN1_VALUE *)a, (ECIES_CIPHERTEXT_VALUE_it())); }
ECIES_CIPHERTEXT_VALUE * ECIES_CIPHERTEXT_VALUE_dup(ECIES_CIPHERTEXT_VALUE *x) { return ASN1_item_dup((ECIES_CIPHERTEXT_VALUE_it()), x); }
int i2d_ECIESParameters(const ECIES_PARAMS *param, unsigned char **out)
{
int ret = 0;
ECIES_PARAMETERS *asn1 = ((void *)0);
if (!(asn1 = ECIES_PARAMETERS_new())) {
ERR_put_error(16,(254),((1|64)),"crypto\\ecies\\ecies_asn1.c",142);
goto end;
}
(void)((asn1->kdf && asn1->sym && asn1->mac) ? 0 : (OPENSSL_die("assertion failed: " "asn1->kdf && asn1->sym && asn1->mac", "crypto\\ecies\\ecies_asn1.c", 146), 1));
if (!X509_ALGOR_set0(asn1->kdf, OBJ_nid2obj(param->kdf_nid),
6, OBJ_nid2obj(EVP_MD_type(param->kdf_md)))) {
ERR_put_error(16,(254),(11),"crypto\\ecies\\ecies_asn1.c",150);
goto end;
}
if (!X509_ALGOR_set0(asn1->sym, OBJ_nid2obj(param->enc_nid),
-1, ((void *)0))) {
ERR_put_error(16,(254),(11),"crypto\\ecies\\ecies_asn1.c",155);
goto end;
}
if (param->mac_nid == 1077 ||
param->mac_nid == 1078) {
if (!X509_ALGOR_set0(asn1->mac, OBJ_nid2obj(param->mac_nid),
6, OBJ_nid2obj(EVP_MD_type(param->hmac_md)))) {
ERR_put_error(16,(254),((1|64)),"crypto\\ecies\\ecies_asn1.c",162);
goto end;
}
} else {
if (!X509_ALGOR_set0(asn1->mac, OBJ_nid2obj(param->mac_nid),
-1, ((void *)0))) {
ERR_put_error(16,(254),((1|64)),"crypto\\ecies\\ecies_asn1.c",168);
goto end;
}
}
if ((ret = i2d_ECIES_PARAMETERS(asn1, out)) <= 0) {
ERR_put_error(16,(254),(13),"crypto\\ecies\\ecies_asn1.c",174);
goto end;
}
end:
...
{
int e = 1;
ECIES_PARAMS *ret = ((void *)0);
ECIES_PARAMETERS *asn1 = ((void *)0);
if (!(ret = CRYPTO_zalloc(sizeof(ECIES_PARAMS), "crypto\\ecies\\ecies_asn1.c", 190))) {
ERR_put_error(16,(101),(13),"crypto\\ecies\\ecies_asn1.c",191);
goto end;
}
if (!(asn1 = d2i_ECIES_PARAMETERS(((void *)0), in, len))) {
ERR_put_error(16,(101),(13),"crypto\\ecies\\ecies_asn1.c",195);
goto end;
}
ret->kdf_nid = OBJ_obj2nid(asn1->kdf->algorithm);
if (ret->kdf_nid != 1065) {
ERR_put_error(16,(101),(141),"crypto\\ecies\\ecies_asn1.c",202);
goto end;
}
if (asn1->kdf->parameter->type != 6) {
ERR_put_error(16,(101),(141),"crypto\\ecies\\ecies_asn1.c",206);
goto end;
}
if (!(ret->kdf_md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(asn1->kdf->parameter->value.object))))) {
#line 211 "crypto\\ecies\\ecies_asn1.c"
ERR_put_error(16,(101),(141),"crypto\\ecies\\ecies_asn1.c",211);
goto end;
}
...
break;
default:
ERR_put_error(16,(101),(141),"crypto\\ecies\\ecies_asn1.c",228);
goto end;
}
...
case 1077:
case 1078:
if (asn1->mac->parameter->type != 6) {
ERR_put_error(16,(101),(141),"crypto\\ecies\\ecies_asn1.c",238);
goto end;
}
if (!(ret->hmac_md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(asn1->mac->parameter->value.object))))) {
#line 243 "crypto\\ecies\\ecies_asn1.c"
ERR_put_error(16,(101),(141),"crypto\\ecies\\ecies_asn1.c",243);
goto end;
}
break;
case 1079:
...
break;
default:
ERR_put_error(16,(101),(141),"crypto\\ecies\\ecies_asn1.c",252);
goto end;
}
if (param && *param)
CRYPTO_free(*param, "crypto\\ecies\\ecies_asn1.c", 257);
if (param)
*param = ret;
e = 0;
end:
if (e && ret) {
CRYPTO_free(ret, "crypto\\ecies\\ecies_asn1.c", 264);
ret = ((void *)0);
}
ECIES_PARAMETERS_free(asn1);
return ret;
