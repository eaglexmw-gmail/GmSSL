...
const ASN1_ITEM * ECIES_PARAMETERS_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, ECIES_PARAMETERS_seq_tt, sizeof(ECIES_PARAMETERS_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(ECIES_PARAMETERS), "ECIES_PARAMETERS" };
    return &local_it;
}
ECIES_PARAMETERS *d2i_ECIES_PARAMETERS(ECIES_PARAMETERS **a, const unsigned char **in, long len)
{
    return (ECIES_PARAMETERS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ECIES_PARAMETERS_it()));
}
int i2d_ECIES_PARAMETERS(ECIES_PARAMETERS *a, unsigned char **out)
{
    return ASN1_item_i2d((ASN1_VALUE *)a, out, (ECIES_PARAMETERS_it()));
}
ECIES_PARAMETERS *ECIES_PARAMETERS_new(void)
{
    return (ECIES_PARAMETERS *)ASN1_item_new((ECIES_PARAMETERS_it()));
}
void ECIES_PARAMETERS_free(ECIES_PARAMETERS *a)
{
    ASN1_item_free((ASN1_VALUE *)a, (ECIES_PARAMETERS_it()));
}
ECIES_PARAMETERS * ECIES_PARAMETERS_dup(ECIES_PARAMETERS *x)
{
    return ASN1_item_dup((ECIES_PARAMETERS_it()), x);
}
...
const ASN1_ITEM * ECIES_CIPHERTEXT_VALUE_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, ECIES_CIPHERTEXT_VALUE_seq_tt, sizeof(ECIES_CIPHERTEXT_VALUE_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(ECIES_CIPHERTEXT_VALUE), "ECIES_CIPHERTEXT_VALUE" };
    return &local_it;
}
ECIES_CIPHERTEXT_VALUE *d2i_ECIES_CIPHERTEXT_VALUE(ECIES_CIPHERTEXT_VALUE **a, const unsigned char **in, long len)
{
    return (ECIES_CIPHERTEXT_VALUE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ECIES_CIPHERTEXT_VALUE_it()));
}
int i2d_ECIES_CIPHERTEXT_VALUE(ECIES_CIPHERTEXT_VALUE *a, unsigned char **out)
{
    return ASN1_item_i2d((ASN1_VALUE *)a, out, (ECIES_CIPHERTEXT_VALUE_it()));
}
ECIES_CIPHERTEXT_VALUE *ECIES_CIPHERTEXT_VALUE_new(void)
{
    return (ECIES_CIPHERTEXT_VALUE *)ASN1_item_new((ECIES_CIPHERTEXT_VALUE_it()));
}
void ECIES_CIPHERTEXT_VALUE_free(ECIES_CIPHERTEXT_VALUE *a)
{
    ASN1_item_free((ASN1_VALUE *)a, (ECIES_CIPHERTEXT_VALUE_it()));
}
ECIES_CIPHERTEXT_VALUE * ECIES_CIPHERTEXT_VALUE_dup(ECIES_CIPHERTEXT_VALUE *x)
{
    return ASN1_item_dup((ECIES_CIPHERTEXT_VALUE_it()), x);
}
int i2d_ECIESParameters(const ECIES_PARAMS *param, unsigned char **out)
{
    int ret = 0;
