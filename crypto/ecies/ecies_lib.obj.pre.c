#line 1 "crypto\\ecies\\ecies_lib.c"
...
#line 53 "crypto\\ecies\\ecies_lib.c"
...
#line 54 "crypto\\ecies\\ecies_lib.c"
...
#line 55 "crypto\\ecies\\ecies_lib.c"
...
#line 56 "crypto\\ecies\\ecies_lib.c"
...
#line 59 "crypto\\ecies\\ecies_lib.c"
#line 60 "crypto\\ecies\\ecies_lib.c"
...
#line 61 "crypto\\ecies\\ecies_lib.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/cmac.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/evp.h"
#line 20 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/cmac.h"
...
#line 41 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/cmac.h"
#line 42 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/cmac.h"
#line 63 "crypto\\ecies\\ecies_lib.c"
#line 64 "crypto\\ecies\\ecies_lib.c"
...
#line 65 "crypto\\ecies\\ecies_lib.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/ecdh.h"
...
#line 11 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/ecdh.h"
#line 66 "crypto\\ecies\\ecies_lib.c"
...
#line 67 "crypto\\ecies\\ecies_lib.c"
...
#line 68 "crypto\\ecies\\ecies_lib.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\internal/o_str.h"
int OPENSSL_memcmp(const void *p1, const void *p2, size_t n);
#line 18 "D:\\07.OpenSrc\\GmSSL\\include\\internal/o_str.h"
#line 69 "crypto\\ecies\\ecies_lib.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\ecies\\ecies_lcl.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/ecies.h"
#line 52 "d:\\07.opensrc\\gmssl\\crypto\\ecies\\ecies_lcl.h"
...
unsigned char *out, size_t *outlen, EC_KEY *ec_key);
ECIES_CIPHERTEXT_VALUE *gmssl_ecies_do_encrypt(int type,
const unsigned char *in, size_t inlen, EC_KEY *ec_key);
int gmssl_ecies_do_decrypt(int type, const ECIES_CIPHERTEXT_VALUE *in,
unsigned char *out, size_t *outlen, EC_KEY *ec_key);
#line 70 "crypto\\ecies\\ecies_lib.c"
int ECIES_PARAMS_init_with_type(ECIES_PARAMS *params, int type)
{
if (!params) {
ERR_put_error(16,(127),((3|64)),"crypto\\ecies\\ecies_lib.c",76);
return 0;
}
switch (type) {
case 1084:
...
break;
#line 98 "crypto\\ecies\\ecies_lib.c"
#line 99 "crypto\\ecies\\ecies_lib.c"
default:
ERR_put_error(16,(127),(142),"crypto\\ecies\\ecies_lib.c",100);
return 0;
}
return 1;
}
...
{
if (!param) {
ERR_put_error(16,(126),((3|64)),"crypto\\ecies\\ecies_lib.c",111);
#line 112 "crypto\\ecies\\ecies_lib.c"
return 0;
}
...
#line 124 "crypto\\ecies\\ecies_lib.c"
return 1;
}
KDF_FUNC ECIES_PARAMS_get_kdf(const ECIES_PARAMS *param)
{
if (!param || !param->kdf_md) {
ERR_put_error(16,(124),((3|64)),"crypto\\ecies\\ecies_lib.c",130);
return ((void *)0);
}
...
case 1067:
case 1068:
ERR_put_error(16,(124),(175),"crypto\\ecies\\ecies_lib.c",140);
return ((void *)0);
}
ERR_put_error(16,(124),(141),"crypto\\ecies\\ecies_lib.c",144);
return ((void *)0);
}
int ECIES_PARAMS_get_enc(const ECIES_PARAMS *param, size_t inlen,
const EVP_CIPHER **enc_cipher, size_t *enckeylen, size_t *ciphertextlen)
...
ERR_put_error(16,(123),((3|64)),"crypto\\ecies\\ecies_lib.c",156);
return 0;
}
...
break;
#line 170 "crypto\\ecies\\ecies_lib.c"
case 1071:
...
break;
#line 190 "crypto\\ecies\\ecies_lib.c"
default:
ERR_put_error(16,(123),(141),"crypto\\ecies\\ecies_lib.c",191);
return 0;
}
outlen = inlen;
if (cipher) {
...
if ((EVP_CIPHER_flags(cipher) & 0xF0007) == 0x2) {
...
ERR_put_error(16,(125),((3|64)),"crypto\\ecies\\ecies_lib.c",224);
return 0;
}
switch (param->mac_nid) {
case 1077:
if (!(md = param->hmac_md)) {
ERR_put_error(16,(125),(141),"crypto\\ecies\\ecies_lib.c",232);
#line 233 "crypto\\ecies\\ecies_lib.c"
return 0;
}
...
case 1078:
if (!(md = param->hmac_md)) {
ERR_put_error(16,(125),(141),"crypto\\ecies\\ecies_lib.c",241);
#line 242 "crypto\\ecies\\ecies_lib.c"
return 0;
}
keylen = EVP_MD_size(md);
...
break;
#line 258 "crypto\\ecies\\ecies_lib.c"
default:
ERR_put_error(16,(125),(141),"crypto\\ecies\\ecies_lib.c",260);
#line 261 "crypto\\ecies\\ecies_lib.c"
return 0;
}
if (cipher) {
keylen = EVP_CIPHER_key_length(cipher);
...
int e = 1;
KDF_FUNC kdf_func;
const EVP_CIPHER *enc_cipher = ((void *)0);
size_t enckeylen, ciphertextlen;
const EVP_MD *hmac_md = ((void *)0);
const EVP_CIPHER *mac_cipher = ((void *)0);
unsigned int mackeylen, maclen;
ECIES_CIPHERTEXT_VALUE *ret = ((void *)0);
const EC_GROUP *group = EC_KEY_get0_group(ec_key);
EC_KEY *ephem_key = ((void *)0);
int point_form = POINT_CONVERSION_COMPRESSED;
unsigned char *sharekey = ((void *)0);
unsigned int sharekeylen;
unsigned char *enckey, *mackey;
unsigned char mac[64];
size_t len;
if (!param || !in || !inlen || !ec_key || !group) {
ERR_put_error(16,(121),((3|64)),"crypto\\ecies\\ecies_lib.c",303);
return 0;
}
if (!(kdf_func = ECIES_PARAMS_get_kdf(param))) {
ERR_put_error(16,(121),(141),"crypto\\ecies\\ecies_lib.c",309);
goto end;
}
if (!ECIES_PARAMS_get_enc(param, inlen, &enc_cipher, &enckeylen, &ciphertextlen)) {
ERR_put_error(16,(121),(141),"crypto\\ecies\\ecies_lib.c",313);
goto end;
}
if (!ECIES_PARAMS_get_mac(param, &hmac_md, &mac_cipher, &mackeylen, &maclen)) {
ERR_put_error(16,(121),(141),"crypto\\ecies\\ecies_lib.c",317);
goto end;
}
if (!(ret = ECIES_CIPHERTEXT_VALUE_new())) {
ERR_put_error(16,(121),((1|64)),"crypto\\ecies\\ecies_lib.c",323);
return 0;
}
if (!(ephem_key = EC_KEY_new())) {
ERR_put_error(16,(121),((1|64)),"crypto\\ecies\\ecies_lib.c",329);
goto end;
}
if (!EC_KEY_set_group(ephem_key, group)) {
ERR_put_error(16,(121),(16),"crypto\\ecies\\ecies_lib.c",333);
goto end;
}
if (!EC_KEY_generate_key(ephem_key)) {
ERR_put_error(16,(121),(16),"crypto\\ecies\\ecies_lib.c",337);
goto end;
}
len = EC_POINT_point2oct(group, EC_KEY_get0_public_key(ephem_key),
point_form, ((void *)0), 0, ((void *)0));
if (!ASN1_OCTET_STRING_set(ret->ephem_point, ((void *)0), len)) {
ERR_put_error(16,(121),(13),"crypto\\ecies\\ecies_lib.c",345);
goto end;
}
if (EC_POINT_point2oct(group, EC_KEY_get0_public_key(ephem_key),
point_form, ret->ephem_point->data, len, ((void *)0)) <= 0) {
ERR_put_error(16,(121),(16),"crypto\\ecies\\ecies_lib.c",350);
goto end;
}
sharekeylen = enckeylen + mackeylen;
if (!(sharekey = CRYPTO_malloc(sharekeylen, "crypto\\ecies\\ecies_lib.c", 356))) {
ERR_put_error(16,(121),((1|64)),"crypto\\ecies\\ecies_lib.c",357);
goto end;
}
if (!ECDH_compute_key(sharekey, sharekeylen,
EC_KEY_get0_public_key(ec_key), ephem_key,
kdf_func)) {
ERR_put_error(16,(121),(114),"crypto\\ecies\\ecies_lib.c",363);
goto end;
}
enckey = sharekey;
mackey = sharekey + enckeylen;
if (!ASN1_OCTET_STRING_set(ret->ciphertext, ((void *)0), ciphertextlen)) {
ERR_put_error(16,(121),((1|64)),"crypto\\ecies\\ecies_lib.c",371);
goto end;
}
if (enc_cipher) {
EVP_CIPHER_CTX *cipher_ctx = ((void *)0);
...
ERR_put_error(16,(121),((1|64)),"crypto\\ecies\\ecies_lib.c",392);
goto end;
}
if (!EVP_EncryptInit(cipher_ctx, enc_cipher, enckey, iv)) {
ERR_put_error(16,(121),(121),"crypto\\ecies\\ecies_lib.c",396);
EVP_CIPHER_CTX_free(cipher_ctx);
goto end;
}
if (!EVP_EncryptUpdate(cipher_ctx, pout, (int *)&len, in, inlen)) {
ERR_put_error(16,(121),(121),"crypto\\ecies\\ecies_lib.c",401);
EVP_CIPHER_CTX_free(cipher_ctx);
goto end;
}
pout += len;
if (!EVP_EncryptFinal(cipher_ctx, pout, (int *)&len)) {
ERR_put_error(16,(121),(121),"crypto\\ecies\\ecies_lib.c",407);
goto end;
}
pout += len;
(void)((pout - ret->ciphertext->data == ciphertextlen) ? 0 : (OPENSSL_die("assertion failed: " "pout - ret->ciphertext->data == ciphertextlen", "crypto\\ecies\\ecies_lib.c", 412), 1));
} else {
int i;
...
ERR_put_error(16,(121),((1|64)),"crypto\\ecies\\ecies_lib.c",425);
goto end;
}
if (!CMAC_Init(cmac_ctx, mackey, mackeylen, mac_cipher, ((void *)0))) {
ERR_put_error(16,(121),(105),"crypto\\ecies\\ecies_lib.c",429);
CMAC_CTX_free(cmac_ctx);
goto end;
}
if (!CMAC_Update(cmac_ctx, ret->ciphertext->data, ret->ciphertext->length)) {
ERR_put_error(16,(121),(106),"crypto\\ecies\\ecies_lib.c",434);
CMAC_CTX_free(cmac_ctx);
goto end;
}
len = sizeof(mac);
if (!CMAC_Final(cmac_ctx, mac, &len)) {
ERR_put_error(16,(121),(104),"crypto\\ecies\\ecies_lib.c",440);
CMAC_CTX_free(cmac_ctx);
goto end;
}
(void)((len == maclen) ? 0 : (OPENSSL_die("assertion failed: " "len == maclen", "crypto\\ecies\\ecies_lib.c", 444), 1));
CMAC_CTX_free(cmac_ctx);
} else {
len = sizeof(mac);
...
mac, &maclen)) {
ERR_put_error(16,(121),(130),"crypto\\ecies\\ecies_lib.c",452);
goto end;
}
(void)((len == maclen || len/2 == maclen) ? 0 : (OPENSSL_die("assertion failed: " "len == maclen || len/2 == maclen", "crypto\\ecies\\ecies_lib.c", 455), 1));
}
if (!ASN1_OCTET_STRING_set(ret->mactag, mac, maclen)) {
ERR_put_error(16,(121),((1|64)),"crypto\\ecies\\ecies_lib.c",459);
goto end;
}
e = 0;
end:
EC_KEY_free(ephem_key);
CRYPTO_free(sharekey, "crypto\\ecies\\ecies_lib.c", 467);
if (e && ret) {
...
ERR_put_error(16,(120),((3|64)),"crypto\\ecies\\ecies_lib.c",494);
return 0;
}
if (!out) {
...
ERR_put_error(16,(120),(103),"crypto\\ecies\\ecies_lib.c",503);
return 0;
}
if (!(kdf_func = ECIES_PARAMS_get_kdf(param))) {
ERR_put_error(16,(120),(141),"crypto\\ecies\\ecies_lib.c",509);
goto end;
}
if (!ECIES_PARAMS_get_enc(param, in->ciphertext->length,
&enc_cipher, &enckeylen, &ciphertextlen)) {
ERR_put_error(16,(120),(141),"crypto\\ecies\\ecies_lib.c",514);
goto end;
}
if (!ECIES_PARAMS_get_mac(param, &hmac_md, &mac_cipher, &mackeylen, &maclen)) {
ERR_put_error(16,(120),(141),"crypto\\ecies\\ecies_lib.c",518);
goto end;
}
if (!in->ephem_point || !in->ephem_point->data || in->ephem_point->length <= 0) {
ERR_put_error(16,(120),(140),"crypto\\ecies\\ecies_lib.c",524);
goto end;
}
if (!(ephem_point = EC_POINT_new(group))) {
ERR_put_error(16,(120),((1|64)),"crypto\\ecies\\ecies_lib.c",528);
goto end;
}
if (!EC_POINT_oct2point(group, ephem_point,
in->ephem_point->data, in->ephem_point->length, ((void *)0))) {
ERR_put_error(16,(120),(140),"crypto\\ecies\\ecies_lib.c",533);
goto end;
}
sharekeylen = enckeylen + mackeylen;
if (!(sharekey = CRYPTO_malloc(sharekeylen, "crypto\\ecies\\ecies_lib.c", 539))) {
ERR_put_error(16,(120),((1|64)),"crypto\\ecies\\ecies_lib.c",540);
goto end;
}
if (!ECDH_compute_key(sharekey, sharekeylen,
ephem_point, ec_key, kdf_func)) {
ERR_put_error(16,(120),(115),"crypto\\ecies\\ecies_lib.c",545);
goto end;
}
enckey = sharekey;
mackey = sharekey + enckeylen;
if (!in->mactag || !in->mactag->data) {
ERR_put_error(16,(120),(140),"crypto\\ecies\\ecies_lib.c",553);
goto end;
}
if (mac_cipher) {
CMAC_CTX *cmac_ctx;
if (!(cmac_ctx = CMAC_CTX_new())) {
ERR_put_error(16,(120),((1|64)),"crypto\\ecies\\ecies_lib.c",560);
goto end;
}
if (!CMAC_Init(cmac_ctx, mackey, mackeylen, mac_cipher, ((void *)0))) {
ERR_put_error(16,(120),(105),"crypto\\ecies\\ecies_lib.c",564);
CMAC_CTX_free(cmac_ctx);
goto end;
}
if (!CMAC_Update(cmac_ctx, in->ciphertext->data, in->ciphertext->length)) {
ERR_put_error(16,(120),(106),"crypto\\ecies\\ecies_lib.c",569);
CMAC_CTX_free(cmac_ctx);
goto end;
}
len = sizeof(mac);
if (!CMAC_Final(cmac_ctx, mac, &len)) {
ERR_put_error(16,(120),(104),"crypto\\ecies\\ecies_lib.c",575);
CMAC_CTX_free(cmac_ctx);
goto end;
}
(void)((len == maclen) ? 0 : (OPENSSL_die("assertion failed: " "len == maclen", "crypto\\ecies\\ecies_lib.c", 579), 1));
CMAC_CTX_free(cmac_ctx);
} else {
unsigned int ulen;
ulen = sizeof(mac);
...
mac, &ulen)) {
ERR_put_error(16,(120),(125),"crypto\\ecies\\ecies_lib.c",588);
goto end;
}
len = (size_t)ulen;
(void)((len == maclen || len/2 == maclen) ? 0 : (OPENSSL_die("assertion failed: " "len == maclen || len/2 == maclen", "crypto\\ecies\\ecies_lib.c", 592), 1));
}
if (maclen != in->mactag->length) {
ERR_put_error(16,(120),(119),"crypto\\ecies\\ecies_lib.c",596);
goto end;
}
if (OPENSSL_memcmp(in->mactag->data, mac, maclen)) {
ERR_put_error(16,(120),(119),"crypto\\ecies\\ecies_lib.c",600);
goto end;
}
if (enc_cipher) {
EVP_CIPHER_CTX *cipher_ctx = ((void *)0);
...
ERR_put_error(16,(120),(140),"crypto\\ecies\\ecies_lib.c",618);
goto end;
}
...
ERR_put_error(16,(120),(140),"crypto\\ecies\\ecies_lib.c",628);
goto end;
}
inlen = in->ciphertext->length;
}
if (!(cipher_ctx = EVP_CIPHER_CTX_new())) {
ERR_put_error(16,(120),((1|64)),"crypto\\ecies\\ecies_lib.c",636);
goto end;
}
if (!EVP_DecryptInit(cipher_ctx, enc_cipher, enckey, iv)) {
ERR_put_error(16,(120),(117),"crypto\\ecies\\ecies_lib.c",641);
EVP_CIPHER_CTX_free(cipher_ctx);
goto end;
}
pout = out;
...
ERR_put_error(16,(120),(112),"crypto\\ecies\\ecies_lib.c",648);
EVP_CIPHER_CTX_free(cipher_ctx);
goto end;
}
pout += ilen;
if (!EVP_DecryptFinal(cipher_ctx, pout, &ilen)) {
ERR_put_error(16,(120),(112),"crypto\\ecies\\ecies_lib.c",654);
EVP_CIPHER_CTX_free(cipher_ctx);
goto end;
}
pout += ilen;
...
CRYPTO_free(sharekey, "crypto\\ecies\\ecies_lib.c", 672);
...
int ret = 0;
ECIES_PARAMS param;
ECIES_CIPHERTEXT_VALUE *cv = ((void *)0);
unsigned char *p = out;
int len;
if (!ECIES_PARAMS_init_with_type(&param, type)) {
ERR_put_error(16,(122),(146),"crypto\\ecies\\ecies_lib.c",687);
return 0;
}
RAND_seed(in, inlen);
if (!(cv = ECIES_do_encrypt(&param, in, inlen, ec_key))) {
ERR_put_error(16,(122),(121),"crypto\\ecies\\ecies_lib.c",693);
return 0;
}
if ((len = i2d_ECIES_CIPHERTEXT_VALUE(cv, ((void *)0))) <= 0) {
ERR_put_error(16,(122),(121),"crypto\\ecies\\ecies_lib.c",698);
goto end;
}
if (!out) {
*outlen = (size_t)len;
...
ERR_put_error(16,(122),(103),"crypto\\ecies\\ecies_lib.c",707);
*outlen = (size_t)len;
goto end;
}
if ((len = i2d_ECIES_CIPHERTEXT_VALUE(cv, &p)) <= 0) {
ERR_put_error(16,(122),(121),"crypto\\ecies\\ecies_lib.c",713);
goto end;
}
*outlen = (size_t)len;
ret = 1;
...
ECIES_CIPHERTEXT_VALUE *cv = ((void *)0);
if (!in) {
ERR_put_error(16,(119),((3|64)),"crypto\\ecies\\ecies_lib.c",733);
return 0;
}
if (inlen <= 0 || inlen > 2147483647) {
ERR_put_error(16,(119),(152),"crypto\\ecies\\ecies_lib.c",738);
return 0;
}
if (!ECIES_PARAMS_init_with_type(&param, type)) {
ERR_put_error(16,(119),(146),"crypto\\ecies\\ecies_lib.c",743);
return 0;
}
if (!(cv = d2i_ECIES_CIPHERTEXT_VALUE(((void *)0), &in, (long)inlen))) {
ERR_put_error(16,(119),(140),"crypto\\ecies\\ecies_lib.c",748);
return 0;
}
if (inlen != i2d_ECIES_CIPHERTEXT_VALUE(cv, ((void *)0))) {
ERR_put_error(16,(119),(140),"crypto\\ecies\\ecies_lib.c",753);
goto end;
}
if (!ECIES_do_decrypt(&param, cv, out, outlen, ec_key)) {
ERR_put_error(16,(119),(122),"crypto\\ecies\\ecies_lib.c",758);
goto end;
}
ret = 1;
end:
