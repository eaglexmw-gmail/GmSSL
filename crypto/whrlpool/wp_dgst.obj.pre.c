#line 1 "crypto\\whrlpool\\wp_dgst.c"
...
#line 64 "crypto\\whrlpool\\wp_dgst.c"
...
#line 65 "crypto\\whrlpool\\wp_dgst.c"
...
#line 66 "crypto\\whrlpool\\wp_dgst.c"
int WHIRLPOOL_Init(WHIRLPOOL_CTX *c)
{
    memset(c, 0, sizeof(*c));
    return (1);
...
#line 143 "crypto\\whrlpool\\wp_dgst.c"
    {
        while (bits)
        {
            unsigned int byteoff = bitoff / 8;
...
#line 177 "crypto\\whrlpool\\wp_dgst.c"
                if (bits >= 8)
                {
