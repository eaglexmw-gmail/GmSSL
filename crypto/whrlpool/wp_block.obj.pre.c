...
do { extern unsigned long OPENSSL_ia32cap_P[]; void whirlpool_block_mmx(void *,const void *,size_t); if (!(OPENSSL_ia32cap_P[0] & (1<<23))) break; whirlpool_block_mmx(ctx->H.c,inp,n); return; } while (0);
