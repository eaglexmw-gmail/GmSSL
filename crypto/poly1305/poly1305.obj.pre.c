#line 1 "crypto\\poly1305\\poly1305.c"
...
#line 11 "crypto\\poly1305\\poly1305.c"
...
#line 12 "crypto\\poly1305\\poly1305.c"
...
#line 13 "crypto\\poly1305\\poly1305.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\crypto\\include\\internal/poly1305.h"
...
#line 11 "D:\\07.OpenSrc\\GmSSL\\crypto\\include\\internal/poly1305.h"
typedef struct poly1305_context POLY1305;
size_t Poly1305_ctx_size(void);
void Poly1305_Init(POLY1305 *ctx, const unsigned char key[32]);
void Poly1305_Update(POLY1305 *ctx, const unsigned char *inp, size_t len);
void Poly1305_Final(POLY1305 *ctx, unsigned char mac[16]);
#line 15 "crypto\\poly1305\\poly1305.c"
...
void poly1305_emit(void *ctx, unsigned char mac[16],
                   const unsigned int nonce[4]);
#line 453 "crypto\\poly1305\\poly1305.c"
void Poly1305_Init(POLY1305 *ctx, const unsigned char key[32])
{
...
#line 475 "crypto\\poly1305\\poly1305.c"
    ctx->num = 0;
}
#line 488 "crypto\\poly1305\\poly1305.c"
void Poly1305_Update(POLY1305 *ctx, const unsigned char *inp, size_t len)
{
    poly1305_blocks_f poly1305_blocks_p = ctx->func.blocks;
#line 500 "crypto\\poly1305\\poly1305.c"
    size_t rem, num;
    if ((num = ctx->num))
    {
        rem = 16 - num;
        if (len >= rem)
        {
            ...
            (*poly1305_blocks_p)(ctx->opaque, ctx->data, 16, 1);
            inp += rem;
            len -= rem;
        }
        else
    ...
    if (len >= 16)
    {
        (*poly1305_blocks_p)(ctx->opaque, inp, len, 1);
        inp += len;
    }
    if (rem)
...
#line 537 "crypto\\poly1305\\poly1305.c"
    size_t num;
    if ((num = ctx->num))
    {
        ctx->data[num++] = 1;
        while (num < 16)
            ctx->data[num++] = 0;
        (*poly1305_blocks_p)(ctx->opaque, ctx->data, 16, 0);
    }
    (*poly1305_emit_p)(ctx->opaque, mac, ctx->nonce);
