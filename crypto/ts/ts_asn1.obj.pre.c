...
static const ASN1_ITEM * TS_MSG_IMPRINT_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, TS_MSG_IMPRINT_seq_tt, sizeof(TS_MSG_IMPRINT_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(TS_MSG_IMPRINT), "TS_MSG_IMPRINT" };
    return &local_it;
}
...
static const ASN1_ITEM * TS_REQ_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, TS_REQ_seq_tt, sizeof(TS_REQ_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(TS_REQ), "TS_REQ" };
    return &local_it;
}
...
static const ASN1_ITEM * TS_ACCURACY_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, TS_ACCURACY_seq_tt, sizeof(TS_ACCURACY_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(TS_ACCURACY), "TS_ACCURACY" };
    return &local_it;
}
...
static const ASN1_ITEM * TS_TST_INFO_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, TS_TST_INFO_seq_tt, sizeof(TS_TST_INFO_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(TS_TST_INFO), "TS_TST_INFO" };
    return &local_it;
}
...
static const ASN1_ITEM * TS_STATUS_INFO_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, TS_STATUS_INFO_seq_tt, sizeof(TS_STATUS_INFO_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(TS_STATUS_INFO), "TS_STATUS_INFO" };
    return &local_it;
}
...
static const ASN1_AUX TS_RESP_aux = {((void *)0), 0, 0, 0, ts_resp_cb, 0};
...
static const ASN1_ITEM * TS_RESP_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, TS_RESP_seq_tt, sizeof(TS_RESP_seq_tt) / sizeof(ASN1_TEMPLATE), &TS_RESP_aux, sizeof(TS_RESP), "TS_RESP" };
    return &local_it;
}
...
static const ASN1_ITEM * ESS_ISSUER_SERIAL_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, ESS_ISSUER_SERIAL_seq_tt, sizeof(ESS_ISSUER_SERIAL_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(ESS_ISSUER_SERIAL), "ESS_ISSUER_SERIAL" };
    return &local_it;
}
...
static const ASN1_ITEM * ESS_CERT_ID_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, ESS_CERT_ID_seq_tt, sizeof(ESS_CERT_ID_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(ESS_CERT_ID), "ESS_CERT_ID" };
    return &local_it;
}
...
static const ASN1_ITEM * ESS_SIGNING_CERT_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, ESS_SIGNING_CERT_seq_tt, sizeof(ESS_SIGNING_CERT_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(ESS_SIGNING_CERT), "ESS_SIGNING_CERT" };
    return &local_it;
}
