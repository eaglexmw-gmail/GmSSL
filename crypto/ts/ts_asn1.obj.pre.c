...
#line 13 "crypto\\ts\\ts_asn1.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\ts\\ts_lcl.h"
...
#line 14 "crypto\\ts\\ts_asn1.c"
static const ASN1_TEMPLATE TS_MSG_IMPRINT_seq_tt[] = {
{ (0), (0), (size_t)&(((TS_MSG_IMPRINT *)0)->hash_algo), "hash_algo", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((TS_MSG_IMPRINT *)0)->hashed_msg), "hashed_msg", (ASN1_OCTET_STRING_it) }
} ; static const ASN1_ITEM * TS_MSG_IMPRINT_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, TS_MSG_IMPRINT_seq_tt, sizeof(TS_MSG_IMPRINT_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(TS_MSG_IMPRINT), "TS_MSG_IMPRINT" }; return &local_it; }
TS_MSG_IMPRINT *d2i_TS_MSG_IMPRINT(TS_MSG_IMPRINT **a, const unsigned char **in, long len) { return (TS_MSG_IMPRINT *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (TS_MSG_IMPRINT_it())); } int i2d_TS_MSG_IMPRINT(const TS_MSG_IMPRINT *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (TS_MSG_IMPRINT_it())); } TS_MSG_IMPRINT *TS_MSG_IMPRINT_new(void) { return (TS_MSG_IMPRINT *)ASN1_item_new((TS_MSG_IMPRINT_it())); } void TS_MSG_IMPRINT_free(TS_MSG_IMPRINT *a) { ASN1_item_free((ASN1_VALUE *)a, (TS_MSG_IMPRINT_it())); }
TS_MSG_IMPRINT * TS_MSG_IMPRINT_dup(TS_MSG_IMPRINT *x) { return ASN1_item_dup((TS_MSG_IMPRINT_it()), x); }
...
#line 44 "crypto\\ts\\ts_asn1.c"
static const ASN1_TEMPLATE TS_REQ_seq_tt[] = {
{ (0), (0), (size_t)&(((TS_REQ *)0)->version), "version", (ASN1_INTEGER_it) },
{ (0), (0), (size_t)&(((TS_REQ *)0)->msg_imprint), "msg_imprint", (TS_MSG_IMPRINT_it) },
{ ((0x1)), (0), (size_t)&(((TS_REQ *)0)->policy_id), "policy_id", (ASN1_OBJECT_it) },
{ ((0x1)), (0), (size_t)&(((TS_REQ *)0)->nonce), "nonce", (ASN1_INTEGER_it) },
{ ((0x1)), (0), (size_t)&(((TS_REQ *)0)->cert_req), "cert_req", (ASN1_FBOOLEAN_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x2 << 1)|(0x1)), (0), (size_t)&(((TS_REQ *)0)->extensions), "extensions", (X509_EXTENSION_it) }
} ; static const ASN1_ITEM * TS_REQ_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, TS_REQ_seq_tt, sizeof(TS_REQ_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(TS_REQ), "TS_REQ" }; return &local_it; }
TS_REQ *d2i_TS_REQ(TS_REQ **a, const unsigned char **in, long len) { return (TS_REQ *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (TS_REQ_it())); } int i2d_TS_REQ(const TS_REQ *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (TS_REQ_it())); } TS_REQ *TS_REQ_new(void) { return (TS_REQ *)ASN1_item_new((TS_REQ_it())); } void TS_REQ_free(TS_REQ *a) { ASN1_item_free((ASN1_VALUE *)a, (TS_REQ_it())); }
TS_REQ * TS_REQ_dup(TS_REQ *x) { return ASN1_item_dup((TS_REQ_it()), x); }
...
#line 76 "crypto\\ts\\ts_asn1.c"
static const ASN1_TEMPLATE TS_ACCURACY_seq_tt[] = {
{ ((0x1)), (0), (size_t)&(((TS_ACCURACY *)0)->seconds), "seconds", (ASN1_INTEGER_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((TS_ACCURACY *)0)->millis), "millis", (ASN1_INTEGER_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x1)), (1), (size_t)&(((TS_ACCURACY *)0)->micros), "micros", (ASN1_INTEGER_it) }
} ; static const ASN1_ITEM * TS_ACCURACY_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, TS_ACCURACY_seq_tt, sizeof(TS_ACCURACY_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(TS_ACCURACY), "TS_ACCURACY" }; return &local_it; }
TS_ACCURACY *d2i_TS_ACCURACY(TS_ACCURACY **a, const unsigned char **in, long len) { return (TS_ACCURACY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (TS_ACCURACY_it())); } int i2d_TS_ACCURACY(const TS_ACCURACY *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (TS_ACCURACY_it())); } TS_ACCURACY *TS_ACCURACY_new(void) { return (TS_ACCURACY *)ASN1_item_new((TS_ACCURACY_it())); } void TS_ACCURACY_free(TS_ACCURACY *a) { ASN1_item_free((ASN1_VALUE *)a, (TS_ACCURACY_it())); }
TS_ACCURACY * TS_ACCURACY_dup(TS_ACCURACY *x) { return ASN1_item_dup((TS_ACCURACY_it()), x); }
static const ASN1_TEMPLATE TS_TST_INFO_seq_tt[] = {
{ (0), (0), (size_t)&(((TS_TST_INFO *)0)->version), "version", (ASN1_INTEGER_it) },
{ (0), (0), (size_t)&(((TS_TST_INFO *)0)->policy_id), "policy_id", (ASN1_OBJECT_it) },
{ (0), (0), (size_t)&(((TS_TST_INFO *)0)->msg_imprint), "msg_imprint", (TS_MSG_IMPRINT_it) },
{ (0), (0), (size_t)&(((TS_TST_INFO *)0)->serial), "serial", (ASN1_INTEGER_it) },
{ (0), (0), (size_t)&(((TS_TST_INFO *)0)->time), "time", (ASN1_GENERALIZEDTIME_it) },
{ ((0x1)), (0), (size_t)&(((TS_TST_INFO *)0)->accuracy), "accuracy", (TS_ACCURACY_it) },
{ ((0x1)), (0), (size_t)&(((TS_TST_INFO *)0)->ordering), "ordering", (ASN1_FBOOLEAN_it) },
{ ((0x1)), (0), (size_t)&(((TS_TST_INFO *)0)->nonce), "nonce", (ASN1_INTEGER_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((TS_TST_INFO *)0)->tsa), "tsa", (GENERAL_NAME_it) },
{ ((0x1 << 3)|(0x2<<6) | (0x2 << 1)|(0x1)), (1), (size_t)&(((TS_TST_INFO *)0)->extensions), "extensions", (X509_EXTENSION_it) }
} ; static const ASN1_ITEM * TS_TST_INFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, TS_TST_INFO_seq_tt, sizeof(TS_TST_INFO_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(TS_TST_INFO), "TS_TST_INFO" }; return &local_it; }
TS_TST_INFO *d2i_TS_TST_INFO(TS_TST_INFO **a, const unsigned char **in, long len) { return (TS_TST_INFO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (TS_TST_INFO_it())); } int i2d_TS_TST_INFO(const TS_TST_INFO *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (TS_TST_INFO_it())); } TS_TST_INFO *TS_TST_INFO_new(void) { return (TS_TST_INFO *)ASN1_item_new((TS_TST_INFO_it())); } void TS_TST_INFO_free(TS_TST_INFO *a) { ASN1_item_free((ASN1_VALUE *)a, (TS_TST_INFO_it())); }
TS_TST_INFO * TS_TST_INFO_dup(TS_TST_INFO *x) { return ASN1_item_dup((TS_TST_INFO_it()), x); }
...
#line 116 "crypto\\ts\\ts_asn1.c"
}
int i2d_TS_TST_INFO_fp(FILE *fp, TS_TST_INFO *a)
{
return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_TS_TST_INFO : ((int (*)(const TS_TST_INFO *,unsigned char **))0))), fp, ((void*) (1 ? a : (const TS_TST_INFO*)0))));
}
#line 123 "crypto\\ts\\ts_asn1.c"
static const ASN1_TEMPLATE TS_STATUS_INFO_seq_tt[] = {
{ (0), (0), (size_t)&(((TS_STATUS_INFO *)0)->status), "status", (ASN1_INTEGER_it) },
{ ((0x2 << 1)|(0x1)), (0), (size_t)&(((TS_STATUS_INFO *)0)->text), "text", (ASN1_UTF8STRING_it) },
{ ((0x1)), (0), (size_t)&(((TS_STATUS_INFO *)0)->failure_info), "failure_info", (ASN1_BIT_STRING_it) }
} ; static const ASN1_ITEM * TS_STATUS_INFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, TS_STATUS_INFO_seq_tt, sizeof(TS_STATUS_INFO_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(TS_STATUS_INFO), "TS_STATUS_INFO" }; return &local_it; }
TS_STATUS_INFO *d2i_TS_STATUS_INFO(TS_STATUS_INFO **a, const unsigned char **in, long len) { return (TS_STATUS_INFO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (TS_STATUS_INFO_it())); } int i2d_TS_STATUS_INFO(const TS_STATUS_INFO *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (TS_STATUS_INFO_it())); } TS_STATUS_INFO *TS_STATUS_INFO_new(void) { return (TS_STATUS_INFO *)ASN1_item_new((TS_STATUS_INFO_it())); } void TS_STATUS_INFO_free(TS_STATUS_INFO *a) { ASN1_item_free((ASN1_VALUE *)a, (TS_STATUS_INFO_it())); }
TS_STATUS_INFO * TS_STATUS_INFO_dup(TS_STATUS_INFO *x) { return ASN1_item_dup((TS_STATUS_INFO_it()), x); }
...
ERR_put_error(47,(150),(131),"crypto\\ts\\ts_asn1.c",141);
return 0;
}
TS_TST_INFO_free(a->tst_info);
a->tst_info = PKCS7_to_TS_TST_INFO(a->token);
if (!a->tst_info) {
ERR_put_error(47,(150),(129),"crypto\\ts\\ts_asn1.c",148);
#line 149 "crypto\\ts\\ts_asn1.c"
return 0;
}
} else if (status == 0 || status == 1) {
ERR_put_error(47,(150),(130),"crypto\\ts\\ts_asn1.c",152);
return 0;
}
return 1;
}
...
static const ASN1_AUX TS_RESP_aux = {((void *)0), 0, 0, 0, ts_resp_cb, 0}; static const ASN1_TEMPLATE TS_RESP_seq_tt[] = {
{ (0), (0), (size_t)&(((TS_RESP *)0)->status_info), "status_info", (TS_STATUS_INFO_it) },
{ ((0x1)), (0), (size_t)&(((TS_RESP *)0)->token), "token", (PKCS7_it) },
} ; static const ASN1_ITEM * TS_RESP_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, TS_RESP_seq_tt, sizeof(TS_RESP_seq_tt) / sizeof(ASN1_TEMPLATE), &TS_RESP_aux, sizeof(TS_RESP), "TS_RESP" }; return &local_it; }
...
TS_RESP * TS_RESP_dup(TS_RESP *x) { return ASN1_item_dup((TS_RESP_it()), x); }
...
#line 203 "crypto\\ts\\ts_asn1.c"
static const ASN1_TEMPLATE ESS_ISSUER_SERIAL_seq_tt[] = {
{ ((0x2 << 1)), (0), (size_t)&(((ESS_ISSUER_SERIAL *)0)->issuer), "issuer", (GENERAL_NAME_it) },
{ (0), (0), (size_t)&(((ESS_ISSUER_SERIAL *)0)->serial), "serial", (ASN1_INTEGER_it) }
} ; static const ASN1_ITEM * ESS_ISSUER_SERIAL_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ESS_ISSUER_SERIAL_seq_tt, sizeof(ESS_ISSUER_SERIAL_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(ESS_ISSUER_SERIAL), "ESS_ISSUER_SERIAL" }; return &local_it; }
ESS_ISSUER_SERIAL *d2i_ESS_ISSUER_SERIAL(ESS_ISSUER_SERIAL **a, const unsigned char **in, long len) { return (ESS_ISSUER_SERIAL *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ESS_ISSUER_SERIAL_it())); } int i2d_ESS_ISSUER_SERIAL(const ESS_ISSUER_SERIAL *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (ESS_ISSUER_SERIAL_it())); } ESS_ISSUER_SERIAL *ESS_ISSUER_SERIAL_new(void) { return (ESS_ISSUER_SERIAL *)ASN1_item_new((ESS_ISSUER_SERIAL_it())); } void ESS_ISSUER_SERIAL_free(ESS_ISSUER_SERIAL *a) { ASN1_item_free((ASN1_VALUE *)a, (ESS_ISSUER_SERIAL_it())); }
ESS_ISSUER_SERIAL * ESS_ISSUER_SERIAL_dup(ESS_ISSUER_SERIAL *x) { return ASN1_item_dup((ESS_ISSUER_SERIAL_it()), x); }
static const ASN1_TEMPLATE ESS_CERT_ID_seq_tt[] = {
{ (0), (0), (size_t)&(((ESS_CERT_ID *)0)->hash), "hash", (ASN1_OCTET_STRING_it) },
{ ((0x1)), (0), (size_t)&(((ESS_CERT_ID *)0)->issuer_serial), "issuer_serial", (ESS_ISSUER_SERIAL_it) }
} ; static const ASN1_ITEM * ESS_CERT_ID_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ESS_CERT_ID_seq_tt, sizeof(ESS_CERT_ID_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(ESS_CERT_ID), "ESS_CERT_ID" }; return &local_it; }
ESS_CERT_ID *d2i_ESS_CERT_ID(ESS_CERT_ID **a, const unsigned char **in, long len) { return (ESS_CERT_ID *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ESS_CERT_ID_it())); } int i2d_ESS_CERT_ID(const ESS_CERT_ID *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (ESS_CERT_ID_it())); } ESS_CERT_ID *ESS_CERT_ID_new(void) { return (ESS_CERT_ID *)ASN1_item_new((ESS_CERT_ID_it())); } void ESS_CERT_ID_free(ESS_CERT_ID *a) { ASN1_item_free((ASN1_VALUE *)a, (ESS_CERT_ID_it())); }
ESS_CERT_ID * ESS_CERT_ID_dup(ESS_CERT_ID *x) { return ASN1_item_dup((ESS_CERT_ID_it()), x); }
static const ASN1_TEMPLATE ESS_SIGNING_CERT_seq_tt[] = {
{ ((0x2 << 1)), (0), (size_t)&(((ESS_SIGNING_CERT *)0)->cert_ids), "cert_ids", (ESS_CERT_ID_it) },
{ ((0x2 << 1)|(0x1)), (0), (size_t)&(((ESS_SIGNING_CERT *)0)->policy_info), "policy_info", (POLICYINFO_it) }
} ; static const ASN1_ITEM * ESS_SIGNING_CERT_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ESS_SIGNING_CERT_seq_tt, sizeof(ESS_SIGNING_CERT_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(ESS_SIGNING_CERT), "ESS_SIGNING_CERT" }; return &local_it; }
ESS_SIGNING_CERT *d2i_ESS_SIGNING_CERT(ESS_SIGNING_CERT **a, const unsigned char **in, long len) { return (ESS_SIGNING_CERT *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ESS_SIGNING_CERT_it())); } int i2d_ESS_SIGNING_CERT(const ESS_SIGNING_CERT *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (ESS_SIGNING_CERT_it())); } ESS_SIGNING_CERT *ESS_SIGNING_CERT_new(void) { return (ESS_SIGNING_CERT *)ASN1_item_new((ESS_SIGNING_CERT_it())); } void ESS_SIGNING_CERT_free(ESS_SIGNING_CERT *a) { ASN1_item_free((ASN1_VALUE *)a, (ESS_SIGNING_CERT_it())); }
ESS_SIGNING_CERT * ESS_SIGNING_CERT_dup(ESS_SIGNING_CERT *x) { return ASN1_item_dup((ESS_SIGNING_CERT_it()), x); }
TS_TST_INFO *PKCS7_to_TS_TST_INFO(PKCS7 *token)
{
...
ERR_put_error(47,(148),(132),"crypto\\ts\\ts_asn1.c",238);
return ((void *)0);
}
if (PKCS7_ctrl(token,2,0,((void *)0))) {
ERR_put_error(47,(148),(134),"crypto\\ts\\ts_asn1.c",242);
return ((void *)0);
}
pkcs7_signed = token->d.sign;
enveloped = pkcs7_signed->contents;
if (OBJ_obj2nid(enveloped->type) != 207) {
ERR_put_error(47,(148),(132),"crypto\\ts\\ts_asn1.c",248);
return ((void *)0);
}
tst_info_wrapper = enveloped->d.other;
if (tst_info_wrapper->type != 4) {
ERR_put_error(47,(148),(133),"crypto\\ts\\ts_asn1.c",253);
return ((void *)0);
}
tst_info_der = tst_info_wrapper->value.octet_string;
p = tst_info_der->data;
return d2i_TS_TST_INFO(((void *)0), &p, tst_info_der->length);
}
