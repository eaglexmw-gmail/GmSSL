...
typedef int (*sk_EVP_PKEY_METHOD_compfunc)(const EVP_PKEY_METHOD * const *a, const EVP_PKEY_METHOD *const *b);
typedef void (*sk_EVP_PKEY_METHOD_freefunc)(EVP_PKEY_METHOD *a);
typedef EVP_PKEY_METHOD * (*sk_EVP_PKEY_METHOD_copyfunc)(const EVP_PKEY_METHOD *a);
static __inline int sk_EVP_PKEY_METHOD_num(const struct stack_st_EVP_PKEY_METHOD *sk)
{
    return OPENSSL_sk_num((const OPENSSL_STACK *)sk);
}
static __inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_value(const struct stack_st_EVP_PKEY_METHOD *sk, int idx)
{
    return (const EVP_PKEY_METHOD *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx);
}
static __inline struct stack_st_EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_new(sk_EVP_PKEY_METHOD_compfunc compare)
{
    return (struct stack_st_EVP_PKEY_METHOD *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare);
}
static __inline struct stack_st_EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_new_null(void)
{
    return (struct stack_st_EVP_PKEY_METHOD *)OPENSSL_sk_new_null();
}
static __inline void sk_EVP_PKEY_METHOD_free(struct stack_st_EVP_PKEY_METHOD *sk)
{
    OPENSSL_sk_free((OPENSSL_STACK *)sk);
}
static __inline void sk_EVP_PKEY_METHOD_zero(struct stack_st_EVP_PKEY_METHOD *sk)
{
    OPENSSL_sk_zero((OPENSSL_STACK *)sk);
}
static __inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_delete(struct stack_st_EVP_PKEY_METHOD *sk, int i)
{
    return (const EVP_PKEY_METHOD *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i);
}
static __inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_delete_ptr(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr)
{
    return (const EVP_PKEY_METHOD *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_EVP_PKEY_METHOD_push(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr)
{
    return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_EVP_PKEY_METHOD_unshift(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr)
{
    return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_pop(struct stack_st_EVP_PKEY_METHOD *sk)
{
    return (const EVP_PKEY_METHOD *)OPENSSL_sk_pop((OPENSSL_STACK *)sk);
}
static __inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_shift(struct stack_st_EVP_PKEY_METHOD *sk)
{
    return (const EVP_PKEY_METHOD *)OPENSSL_sk_shift((OPENSSL_STACK *)sk);
}
static __inline void sk_EVP_PKEY_METHOD_pop_free(struct stack_st_EVP_PKEY_METHOD *sk, sk_EVP_PKEY_METHOD_freefunc freefunc)
{
    OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc);
}
static __inline int sk_EVP_PKEY_METHOD_insert(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr, int idx)
{
    return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx);
}
static __inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_set(struct stack_st_EVP_PKEY_METHOD *sk, int idx, const EVP_PKEY_METHOD *ptr)
{
    return (const EVP_PKEY_METHOD *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr);
}
static __inline int sk_EVP_PKEY_METHOD_find(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr)
{
    return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_EVP_PKEY_METHOD_find_ex(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr)
{
    return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline void sk_EVP_PKEY_METHOD_sort(struct stack_st_EVP_PKEY_METHOD *sk)
{
    OPENSSL_sk_sort((OPENSSL_STACK *)sk);
}
static __inline int sk_EVP_PKEY_METHOD_is_sorted(const struct stack_st_EVP_PKEY_METHOD *sk)
{
    return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_EVP_PKEY_METHOD * sk_EVP_PKEY_METHOD_dup(const struct stack_st_EVP_PKEY_METHOD *sk)
{
    return (struct stack_st_EVP_PKEY_METHOD *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_deep_copy(const struct stack_st_EVP_PKEY_METHOD *sk, sk_EVP_PKEY_METHOD_copyfunc copyfunc, sk_EVP_PKEY_METHOD_freefunc freefunc)
{
...
static __inline sk_EVP_PKEY_METHOD_compfunc sk_EVP_PKEY_METHOD_set_cmp_func(struct stack_st_EVP_PKEY_METHOD *sk, sk_EVP_PKEY_METHOD_compfunc compare)
{
    return (sk_EVP_PKEY_METHOD_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare);
}
...
typedef int (*sk_EVP_PBE_CTL_compfunc)(const EVP_PBE_CTL * const *a, const EVP_PBE_CTL *const *b);
typedef void (*sk_EVP_PBE_CTL_freefunc)(EVP_PBE_CTL *a);
typedef EVP_PBE_CTL * (*sk_EVP_PBE_CTL_copyfunc)(const EVP_PBE_CTL *a);
static __inline int sk_EVP_PBE_CTL_num(const struct stack_st_EVP_PBE_CTL *sk)
{
    return OPENSSL_sk_num((const OPENSSL_STACK *)sk);
}
static __inline EVP_PBE_CTL *sk_EVP_PBE_CTL_value(const struct stack_st_EVP_PBE_CTL *sk, int idx)
{
    return (EVP_PBE_CTL *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx);
}
static __inline struct stack_st_EVP_PBE_CTL *sk_EVP_PBE_CTL_new(sk_EVP_PBE_CTL_compfunc compare)
{
    return (struct stack_st_EVP_PBE_CTL *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare);
}
static __inline struct stack_st_EVP_PBE_CTL *sk_EVP_PBE_CTL_new_null(void)
{
    return (struct stack_st_EVP_PBE_CTL *)OPENSSL_sk_new_null();
}
static __inline void sk_EVP_PBE_CTL_free(struct stack_st_EVP_PBE_CTL *sk)
{
    OPENSSL_sk_free((OPENSSL_STACK *)sk);
}
static __inline void sk_EVP_PBE_CTL_zero(struct stack_st_EVP_PBE_CTL *sk)
{
    OPENSSL_sk_zero((OPENSSL_STACK *)sk);
}
static __inline EVP_PBE_CTL *sk_EVP_PBE_CTL_delete(struct stack_st_EVP_PBE_CTL *sk, int i)
{
    return (EVP_PBE_CTL *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i);
}
static __inline EVP_PBE_CTL *sk_EVP_PBE_CTL_delete_ptr(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr)
{
    return (EVP_PBE_CTL *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_EVP_PBE_CTL_push(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr)
{
    return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_EVP_PBE_CTL_unshift(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr)
{
    return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline EVP_PBE_CTL *sk_EVP_PBE_CTL_pop(struct stack_st_EVP_PBE_CTL *sk)
{
    return (EVP_PBE_CTL *)OPENSSL_sk_pop((OPENSSL_STACK *)sk);
}
static __inline EVP_PBE_CTL *sk_EVP_PBE_CTL_shift(struct stack_st_EVP_PBE_CTL *sk)
{
    return (EVP_PBE_CTL *)OPENSSL_sk_shift((OPENSSL_STACK *)sk);
}
static __inline void sk_EVP_PBE_CTL_pop_free(struct stack_st_EVP_PBE_CTL *sk, sk_EVP_PBE_CTL_freefunc freefunc)
{
    OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc);
}
static __inline int sk_EVP_PBE_CTL_insert(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr, int idx)
{
    return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx);
}
static __inline EVP_PBE_CTL *sk_EVP_PBE_CTL_set(struct stack_st_EVP_PBE_CTL *sk, int idx, EVP_PBE_CTL *ptr)
{
    return (EVP_PBE_CTL *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr);
}
static __inline int sk_EVP_PBE_CTL_find(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr)
{
    return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_EVP_PBE_CTL_find_ex(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr)
{
    return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline void sk_EVP_PBE_CTL_sort(struct stack_st_EVP_PBE_CTL *sk)
{
    OPENSSL_sk_sort((OPENSSL_STACK *)sk);
}
static __inline int sk_EVP_PBE_CTL_is_sorted(const struct stack_st_EVP_PBE_CTL *sk)
{
    return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_EVP_PBE_CTL * sk_EVP_PBE_CTL_dup(const struct stack_st_EVP_PBE_CTL *sk)
{
    return (struct stack_st_EVP_PBE_CTL *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_EVP_PBE_CTL *sk_EVP_PBE_CTL_deep_copy(const struct stack_st_EVP_PBE_CTL *sk, sk_EVP_PBE_CTL_copyfunc copyfunc, sk_EVP_PBE_CTL_freefunc freefunc)
{
    return (struct stack_st_EVP_PBE_CTL *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc);
}
static __inline sk_EVP_PBE_CTL_compfunc sk_EVP_PBE_CTL_set_cmp_func(struct stack_st_EVP_PBE_CTL *sk, sk_EVP_PBE_CTL_compfunc compare)
{
    return (sk_EVP_PBE_CTL_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare);
}
...
#line 1076 "crypto\\evp\\e_aes.c"
    ...
    else if ((OPENSSL_ia32cap_P[1]&(1<<(41-32))))
    {
...
static const EVP_CIPHER aesni_128_cbc = { 419,16,128/8,16, 0|0x1000|0x2, aesni_init_key, aesni_cbc_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_128_cbc = { 419,16, 128/8,16, 0|0x1000|0x2, aes_init_key, aes_cbc_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_128_cbc(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_cbc:&aes_128_cbc;
}
static const EVP_CIPHER aesni_128_ecb = { 418,16,128/8,0, 0|0x1000|0x1, aesni_init_key, aesni_ecb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_128_ecb = { 418,16, 128/8,0, 0|0x1000|0x1, aes_init_key, aes_ecb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_128_ecb(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_ecb:&aes_128_ecb;
}
static const EVP_CIPHER aesni_128_ofb = { 420,1,128/8,16, 0|0x1000|0x4, aesni_init_key, aes_ofb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_128_ofb = { 420,1, 128/8,16, 0|0x1000|0x4, aes_init_key, aes_ofb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_128_ofb(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_ofb:&aes_128_ofb;
}
static const EVP_CIPHER aesni_128_cfb = { 421,1,128/8,16, 0|0x1000|0x3, aesni_init_key, aes_cfb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_128_cfb = { 421,1, 128/8,16, 0|0x1000|0x3, aes_init_key, aes_cfb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_128_cfb128(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_cfb:&aes_128_cfb;
}
static const EVP_CIPHER aesni_128_cfb1 = { 650,1,128/8,16, 0|0x3, aesni_init_key, aes_cfb1_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_128_cfb1 = { 650,1, 128/8,16, 0|0x3, aes_init_key, aes_cfb1_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_128_cfb1(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_cfb1:&aes_128_cfb1;
}
static const EVP_CIPHER aesni_128_cfb8 = { 653,1,128/8,16, 0|0x3, aesni_init_key, aes_cfb8_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_128_cfb8 = { 653,1, 128/8,16, 0|0x3, aes_init_key, aes_cfb8_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_128_cfb8(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_cfb8:&aes_128_cfb8;
}
static const EVP_CIPHER aesni_128_ctr = { 904,1,128/8,16, 0|0x5, aesni_init_key, aes_ctr_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_128_ctr = { 904,1, 128/8,16, 0|0x5, aes_init_key, aes_ctr_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_128_ctr(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_ctr:&aes_128_ctr;
}
static const EVP_CIPHER aesni_192_cbc = { 423,16,192/8,16, 0|0x1000|0x2, aesni_init_key, aesni_cbc_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_192_cbc = { 423,16, 192/8,16, 0|0x1000|0x2, aes_init_key, aes_cbc_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_192_cbc(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_192_cbc:&aes_192_cbc;
}
static const EVP_CIPHER aesni_192_ecb = { 422,16,192/8,0, 0|0x1000|0x1, aesni_init_key, aesni_ecb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_192_ecb = { 422,16, 192/8,0, 0|0x1000|0x1, aes_init_key, aes_ecb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_192_ecb(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_192_ecb:&aes_192_ecb;
}
static const EVP_CIPHER aesni_192_ofb = { 424,1,192/8,16, 0|0x1000|0x4, aesni_init_key, aes_ofb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_192_ofb = { 424,1, 192/8,16, 0|0x1000|0x4, aes_init_key, aes_ofb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_192_ofb(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_192_ofb:&aes_192_ofb;
}
static const EVP_CIPHER aesni_192_cfb = { 425,1,192/8,16, 0|0x1000|0x3, aesni_init_key, aes_cfb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_192_cfb = { 425,1, 192/8,16, 0|0x1000|0x3, aes_init_key, aes_cfb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_192_cfb128(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_192_cfb:&aes_192_cfb;
}
static const EVP_CIPHER aesni_192_cfb1 = { 651,1,192/8,16, 0|0x3, aesni_init_key, aes_cfb1_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_192_cfb1 = { 651,1, 192/8,16, 0|0x3, aes_init_key, aes_cfb1_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_192_cfb1(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_192_cfb1:&aes_192_cfb1;
}
static const EVP_CIPHER aesni_192_cfb8 = { 654,1,192/8,16, 0|0x3, aesni_init_key, aes_cfb8_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_192_cfb8 = { 654,1, 192/8,16, 0|0x3, aes_init_key, aes_cfb8_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_192_cfb8(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_192_cfb8:&aes_192_cfb8;
}
static const EVP_CIPHER aesni_192_ctr = { 905,1,192/8,16, 0|0x5, aesni_init_key, aes_ctr_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_192_ctr = { 905,1, 192/8,16, 0|0x5, aes_init_key, aes_ctr_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_192_ctr(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_192_ctr:&aes_192_ctr;
}
static const EVP_CIPHER aesni_256_cbc = { 427,16,256/8,16, 0|0x1000|0x2, aesni_init_key, aesni_cbc_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_256_cbc = { 427,16, 256/8,16, 0|0x1000|0x2, aes_init_key, aes_cbc_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_256_cbc(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_256_cbc:&aes_256_cbc;
}
static const EVP_CIPHER aesni_256_ecb = { 426,16,256/8,0, 0|0x1000|0x1, aesni_init_key, aesni_ecb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_256_ecb = { 426,16, 256/8,0, 0|0x1000|0x1, aes_init_key, aes_ecb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_256_ecb(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_256_ecb:&aes_256_ecb;
}
static const EVP_CIPHER aesni_256_ofb = { 428,1,256/8,16, 0|0x1000|0x4, aesni_init_key, aes_ofb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_256_ofb = { 428,1, 256/8,16, 0|0x1000|0x4, aes_init_key, aes_ofb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_256_ofb(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_256_ofb:&aes_256_ofb;
}
static const EVP_CIPHER aesni_256_cfb = { 429,1,256/8,16, 0|0x1000|0x3, aesni_init_key, aes_cfb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_256_cfb = { 429,1, 256/8,16, 0|0x1000|0x3, aes_init_key, aes_cfb_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_256_cfb128(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_256_cfb:&aes_256_cfb;
}
static const EVP_CIPHER aesni_256_cfb1 = { 652,1,256/8,16, 0|0x3, aesni_init_key, aes_cfb1_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_256_cfb1 = { 652,1, 256/8,16, 0|0x3, aes_init_key, aes_cfb1_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_256_cfb1(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_256_cfb1:&aes_256_cfb1;
}
static const EVP_CIPHER aesni_256_cfb8 = { 655,1,256/8,16, 0|0x3, aesni_init_key, aes_cfb8_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_256_cfb8 = { 655,1, 256/8,16, 0|0x3, aes_init_key, aes_cfb8_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_256_cfb8(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_256_cfb8:&aes_256_cfb8;
}
static const EVP_CIPHER aesni_256_ctr = { 906,1,256/8,16, 0|0x5, aesni_init_key, aes_ctr_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
static const EVP_CIPHER aes_256_ctr = { 906,1, 256/8,16, 0|0x5, aes_init_key, aes_ctr_cipher, ((void *)0), sizeof(EVP_AES_KEY), ((void *)0),((void *)0),((void *)0),((void *)0) };
const EVP_CIPHER *EVP_aes_256_ctr(void)
{
...
static const EVP_CIPHER aesni_128_gcm = { 895,1, (0x6==0x10001?2:1)*128/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x6, aesni_gcm_init_key, aes_gcm_cipher, aes_gcm_cleanup, sizeof(EVP_AES_GCM_CTX), ((void *)0),((void *)0),aes_gcm_ctrl,((void *)0) };
static const EVP_CIPHER aes_128_gcm = { 895,1, (0x6==0x10001?2:1)*128/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x6, aes_gcm_init_key, aes_gcm_cipher, aes_gcm_cleanup, sizeof(EVP_AES_GCM_CTX), ((void *)0),((void *)0),aes_gcm_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_128_gcm(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_gcm:&aes_128_gcm;
}
#line 1774 "crypto\\evp\\e_aes.c"
static const EVP_CIPHER aesni_192_gcm = { 898,1, (0x6==0x10001?2:1)*192/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x6, aesni_gcm_init_key, aes_gcm_cipher, aes_gcm_cleanup, sizeof(EVP_AES_GCM_CTX), ((void *)0),((void *)0),aes_gcm_ctrl,((void *)0) };
static const EVP_CIPHER aes_192_gcm = { 898,1, (0x6==0x10001?2:1)*192/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x6, aes_gcm_init_key, aes_gcm_cipher, aes_gcm_cleanup, sizeof(EVP_AES_GCM_CTX), ((void *)0),((void *)0),aes_gcm_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_192_gcm(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_192_gcm:&aes_192_gcm;
}
#line 1776 "crypto\\evp\\e_aes.c"
static const EVP_CIPHER aesni_256_gcm = { 901,1, (0x6==0x10001?2:1)*256/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x6, aesni_gcm_init_key, aes_gcm_cipher, aes_gcm_cleanup, sizeof(EVP_AES_GCM_CTX), ((void *)0),((void *)0),aes_gcm_ctrl,((void *)0) };
static const EVP_CIPHER aes_256_gcm = { 901,1, (0x6==0x10001?2:1)*256/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x6, aes_gcm_init_key, aes_gcm_cipher, aes_gcm_cleanup, sizeof(EVP_AES_GCM_CTX), ((void *)0),((void *)0),aes_gcm_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_256_gcm(void)
{
...
static const EVP_CIPHER aesni_128_xts = { 913,1, (0x10001==0x10001?2:1)*128/8, 16, (0x1000 | 0x10 | 0x20 | 0x40 | 0x400)|0x10001, aesni_xts_init_key, aes_xts_cipher, ((void *)0), sizeof(EVP_AES_XTS_CTX), ((void *)0),((void *)0),aes_xts_ctrl,((void *)0) };
static const EVP_CIPHER aes_128_xts = { 913,1, (0x10001==0x10001?2:1)*128/8, 16, (0x1000 | 0x10 | 0x20 | 0x40 | 0x400)|0x10001, aes_xts_init_key, aes_xts_cipher, ((void *)0), sizeof(EVP_AES_XTS_CTX), ((void *)0),((void *)0),aes_xts_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_128_xts(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_xts:&aes_128_xts;
}
static const EVP_CIPHER aesni_256_xts = { 914,1, (0x10001==0x10001?2:1)*256/8, 16, (0x1000 | 0x10 | 0x20 | 0x40 | 0x400)|0x10001, aesni_xts_init_key, aes_xts_cipher, ((void *)0), sizeof(EVP_AES_XTS_CTX), ((void *)0),((void *)0),aes_xts_ctrl,((void *)0) };
static const EVP_CIPHER aes_256_xts = { 914,1, (0x10001==0x10001?2:1)*256/8, 16, (0x1000 | 0x10 | 0x20 | 0x40 | 0x400)|0x10001, aes_xts_init_key, aes_xts_cipher, ((void *)0), sizeof(EVP_AES_XTS_CTX), ((void *)0),((void *)0),aes_xts_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_256_xts(void)
{
...
static const EVP_CIPHER aesni_128_ccm = { 896,1, (0x7==0x10001?2:1)*128/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x7, aesni_ccm_init_key, aes_ccm_cipher, ((void *)0), sizeof(EVP_AES_CCM_CTX), ((void *)0),((void *)0),aes_ccm_ctrl,((void *)0) };
static const EVP_CIPHER aes_128_ccm = { 896,1, (0x7==0x10001?2:1)*128/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x7, aes_ccm_init_key, aes_ccm_cipher, ((void *)0), sizeof(EVP_AES_CCM_CTX), ((void *)0),((void *)0),aes_ccm_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_128_ccm(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_ccm:&aes_128_ccm;
}
#line 2194 "crypto\\evp\\e_aes.c"
static const EVP_CIPHER aesni_192_ccm = { 899,1, (0x7==0x10001?2:1)*192/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x7, aesni_ccm_init_key, aes_ccm_cipher, ((void *)0), sizeof(EVP_AES_CCM_CTX), ((void *)0),((void *)0),aes_ccm_ctrl,((void *)0) };
static const EVP_CIPHER aes_192_ccm = { 899,1, (0x7==0x10001?2:1)*192/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x7, aes_ccm_init_key, aes_ccm_cipher, ((void *)0), sizeof(EVP_AES_CCM_CTX), ((void *)0),((void *)0),aes_ccm_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_192_ccm(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_192_ccm:&aes_192_ccm;
}
#line 2196 "crypto\\evp\\e_aes.c"
static const EVP_CIPHER aesni_256_ccm = { 902,1, (0x7==0x10001?2:1)*256/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x7, aesni_ccm_init_key, aes_ccm_cipher, ((void *)0), sizeof(EVP_AES_CCM_CTX), ((void *)0),((void *)0),aes_ccm_ctrl,((void *)0) };
static const EVP_CIPHER aes_256_ccm = { 902,1, (0x7==0x10001?2:1)*256/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x7, aes_ccm_init_key, aes_ccm_cipher, ((void *)0), sizeof(EVP_AES_CCM_CTX), ((void *)0),((void *)0),aes_ccm_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_256_ccm(void)
{
...
static const EVP_CIPHER aesni_128_ocb = { 958,16, (0x10003==0x10001?2:1)*128/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x10003, aesni_ocb_init_key, aes_ocb_cipher, aes_ocb_cleanup, sizeof(EVP_AES_OCB_CTX), ((void *)0),((void *)0),aes_ocb_ctrl,((void *)0) };
static const EVP_CIPHER aes_128_ocb = { 958,16, (0x10003==0x10001?2:1)*128/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x10003, aes_ocb_init_key, aes_ocb_cipher, aes_ocb_cleanup, sizeof(EVP_AES_OCB_CTX), ((void *)0),((void *)0),aes_ocb_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_128_ocb(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_128_ocb:&aes_128_ocb;
}
#line 2699 "crypto\\evp\\e_aes.c"
static const EVP_CIPHER aesni_192_ocb = { 959,16, (0x10003==0x10001?2:1)*192/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x10003, aesni_ocb_init_key, aes_ocb_cipher, aes_ocb_cleanup, sizeof(EVP_AES_OCB_CTX), ((void *)0),((void *)0),aes_ocb_ctrl,((void *)0) };
static const EVP_CIPHER aes_192_ocb = { 959,16, (0x10003==0x10001?2:1)*192/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x10003, aes_ocb_init_key, aes_ocb_cipher, aes_ocb_cleanup, sizeof(EVP_AES_OCB_CTX), ((void *)0),((void *)0),aes_ocb_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_192_ocb(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_192_ocb:&aes_192_ocb;
}
#line 2701 "crypto\\evp\\e_aes.c"
static const EVP_CIPHER aesni_256_ocb = { 960,16, (0x10003==0x10001?2:1)*256/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x10003, aesni_ocb_init_key, aes_ocb_cipher, aes_ocb_cleanup, sizeof(EVP_AES_OCB_CTX), ((void *)0),((void *)0),aes_ocb_ctrl,((void *)0) };
static const EVP_CIPHER aes_256_ocb = { 960,16, (0x10003==0x10001?2:1)*256/8, 12, 0x200000 | (0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400)|0x10003, aes_ocb_init_key, aes_ocb_cipher, aes_ocb_cleanup, sizeof(EVP_AES_OCB_CTX), ((void *)0),((void *)0),aes_ocb_ctrl,((void *)0) };
const EVP_CIPHER *EVP_aes_256_ocb(void)
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32)))?&aesni_256_ocb:&aes_256_ocb;
}
