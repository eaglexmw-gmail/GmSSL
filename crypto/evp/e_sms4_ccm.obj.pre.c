#line 1 "crypto\\evp\\e_sms4_ccm.c"
...
#line 59 "crypto\\evp\\e_sms4_ccm.c"
...
#line 61 "crypto\\evp\\e_sms4_ccm.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/crypto.h"
#line 62 "crypto\\evp\\e_sms4_ccm.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/objects.h"
#line 63 "crypto\\evp\\e_sms4_ccm.c"
...
#line 64 "crypto\\evp\\e_sms4_ccm.c"
...
#line 65 "crypto\\evp\\e_sms4_ccm.c"
...
#line 66 "crypto\\evp\\e_sms4_ccm.c"
...
#line 70 "crypto\\evp\\e_sms4_ccm.c"
typedef struct {
union {
double align;
sms4_key_t ks;
...
{
EVP_SMS4_CCM_CTX *cctx = ((EVP_SMS4_CCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(c));
switch (type) {
case 0x0:
cctx->key_set = 0;
cctx->iv_set = 0;
...
EVP_SMS4_CCM_CTX *cctx_out = ((EVP_SMS4_CCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(out));
if (cctx->ccm.key) {
...
const unsigned char *iv, int enc)
{
EVP_SMS4_CCM_CTX *cctx = ((EVP_SMS4_CCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(ctx));
if (!iv && !key)
return 1;
if (key)
do {
...
16,
12,
(0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 | 0x200000),
sms4_ccm_init_key,
sms4_ccm_cipher,
((void *)0),
sizeof(EVP_SMS4_CCM_CTX),
((void *)0), ((void *)0), sms4_ccm_ctrl, ((void *)0)
};
const EVP_CIPHER *EVP_sms4_ccm(void) {
return &sms4_ccm;
}
#line 341 "crypto\\evp\\e_sms4_ccm.c"
