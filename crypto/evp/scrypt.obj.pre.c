...
Blen = p * 128 * r;
i = 0xffffffffffffffffui64 / (32 * sizeof(uint32_t));
if (N + 2 > i / r)
return 0;
Vlen = 32 * r * (N + 2) * sizeof(uint32_t);
if (Blen > 0xffffffffffffffffui64 - Vlen)
return 0;
if (Blen > 0xffffffff - Vlen)
return 0;
allocsize = (size_t)(Blen + Vlen);
if (maxmem == 0)
maxmem = (1024 * 1024 * 32);
if (allocsize > maxmem) {
ERR_put_error(6,(181),(172),"crypto\\evp\\scrypt.c",229);
return 0;
}
if (key == ((void *)0))
return 1;
B = CRYPTO_malloc(allocsize, "crypto\\evp\\scrypt.c", 237);
if (B == ((void *)0))
return 0;
X = (uint32_t *)(B + Blen);
T = X + 32 * r;
...
rv = 1;
err:
CRYPTO_clear_free(B, allocsize, "crypto\\evp\\scrypt.c", 255);
return rv;
}
#line 259 "crypto\\evp\\scrypt.c"
