#line 1 "crypto\\evp\\e_sms4_gcm.c"
...
#line 59 "crypto\\evp\\e_sms4_gcm.c"
...
#line 61 "crypto\\evp\\e_sms4_gcm.c"
...
#line 62 "crypto\\evp\\e_sms4_gcm.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/crypto.h"
#line 63 "crypto\\evp\\e_sms4_gcm.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/objects.h"
#line 64 "crypto\\evp\\e_sms4_gcm.c"
...
#line 65 "crypto\\evp\\e_sms4_gcm.c"
...
#line 66 "crypto\\evp\\e_sms4_gcm.c"
...
#line 67 "crypto\\evp\\e_sms4_gcm.c"
...
#line 71 "crypto\\evp\\e_sms4_gcm.c"
typedef struct {
union {
double align;
sms4_key_t ks;
...
{
EVP_SMS4_GCM_CTX *gctx = ((EVP_SMS4_GCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(c));
OPENSSL_cleanse(&gctx->gcm, sizeof(gctx->gcm));
if (gctx->iv != EVP_CIPHER_CTX_iv_noconst(c))
CRYPTO_free(gctx->iv, "crypto\\evp\\e_sms4_gcm.c", 94);
return 1;
}
...
if (gctx->iv != EVP_CIPHER_CTX_iv_noconst(c))
CRYPTO_free(gctx->iv, "crypto\\evp\\e_sms4_gcm.c", 134);
gctx->iv = CRYPTO_malloc(arg, "crypto\\evp\\e_sms4_gcm.c", 135);
if (gctx->iv == ((void *)0))
return 0;
}
gctx->ivlen = arg;
...
EVP_SMS4_GCM_CTX *gctx_out = ((EVP_SMS4_GCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(out));
if (gctx->gcm.key) {
...
gctx_out->iv = CRYPTO_malloc(gctx->ivlen, "crypto\\evp\\e_sms4_gcm.c", 234);
...
const unsigned char *iv, int enc)
{
EVP_SMS4_GCM_CTX *gctx = ((EVP_SMS4_GCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(ctx));
if (!iv && !key)
return 1;
if (key) {
do {
...
16,
12,
(0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 | 0x6 | 0x200000),
sms4_gcm_init_key,
sms4_gcm_cipher,
sms4_gcm_cleanup,
sizeof(EVP_SMS4_GCM_CTX),
((void *)0), ((void *)0), sms4_gcm_ctrl, ((void *)0)
};
const EVP_CIPHER *EVP_sms4_gcm(void) {
return &sms4_gcm;
}
#line 464 "crypto\\evp\\e_sms4_gcm.c"
