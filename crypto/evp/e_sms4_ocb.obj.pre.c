#line 1 "crypto\\evp\\e_sms4_ocb.c"
...
#line 59 "crypto\\evp\\e_sms4_ocb.c"
...
#line 61 "crypto\\evp\\e_sms4_ocb.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/crypto.h"
#line 62 "crypto\\evp\\e_sms4_ocb.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/objects.h"
#line 63 "crypto\\evp\\e_sms4_ocb.c"
...
#line 64 "crypto\\evp\\e_sms4_ocb.c"
...
#line 65 "crypto\\evp\\e_sms4_ocb.c"
...
#line 66 "crypto\\evp\\e_sms4_ocb.c"
...
#line 70 "crypto\\evp\\e_sms4_ocb.c"
typedef struct {
union {
double align;
sms4_key_t ks;
...
{
EVP_SMS4_OCB_CTX *octx = ((EVP_SMS4_OCB_CTX *)EVP_CIPHER_CTX_get_cipher_data(c));
EVP_CIPHER_CTX *newc;
...
new_octx = ((EVP_SMS4_OCB_CTX *)EVP_CIPHER_CTX_get_cipher_data(newc));
...
const unsigned char *iv, int enc)
{
EVP_SMS4_OCB_CTX *octx = ((EVP_SMS4_OCB_CTX *)EVP_CIPHER_CTX_get_cipher_data(ctx));
if (!iv && !key)
return 1;
if (key) {
do {
...
((void *)0), ((void *)0), sms4_ocb_ctrl, ((void *)0)
};
const EVP_CIPHER *EVP_sms4_ocb(void) {
return &sms4_ocb;
}
#line 373 "crypto\\evp\\e_sms4_ocb.c"
#line 374 "crypto\\evp\\e_sms4_ocb.c"
