...
#line 18 "crypto\\evp\\e_seed.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/seed.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 114 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 116 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 118 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
...
#line 155 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 176 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 39 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/seed.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/e_os2.h"
#line 42 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/seed.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/crypto.h"
#line 43 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/seed.h"
...
#line 57 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/seed.h"
#line 58 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/seed.h"
typedef struct seed_key_st {
unsigned int data[32];
#line 68 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/seed.h"
} SEED_KEY_SCHEDULE;
...
size_t len, const SEED_KEY_SCHEDULE *ks,
unsigned char ivec[16], int *num);
#line 97 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/seed.h"
#line 99 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/seed.h"
#line 19 "crypto\\evp\\e_seed.c"
...
#line 20 "crypto\\evp\\e_seed.c"
static int seed_init_key(EVP_CIPHER_CTX *ctx, const unsigned char *key,
const unsigned char *iv, int enc);
typedef struct {
SEED_KEY_SCHEDULE ks;
} EVP_SEED_KEY;
static int seed_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { SEED_cbc_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_SEED_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), EVP_CIPHER_CTX_encrypting(ctx)); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) SEED_cbc_encrypt(in, out, (long)inl, &((EVP_SEED_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), EVP_CIPHER_CTX_encrypting(ctx)); return 1;} static int seed_cfb128_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1<<(sizeof(long)*8-2)); if (128 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_num(ctx); SEED_cfb128_encrypt(in, out, (long) ((128 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? inl*8 : inl), &((EVP_SEED_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), &num, EVP_CIPHER_CTX_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static int seed_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = EVP_CIPHER_CTX_cipher(ctx)->block_size; if (inl < bl) return 1; inl -= bl; for (i=0; i <= inl; i+=bl) SEED_ecb_encrypt(in + i, out + i, &((EVP_SEED_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_encrypting(ctx)); return 1;} static int seed_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { int num = EVP_CIPHER_CTX_num(ctx); SEED_ofb128_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_SEED_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), &num); EVP_CIPHER_CTX_set_num(ctx, num); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) { int num = EVP_CIPHER_CTX_num(ctx); SEED_ofb128_encrypt(in, out, (long)inl, &((EVP_SEED_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), &num); EVP_CIPHER_CTX_set_num(ctx, num); } return 1;} static const EVP_CIPHER seed_cbc = { 777, 16, 16, 16, 0x1000 | 0x2, seed_init_key, seed_cbc_cipher, 0, sizeof(EVP_SEED_KEY), 0, 0, 0, ((void *)0) }; const EVP_CIPHER *EVP_seed_cbc(void) { return &seed_cbc; } static const EVP_CIPHER seed_cfb128 = { 779, 1, 16, 16, 0x1000 | 0x3, seed_init_key, seed_cfb128_cipher, 0, sizeof(EVP_SEED_KEY), 0, 0, 0, ((void *)0) }; const EVP_CIPHER *EVP_seed_cfb128(void) { return &seed_cfb128; } static const EVP_CIPHER seed_ofb = { 778, 1, 16, 16, 0x1000 | 0x4, seed_init_key, seed_ofb_cipher, 0, sizeof(EVP_SEED_KEY), 0, 0, 0, ((void *)0) }; const EVP_CIPHER *EVP_seed_ofb(void) { return &seed_ofb; } static const EVP_CIPHER seed_ecb = { 776, 16, 16, 0, 0x1000 | 0x1, seed_init_key, seed_ecb_cipher, 0, sizeof(EVP_SEED_KEY), 0, 0, 0, ((void *)0) }; const EVP_CIPHER *EVP_seed_ecb(void) { return &seed_ecb; }
#line 31 "crypto\\evp\\e_seed.c"
static int seed_init_key(EVP_CIPHER_CTX *ctx, const unsigned char *key,
const unsigned char *iv, int enc)
{
SEED_set_key(key, &((EVP_SEED_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks);
return 1;
}
#line 40 "crypto\\evp\\e_seed.c"
