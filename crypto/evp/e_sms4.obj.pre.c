...
#line 60 "crypto\\evp\\e_sms4.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/crypto.h"
#line 61 "crypto\\evp\\e_sms4.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/objects.h"
#line 62 "crypto\\evp\\e_sms4.c"
...
#line 64 "crypto\\evp\\e_sms4.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
...
#line 11 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/modes.h"
...
#line 13 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
typedef __int64 i64;
typedef unsigned __int64 u64;
#line 27 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
typedef unsigned int u32;
typedef unsigned char u8;
#line 40 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
#line 41 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
#line 77 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
#pragma intrinsic(_byteswap_uint64,_byteswap_ulong)
#line 87 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
#line 88 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
#line 89 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
#line 96 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
typedef struct {
u64 hi, lo;
} u128;
...
#line 124 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
u128 Htable[16];
void (*gmult) (u64 Xi[2], const u128 Htable[16]);
void (*ghash) (u64 Xi[2], const u128 Htable[16], const u8 *inp,
size_t len);
#line 129 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
...
#line 162 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
#line 164 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
...
#line 188 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
#line 189 "d:\\07.opensrc\\gmssl\\crypto\\evp\\../modes/modes_lcl.h"
#line 65 "crypto\\evp\\e_sms4.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/sms4.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 114 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 116 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 118 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
...
#line 155 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 176 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/opensslconf.h"
#line 54 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/sms4.h"
...
#line 62 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/sms4.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/e_os2.h"
#line 63 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/sms4.h"
...
{
int mode;
EVP_SMS4_KEY *dat = ((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx));
...
dat->stream.cbc = mode == 0x2 ? (cbc128_f) sms4_cbc_encrypt : ((void *)0);
return 1;
}
...
static int sms4_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { sms4_cbc_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), EVP_CIPHER_CTX_encrypting(ctx)); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) sms4_cbc_encrypt(in, out, (long)inl, &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), EVP_CIPHER_CTX_encrypting(ctx)); return 1;} static int sms4_cfb128_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1<<(sizeof(long)*8-2)); if (128 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_num(ctx); sms4_cfb128_encrypt(in, out, (long) ((128 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? inl*8 : inl), &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), &num, EVP_CIPHER_CTX_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static int sms4_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = EVP_CIPHER_CTX_cipher(ctx)->block_size; if (inl < bl) return 1; inl -= bl; for (i=0; i <= inl; i+=bl) sms4_ecb_encrypt(in + i, out + i, &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_encrypting(ctx)); return 1;} static int sms4_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { int num = EVP_CIPHER_CTX_num(ctx); sms4_ofb128_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), &num); EVP_CIPHER_CTX_set_num(ctx, num); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) { int num = EVP_CIPHER_CTX_num(ctx); sms4_ofb128_encrypt(in, out, (long)inl, &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), &num); EVP_CIPHER_CTX_set_num(ctx, num); } return 1;} static const EVP_CIPHER sms4_cbc = { 1151, 16, 16, (16), 0x1000 | 0x2, sms4_init_key, sms4_cbc_cipher, ((void *)0), sizeof(EVP_SMS4_KEY), ((void *)0), ((void *)0), sms4_ctrl, ((void *)0) }; const EVP_CIPHER *EVP_sms4_cbc(void) { return &sms4_cbc; } static const EVP_CIPHER sms4_cfb128 = { 1153, 1, 16, (16), 0x1000 | 0x3, sms4_init_key, sms4_cfb128_cipher, ((void *)0), sizeof(EVP_SMS4_KEY), ((void *)0), ((void *)0), sms4_ctrl, ((void *)0) }; const EVP_CIPHER *EVP_sms4_cfb128(void) { return &sms4_cfb128; } static const EVP_CIPHER sms4_ofb = { 1152, 1, 16, (16), 0x1000 | 0x4, sms4_init_key, sms4_ofb_cipher, ((void *)0), sizeof(EVP_SMS4_KEY), ((void *)0), ((void *)0), sms4_ctrl, ((void *)0) }; const EVP_CIPHER *EVP_sms4_ofb(void) { return &sms4_ofb; } static const EVP_CIPHER sms4_ecb = { 1150, 16, 16, 0, 0x1000 | 0x1, sms4_init_key, sms4_ecb_cipher, ((void *)0), sizeof(EVP_SMS4_KEY), ((void *)0), ((void *)0), sms4_ctrl, ((void *)0) }; const EVP_CIPHER *EVP_sms4_ecb(void) { return &sms4_ecb; }
#line 112 "crypto\\evp\\e_sms4.c"
...
CRYPTO_cfb128_1_encrypt(in, out, ((size_t)1<<(sizeof(size_t)*8-4)) * 8, &sms4_key->ks,
ctx->iv, &ctx->num, ctx->encrypt, (block128_f)sms4_encrypt);
...
((void *)0),
sizeof(EVP_SMS4_KEY),
((void *)0),((void *)0),sms4_ctrl,((void *)0),
};
const EVP_CIPHER *EVP_sms4_cfb1(void)
{
return &sms4_cfb1;
