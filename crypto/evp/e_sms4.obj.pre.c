...
static int sms4_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl)
{
    ...
    {
        sms4_cbc_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), EVP_CIPHER_CTX_encrypting(ctx));
        inl-=((size_t)1<<(sizeof(long)*8-2));
        in +=((size_t)1<<(sizeof(long)*8-2));
        out+=((size_t)1<<(sizeof(long)*8-2));
    }
    if (inl) sms4_cbc_encrypt(in, out, (long)inl, &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), EVP_CIPHER_CTX_encrypting(ctx));
    return 1;
}
static int sms4_cfb128_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl)
{
    ...
    while (inl && inl >= chunk)
    {
        ...
        sms4_cfb128_encrypt(in, out, (long) ((128 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? inl*8 : inl), &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), &num, EVP_CIPHER_CTX_encrypting(ctx));
...
static int sms4_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl)
{
    ...
    if (inl < bl) return 1;
    inl -= bl;
    for (i=0; i <= inl; i+=bl) sms4_ecb_encrypt(in + i, out + i, &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_encrypting(ctx));
    return 1;
}
static int sms4_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl)
{
    ...
    {
        int num = EVP_CIPHER_CTX_num(ctx);
        sms4_ofb128_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), &num);
        EVP_CIPHER_CTX_set_num(ctx, num);
        inl-=((size_t)1<<(sizeof(long)*8-2));
        in +=((size_t)1<<(sizeof(long)*8-2));
        out+=((size_t)1<<(sizeof(long)*8-2));
    ...
    {
        int num = EVP_CIPHER_CTX_num(ctx);
        sms4_ofb128_encrypt(in, out, (long)inl, &((EVP_SMS4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_iv_noconst(ctx), &num);
        EVP_CIPHER_CTX_set_num(ctx, num);
    }
    return 1;
}
static const EVP_CIPHER sms4_cbc = { 1151, 16, 16, (16), 0x1000 | 0x2, sms4_init_key, sms4_cbc_cipher, ((void *)0), sizeof(EVP_SMS4_KEY), ((void *)0), ((void *)0), sms4_ctrl, ((void *)0) };
const EVP_CIPHER *EVP_sms4_cbc(void)
{
    return &sms4_cbc;
}
static const EVP_CIPHER sms4_cfb128 = { 1153, 1, 16, (16), 0x1000 | 0x3, sms4_init_key, sms4_cfb128_cipher, ((void *)0), sizeof(EVP_SMS4_KEY), ((void *)0), ((void *)0), sms4_ctrl, ((void *)0) };
const EVP_CIPHER *EVP_sms4_cfb128(void)
{
    return &sms4_cfb128;
}
static const EVP_CIPHER sms4_ofb = { 1152, 1, 16, (16), 0x1000 | 0x4, sms4_init_key, sms4_ofb_cipher, ((void *)0), sizeof(EVP_SMS4_KEY), ((void *)0), ((void *)0), sms4_ctrl, ((void *)0) };
const EVP_CIPHER *EVP_sms4_ofb(void)
{
    return &sms4_ofb;
}
static const EVP_CIPHER sms4_ecb = { 1150, 16, 16, 0, 0x1000 | 0x1, sms4_init_key, sms4_ecb_cipher, ((void *)0), sizeof(EVP_SMS4_KEY), ((void *)0), ((void *)0), sms4_ctrl, ((void *)0) };
const EVP_CIPHER *EVP_sms4_ecb(void)
{
    return &sms4_ecb;
}
