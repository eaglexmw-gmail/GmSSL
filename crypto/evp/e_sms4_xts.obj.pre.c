#line 1 "crypto\\evp\\e_sms4_xts.c"
...
#line 59 "crypto\\evp\\e_sms4_xts.c"
...
#line 61 "crypto\\evp\\e_sms4_xts.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/crypto.h"
#line 62 "crypto\\evp\\e_sms4_xts.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/objects.h"
#line 63 "crypto\\evp\\e_sms4_xts.c"
...
#line 64 "crypto\\evp\\e_sms4_xts.c"
...
#line 65 "crypto\\evp\\e_sms4_xts.c"
...
#line 66 "crypto\\evp\\e_sms4_xts.c"
...
#line 69 "crypto\\evp\\e_sms4_xts.c"
typedef struct {
union {
double align;
sms4_key_t ks;
...
{
EVP_SMS4_XTS_CTX *xctx = ((EVP_SMS4_XTS_CTX *)EVP_CIPHER_CTX_get_cipher_data(c));
if (type == 0x8) {
EVP_CIPHER_CTX *out = ptr;
EVP_SMS4_XTS_CTX *xctx_out = ((EVP_SMS4_XTS_CTX *)EVP_CIPHER_CTX_get_cipher_data(out));
if (xctx->xts.key1) {
...
const unsigned char *iv, int enc)
{
EVP_SMS4_XTS_CTX *xctx = ((EVP_SMS4_XTS_CTX *)EVP_CIPHER_CTX_get_cipher_data(ctx));
if (!iv && !key)
return 1;
if (key)
do {
...
16,
(16),
(0x1000 | 0x10 | 0x20 | 0x40 | 0x400),
sms4_xts_init_key,
sms4_xts_cipher,
((void *)0),
sizeof(EVP_SMS4_XTS_CTX),
((void *)0), ((void *)0), sms4_xts_ctrl, ((void *)0)
};
const EVP_CIPHER *EVP_sms4_xts(void) {
return &sms4_xts;
}
#line 184 "crypto\\evp\\e_sms4_xts.c"
