...
#line 45 "crypto\\seed\\seed.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\seed\\seed_locl.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/e_os2.h"
#line 39 "d:\\07.opensrc\\gmssl\\crypto\\seed\\seed_locl.h"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/seed.h"
#line 40 "d:\\07.opensrc\\gmssl\\crypto\\seed\\seed_locl.h"
typedef unsigned int seed_word;
#line 46 "d:\\07.opensrc\\gmssl\\crypto\\seed\\seed_locl.h"
#line 121 "d:\\07.opensrc\\gmssl\\crypto\\seed\\seed_locl.h"
#line 46 "crypto\\seed\\seed.c"
...
#line 414 "crypto\\seed\\seed.c"
#line 439 "crypto\\seed\\seed.c"
void SEED_set_key(const unsigned char rawkey[16],
                  SEED_KEY_SCHEDULE *ks)
{
    seed_word x1, x2, x3, x4;
    seed_word t0, t1;
    (x1) = ((((seed_word)(rawkey)[0]) << 24) | (((seed_word)(rawkey)[1]) << 16) | (((seed_word)(rawkey)[2]) << 8) | ((seed_word)(rawkey)[3]));
    (x2) = ((((seed_word)(rawkey + 4)[0]) << 24) | (((seed_word)(rawkey + 4)[1]) << 16) | (((seed_word)(rawkey + 4)[2]) << 8) | ((seed_word)(rawkey + 4)[3]));
    (x3) = ((((seed_word)(rawkey + 8)[0]) << 24) | (((seed_word)(rawkey + 8)[1]) << 16) | (((seed_word)(rawkey + 8)[2]) << 8) | ((seed_word)(rawkey + 8)[3]));
    (x4) = ((((seed_word)(rawkey + 12)[0]) << 24) | (((seed_word)(rawkey + 12)[1]) << 16) | (((seed_word)(rawkey + 12)[2]) << 8) | ((seed_word)(rawkey + 12)[3]));
    t0 = (x1 + x3 - 0x9e3779b9) & 0xffffffff;
    t1 = (x2 - x4 + 0x9e3779b9) & 0xffffffff;
    (&ks->data[0])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[0])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x1);
    (x1) = (((x1)>>8) ^ ((x2)<<24)) & 0xffffffff;
    (x2) = (((x2)>>8) ^ ((t0)<<24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0x3c6ef373)) & 0xffffffff;
    (t1) = ((x2) + (0x3c6ef373) - (x4)) & 0xffffffff;
    (&ks->data[2])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[2])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x3);
    (x3) = (((x3)<<8) ^ ((x4)>>24)) & 0xffffffff;
    (x4) = (((x4)<<8) ^ ((t0)>>24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0x78dde6e6)) & 0xffffffff;
    (t1) = ((x2) + (0x78dde6e6) - (x4)) & 0xffffffff;
    (&ks->data[4])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[4])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x1);
    (x1) = (((x1)>>8) ^ ((x2)<<24)) & 0xffffffff;
    (x2) = (((x2)>>8) ^ ((t0)<<24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0xf1bbcdcc)) & 0xffffffff;
    (t1) = ((x2) + (0xf1bbcdcc) - (x4)) & 0xffffffff;
    (&ks->data[6])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[6])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x3);
    (x3) = (((x3)<<8) ^ ((x4)>>24)) & 0xffffffff;
    (x4) = (((x4)<<8) ^ ((t0)>>24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0xe3779b99)) & 0xffffffff;
    (t1) = ((x2) + (0xe3779b99) - (x4)) & 0xffffffff;
    (&ks->data[8])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[8])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x1);
    (x1) = (((x1)>>8) ^ ((x2)<<24)) & 0xffffffff;
    (x2) = (((x2)>>8) ^ ((t0)<<24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0xc6ef3733)) & 0xffffffff;
    (t1) = ((x2) + (0xc6ef3733) - (x4)) & 0xffffffff;
    (&ks->data[10])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[10])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x3);
    (x3) = (((x3)<<8) ^ ((x4)>>24)) & 0xffffffff;
    (x4) = (((x4)<<8) ^ ((t0)>>24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0x8dde6e67)) & 0xffffffff;
    (t1) = ((x2) + (0x8dde6e67) - (x4)) & 0xffffffff;
    (&ks->data[12])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[12])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x1);
    (x1) = (((x1)>>8) ^ ((x2)<<24)) & 0xffffffff;
    (x2) = (((x2)>>8) ^ ((t0)<<24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0x1bbcdccf)) & 0xffffffff;
    (t1) = ((x2) + (0x1bbcdccf) - (x4)) & 0xffffffff;
    (&ks->data[14])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[14])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x3);
    (x3) = (((x3)<<8) ^ ((x4)>>24)) & 0xffffffff;
    (x4) = (((x4)<<8) ^ ((t0)>>24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0x3779b99e)) & 0xffffffff;
    (t1) = ((x2) + (0x3779b99e) - (x4)) & 0xffffffff;
    (&ks->data[16])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[16])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x1);
    (x1) = (((x1)>>8) ^ ((x2)<<24)) & 0xffffffff;
    (x2) = (((x2)>>8) ^ ((t0)<<24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0x6ef3733c)) & 0xffffffff;
    (t1) = ((x2) + (0x6ef3733c) - (x4)) & 0xffffffff;
    (&ks->data[18])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[18])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x3);
    (x3) = (((x3)<<8) ^ ((x4)>>24)) & 0xffffffff;
    (x4) = (((x4)<<8) ^ ((t0)>>24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0xdde6e678)) & 0xffffffff;
    (t1) = ((x2) + (0xdde6e678) - (x4)) & 0xffffffff;
    (&ks->data[20])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[20])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x1);
    (x1) = (((x1)>>8) ^ ((x2)<<24)) & 0xffffffff;
    (x2) = (((x2)>>8) ^ ((t0)<<24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0xbbcdccf1)) & 0xffffffff;
    (t1) = ((x2) + (0xbbcdccf1) - (x4)) & 0xffffffff;
    (&ks->data[22])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[22])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x3);
    (x3) = (((x3)<<8) ^ ((x4)>>24)) & 0xffffffff;
    (x4) = (((x4)<<8) ^ ((t0)>>24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0x779b99e3)) & 0xffffffff;
    (t1) = ((x2) + (0x779b99e3) - (x4)) & 0xffffffff;
    (&ks->data[24])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[24])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x1);
    (x1) = (((x1)>>8) ^ ((x2)<<24)) & 0xffffffff;
    (x2) = (((x2)>>8) ^ ((t0)<<24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0xef3733c6)) & 0xffffffff;
    (t1) = ((x2) + (0xef3733c6) - (x4)) & 0xffffffff;
    (&ks->data[26])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[26])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x3);
    (x3) = (((x3)<<8) ^ ((x4)>>24)) & 0xffffffff;
    (x4) = (((x4)<<8) ^ ((t0)>>24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0xde6e678d)) & 0xffffffff;
    (t1) = ((x2) + (0xde6e678d) - (x4)) & 0xffffffff;
    (&ks->data[28])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[28])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = (x1);
    (x1) = (((x1)>>8) ^ ((x2)<<24)) & 0xffffffff;
    (x2) = (((x2)>>8) ^ ((t0)<<24)) & 0xffffffff;
    (t0) = ((x1) + (x3) - (0xbcdccf1b)) & 0xffffffff;
    (t1) = ((x2) + (0xbcdccf1b) - (x4)) & 0xffffffff;
    (&ks->data[30])[0] = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (&ks->data[30])[1] = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
#line 497 "crypto\\seed\\seed.c"
}
void SEED_encrypt(const unsigned char s[16],
                  unsigned char d[16],
                  const SEED_KEY_SCHEDULE *ks)
{
    seed_word x1, x2, x3, x4;
    seed_word t0, t1;
    (x1) = ((((seed_word)(s)[0]) << 24) | (((seed_word)(s)[1]) << 16) | (((seed_word)(s)[2]) << 8) | ((seed_word)(s)[3]));
    (x2) = ((((seed_word)(s + 4)[0]) << 24) | (((seed_word)(s + 4)[1]) << 16) | (((seed_word)(s + 4)[2]) << 8) | ((seed_word)(s + 4)[3]));
    (x3) = ((((seed_word)(s + 8)[0]) << 24) | (((seed_word)(s + 8)[1]) << 16) | (((seed_word)(s + 8)[2]) << 8) | ((seed_word)(s + 8)[3]));
    (x4) = ((((seed_word)(s + 12)[0]) << 24) | (((seed_word)(s + 12)[1]) << 16) | (((seed_word)(s + 12)[2]) << 8) | ((seed_word)(s + 12)[3]));
    (t0) = (x3) ^ (ks->data)[(0)];
    (t1) = (x4) ^ (ks->data)[(0)+1];
    (t1) ^= (t0);
    (t1) = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = ((t0) + (t1)) & 0xffffffff;
    (t0) = SS[0][(unsigned char) ((t0)) & 0xff] ^ SS[1][(unsigned char) (((t0))>>8) & 0xff] ^ SS[2][(unsigned char)(((t0))>>16) & 0xff] ^ SS[3][(unsigned char)(((t0))>>24) & 0xff];
    (t1) = ((t1) + (t0)) & 0xffffffff;
    (t1) = SS[0][(unsigned char) ((t1)) & 0xff] ^ SS[1][(unsigned char) (((t1))>>8) & 0xff] ^ SS[2][(unsigned char)(((t1))>>16) & 0xff] ^ SS[3][(unsigned char)(((t1))>>24) & 0xff];
    (t0) = ((t0) + (t1)) & 0xffffffff;
    (x1) ^= (t0);
    ...
    (x3) ^= (t0);
    (x4) ^= (t1);
#line 537 "crypto\\seed\\seed.c"
    *((d)+0) = (unsigned char)((x3)>>24) & 0xff;
    *((d)+1) = (unsigned char)((x3)>>16) & 0xff;
    *((d)+2) = (unsigned char)((x3)>> 8) & 0xff;
    *((d)+3) = (unsigned char)((x3)) & 0xff;
    *((d + 4)+0) = (unsigned char)((x4)>>24) & 0xff;
    *((d + 4)+1) = (unsigned char)((x4)>>16) & 0xff;
    *((d + 4)+2) = (unsigned char)((x4)>> 8) & 0xff;
    *((d + 4)+3) = (unsigned char)((x4)) & 0xff;
    *((d + 8)+0) = (unsigned char)((x1)>>24) & 0xff;
    *((d + 8)+1) = (unsigned char)((x1)>>16) & 0xff;
    *((d + 8)+2) = (unsigned char)((x1)>> 8) & 0xff;
    *((d + 8)+3) = (unsigned char)((x1)) & 0xff;
    *((d + 12)+0) = (unsigned char)((x2)>>24) & 0xff;
    *((d + 12)+1) = (unsigned char)((x2)>>16) & 0xff;
    *((d + 12)+2) = (unsigned char)((x2)>> 8) & 0xff;
    *((d + 12)+3) = (unsigned char)((x2)) & 0xff;
}
void SEED_decrypt(const unsigned char s[16],
                  unsigned char d[16],
                  const SEED_KEY_SCHEDULE *ks)
