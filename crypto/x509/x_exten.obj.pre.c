...
struct stack_st_BY_DIR_HASH;
typedef int (*sk_BY_DIR_HASH_compfunc)(const BY_DIR_HASH * const *a, const BY_DIR_HASH *const *b);
typedef void (*sk_BY_DIR_HASH_freefunc)(BY_DIR_HASH *a);
typedef BY_DIR_HASH * (*sk_BY_DIR_HASH_copyfunc)(const BY_DIR_HASH *a);
static __inline int sk_BY_DIR_HASH_num(const struct stack_st_BY_DIR_HASH *sk)
{
    return OPENSSL_sk_num((const OPENSSL_STACK *)sk);
}
static __inline BY_DIR_HASH *sk_BY_DIR_HASH_value(const struct stack_st_BY_DIR_HASH *sk, int idx)
{
    return (BY_DIR_HASH *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx);
}
static __inline struct stack_st_BY_DIR_HASH *sk_BY_DIR_HASH_new(sk_BY_DIR_HASH_compfunc compare)
{
    return (struct stack_st_BY_DIR_HASH *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare);
}
static __inline struct stack_st_BY_DIR_HASH *sk_BY_DIR_HASH_new_null(void)
{
    return (struct stack_st_BY_DIR_HASH *)OPENSSL_sk_new_null();
}
static __inline void sk_BY_DIR_HASH_free(struct stack_st_BY_DIR_HASH *sk)
{
    OPENSSL_sk_free((OPENSSL_STACK *)sk);
}
static __inline void sk_BY_DIR_HASH_zero(struct stack_st_BY_DIR_HASH *sk)
{
    OPENSSL_sk_zero((OPENSSL_STACK *)sk);
}
static __inline BY_DIR_HASH *sk_BY_DIR_HASH_delete(struct stack_st_BY_DIR_HASH *sk, int i)
{
    return (BY_DIR_HASH *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i);
}
static __inline BY_DIR_HASH *sk_BY_DIR_HASH_delete_ptr(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr)
{
    return (BY_DIR_HASH *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_BY_DIR_HASH_push(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr)
{
    return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_BY_DIR_HASH_unshift(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr)
{
    return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline BY_DIR_HASH *sk_BY_DIR_HASH_pop(struct stack_st_BY_DIR_HASH *sk)
{
    return (BY_DIR_HASH *)OPENSSL_sk_pop((OPENSSL_STACK *)sk);
}
static __inline BY_DIR_HASH *sk_BY_DIR_HASH_shift(struct stack_st_BY_DIR_HASH *sk)
{
    return (BY_DIR_HASH *)OPENSSL_sk_shift((OPENSSL_STACK *)sk);
}
static __inline void sk_BY_DIR_HASH_pop_free(struct stack_st_BY_DIR_HASH *sk, sk_BY_DIR_HASH_freefunc freefunc)
{
    OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc);
}
static __inline int sk_BY_DIR_HASH_insert(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr, int idx)
{
    return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx);
}
static __inline BY_DIR_HASH *sk_BY_DIR_HASH_set(struct stack_st_BY_DIR_HASH *sk, int idx, BY_DIR_HASH *ptr)
{
    return (BY_DIR_HASH *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr);
}
static __inline int sk_BY_DIR_HASH_find(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr)
{
    return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_BY_DIR_HASH_find_ex(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr)
{
    return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline void sk_BY_DIR_HASH_sort(struct stack_st_BY_DIR_HASH *sk)
{
    OPENSSL_sk_sort((OPENSSL_STACK *)sk);
}
static __inline int sk_BY_DIR_HASH_is_sorted(const struct stack_st_BY_DIR_HASH *sk)
{
    return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_BY_DIR_HASH * sk_BY_DIR_HASH_dup(const struct stack_st_BY_DIR_HASH *sk)
{
    return (struct stack_st_BY_DIR_HASH *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_BY_DIR_HASH *sk_BY_DIR_HASH_deep_copy(const struct stack_st_BY_DIR_HASH *sk, sk_BY_DIR_HASH_copyfunc copyfunc, sk_BY_DIR_HASH_freefunc freefunc)
{
    return (struct stack_st_BY_DIR_HASH *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc);
}
static __inline sk_BY_DIR_HASH_compfunc sk_BY_DIR_HASH_set_cmp_func(struct stack_st_BY_DIR_HASH *sk, sk_BY_DIR_HASH_compfunc compare)
{
    return (sk_BY_DIR_HASH_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare);
}
struct stack_st_BY_DIR_ENTRY;
typedef int (*sk_BY_DIR_ENTRY_compfunc)(const BY_DIR_ENTRY * const *a, const BY_DIR_ENTRY *const *b);
typedef void (*sk_BY_DIR_ENTRY_freefunc)(BY_DIR_ENTRY *a);
typedef BY_DIR_ENTRY * (*sk_BY_DIR_ENTRY_copyfunc)(const BY_DIR_ENTRY *a);
static __inline int sk_BY_DIR_ENTRY_num(const struct stack_st_BY_DIR_ENTRY *sk)
{
    return OPENSSL_sk_num((const OPENSSL_STACK *)sk);
}
static __inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_value(const struct stack_st_BY_DIR_ENTRY *sk, int idx)
{
    return (BY_DIR_ENTRY *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx);
}
static __inline struct stack_st_BY_DIR_ENTRY *sk_BY_DIR_ENTRY_new(sk_BY_DIR_ENTRY_compfunc compare)
{
    return (struct stack_st_BY_DIR_ENTRY *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare);
}
static __inline struct stack_st_BY_DIR_ENTRY *sk_BY_DIR_ENTRY_new_null(void)
{
    return (struct stack_st_BY_DIR_ENTRY *)OPENSSL_sk_new_null();
}
static __inline void sk_BY_DIR_ENTRY_free(struct stack_st_BY_DIR_ENTRY *sk)
{
    OPENSSL_sk_free((OPENSSL_STACK *)sk);
}
static __inline void sk_BY_DIR_ENTRY_zero(struct stack_st_BY_DIR_ENTRY *sk)
{
    OPENSSL_sk_zero((OPENSSL_STACK *)sk);
}
static __inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_delete(struct stack_st_BY_DIR_ENTRY *sk, int i)
{
    return (BY_DIR_ENTRY *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i);
}
static __inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_delete_ptr(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr)
{
    return (BY_DIR_ENTRY *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_BY_DIR_ENTRY_push(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr)
{
    return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_BY_DIR_ENTRY_unshift(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr)
{
    return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_pop(struct stack_st_BY_DIR_ENTRY *sk)
{
    return (BY_DIR_ENTRY *)OPENSSL_sk_pop((OPENSSL_STACK *)sk);
}
static __inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_shift(struct stack_st_BY_DIR_ENTRY *sk)
{
    return (BY_DIR_ENTRY *)OPENSSL_sk_shift((OPENSSL_STACK *)sk);
}
static __inline void sk_BY_DIR_ENTRY_pop_free(struct stack_st_BY_DIR_ENTRY *sk, sk_BY_DIR_ENTRY_freefunc freefunc)
{
    OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc);
}
static __inline int sk_BY_DIR_ENTRY_insert(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr, int idx)
{
    return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx);
}
static __inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_set(struct stack_st_BY_DIR_ENTRY *sk, int idx, BY_DIR_ENTRY *ptr)
{
    return (BY_DIR_ENTRY *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr);
}
static __inline int sk_BY_DIR_ENTRY_find(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr)
{
    return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_BY_DIR_ENTRY_find_ex(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr)
{
    return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline void sk_BY_DIR_ENTRY_sort(struct stack_st_BY_DIR_ENTRY *sk)
{
    OPENSSL_sk_sort((OPENSSL_STACK *)sk);
}
static __inline int sk_BY_DIR_ENTRY_is_sorted(const struct stack_st_BY_DIR_ENTRY *sk)
{
    return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_BY_DIR_ENTRY * sk_BY_DIR_ENTRY_dup(const struct stack_st_BY_DIR_ENTRY *sk)
{
    return (struct stack_st_BY_DIR_ENTRY *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_BY_DIR_ENTRY *sk_BY_DIR_ENTRY_deep_copy(const struct stack_st_BY_DIR_ENTRY *sk, sk_BY_DIR_ENTRY_copyfunc copyfunc, sk_BY_DIR_ENTRY_freefunc freefunc)
{
    return (struct stack_st_BY_DIR_ENTRY *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc);
}
static __inline sk_BY_DIR_ENTRY_compfunc sk_BY_DIR_ENTRY_set_cmp_func(struct stack_st_BY_DIR_ENTRY *sk, sk_BY_DIR_ENTRY_compfunc compare)
{
    return (sk_BY_DIR_ENTRY_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare);
}
typedef struct stack_st_X509_NAME_ENTRY STACK_OF_X509_NAME_ENTRY;
struct stack_st_STACK_OF_X509_NAME_ENTRY;
typedef int (*sk_STACK_OF_X509_NAME_ENTRY_compfunc)(const STACK_OF_X509_NAME_ENTRY * const *a, const STACK_OF_X509_NAME_ENTRY *const *b);
typedef void (*sk_STACK_OF_X509_NAME_ENTRY_freefunc)(STACK_OF_X509_NAME_ENTRY *a);
typedef STACK_OF_X509_NAME_ENTRY * (*sk_STACK_OF_X509_NAME_ENTRY_copyfunc)(const STACK_OF_X509_NAME_ENTRY *a);
static __inline int sk_STACK_OF_X509_NAME_ENTRY_num(const struct stack_st_STACK_OF_X509_NAME_ENTRY *sk)
{
    return OPENSSL_sk_num((const OPENSSL_STACK *)sk);
}
static __inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_value(const struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, int idx)
{
    return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx);
}
static __inline struct stack_st_STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_new(sk_STACK_OF_X509_NAME_ENTRY_compfunc compare)
{
    return (struct stack_st_STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare);
}
static __inline struct stack_st_STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_new_null(void)
{
    return (struct stack_st_STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_new_null();
}
static __inline void sk_STACK_OF_X509_NAME_ENTRY_free(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk)
{
    OPENSSL_sk_free((OPENSSL_STACK *)sk);
}
static __inline void sk_STACK_OF_X509_NAME_ENTRY_zero(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk)
{
    OPENSSL_sk_zero((OPENSSL_STACK *)sk);
}
static __inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_delete(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, int i)
{
    return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i);
}
static __inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_delete_ptr(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr)
{
    return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_STACK_OF_X509_NAME_ENTRY_push(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr)
{
    return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_STACK_OF_X509_NAME_ENTRY_unshift(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr)
{
    return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_pop(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk)
{
    return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_pop((OPENSSL_STACK *)sk);
}
static __inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_shift(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk)
{
    return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_shift((OPENSSL_STACK *)sk);
}
static __inline void sk_STACK_OF_X509_NAME_ENTRY_pop_free(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, sk_STACK_OF_X509_NAME_ENTRY_freefunc freefunc)
{
    OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc);
}
static __inline int sk_STACK_OF_X509_NAME_ENTRY_insert(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr, int idx)
{
    return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx);
}
static __inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_set(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, int idx, STACK_OF_X509_NAME_ENTRY *ptr)
{
    return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr);
}
static __inline int sk_STACK_OF_X509_NAME_ENTRY_find(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr)
{
    return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_STACK_OF_X509_NAME_ENTRY_find_ex(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr)
{
    return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline void sk_STACK_OF_X509_NAME_ENTRY_sort(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk)
{
    OPENSSL_sk_sort((OPENSSL_STACK *)sk);
}
static __inline int sk_STACK_OF_X509_NAME_ENTRY_is_sorted(const struct stack_st_STACK_OF_X509_NAME_ENTRY *sk)
{
    return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_STACK_OF_X509_NAME_ENTRY * sk_STACK_OF_X509_NAME_ENTRY_dup(const struct stack_st_STACK_OF_X509_NAME_ENTRY *sk)
{
    return (struct stack_st_STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_deep_copy(const struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, sk_STACK_OF_X509_NAME_ENTRY_copyfunc copyfunc, sk_STACK_OF_X509_NAME_ENTRY_freefunc freefunc)
{
    return (struct stack_st_STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc);
}
static __inline sk_STACK_OF_X509_NAME_ENTRY_compfunc sk_STACK_OF_X509_NAME_ENTRY_set_cmp_func(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, sk_STACK_OF_X509_NAME_ENTRY_compfunc compare)
{
    return (sk_STACK_OF_X509_NAME_ENTRY_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare);
}
...
const ASN1_ITEM * X509_EXTENSION_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, X509_EXTENSION_seq_tt, sizeof(X509_EXTENSION_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(X509_EXTENSION), "X509_EXTENSION" };
    return &local_it;
}
...
const ASN1_ITEM * X509_EXTENSIONS_it(void)
{
    static const ASN1_ITEM local_it = { 0x0, -1, &X509_EXTENSIONS_item_tt, 0, ((void *)0), 0, "X509_EXTENSIONS" };
    return &local_it;
}
X509_EXTENSION *d2i_X509_EXTENSION(X509_EXTENSION **a, const unsigned char **in, long len)
{
