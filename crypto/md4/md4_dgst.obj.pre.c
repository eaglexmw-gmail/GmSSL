...
#line 339 "D:\\07.OpenSrc\\GmSSL\\crypto\\include\\internal/md32_common.h"
    ...
    do
    {
        unsigned long ll;
        ll=(c)->A;
        (void)(*(((md))++)=(unsigned char)(((ll) )&0xff), *(((md))++)=(unsigned char)(((ll)>> 8)&0xff), *(((md))++)=(unsigned char)(((ll)>>16)&0xff), *(((md))++)=(unsigned char)(((ll)>>24)&0xff), ll);
        ll=(c)->B;
        (void)(*(((md))++)=(unsigned char)(((ll) )&0xff), *(((md))++)=(unsigned char)(((ll)>> 8)&0xff), *(((md))++)=(unsigned char)(((ll)>>16)&0xff), *(((md))++)=(unsigned char)(((ll)>>24)&0xff), ll);
        ll=(c)->C;
        (void)(*(((md))++)=(unsigned char)(((ll) )&0xff), *(((md))++)=(unsigned char)(((ll)>> 8)&0xff), *(((md))++)=(unsigned char)(((ll)>>16)&0xff), *(((md))++)=(unsigned char)(((ll)>>24)&0xff), ll);
...
#line 50 "crypto\\md4\\md4_dgst.c"
    ...
    for (; num--;)
    {
        ...
        {
            A+=((XX0)+(0x5A827999L)+((((B)) & ((C))) | (((B)) & ((D))) | (((C)) & ((D)))));
            A=_lrotl(A,3);
        };;
        {
            D+=((XX4)+(0x5A827999L)+((((A)) & ((B))) | (((A)) & ((C))) | (((B)) & ((C)))));
            D=_lrotl(D,5);
        };;
        {
            C+=((XX8)+(0x5A827999L)+((((D)) & ((A))) | (((D)) & ((B))) | (((A)) & ((B)))));
            C=_lrotl(C,9);
        };;
        {
            B+=((XX12)+(0x5A827999L)+((((C)) & ((D))) | (((C)) & ((A))) | (((D)) & ((A)))));
            B=_lrotl(B,13);
        };;
        {
            A+=((XX1)+(0x5A827999L)+((((B)) & ((C))) | (((B)) & ((D))) | (((C)) & ((D)))));
            A=_lrotl(A,3);
        };;
        {
            D+=((XX5)+(0x5A827999L)+((((A)) & ((B))) | (((A)) & ((C))) | (((B)) & ((C)))));
            D=_lrotl(D,5);
        };;
        {
            C+=((XX9)+(0x5A827999L)+((((D)) & ((A))) | (((D)) & ((B))) | (((A)) & ((B)))));
            C=_lrotl(C,9);
        };;
        {
            B+=((XX13)+(0x5A827999L)+((((C)) & ((D))) | (((C)) & ((A))) | (((D)) & ((A)))));
            B=_lrotl(B,13);
        };;
        {
            A+=((XX2)+(0x5A827999L)+((((B)) & ((C))) | (((B)) & ((D))) | (((C)) & ((D)))));
            A=_lrotl(A,3);
        };;
        {
            D+=((XX6)+(0x5A827999L)+((((A)) & ((B))) | (((A)) & ((C))) | (((B)) & ((C)))));
            D=_lrotl(D,5);
        };;
        {
            C+=((XX10)+(0x5A827999L)+((((D)) & ((A))) | (((D)) & ((B))) | (((A)) & ((B)))));
            C=_lrotl(C,9);
        };;
        {
            B+=((XX14)+(0x5A827999L)+((((C)) & ((D))) | (((C)) & ((A))) | (((D)) & ((A)))));
            B=_lrotl(B,13);
        };;
        {
            A+=((XX3)+(0x5A827999L)+((((B)) & ((C))) | (((B)) & ((D))) | (((C)) & ((D)))));
            A=_lrotl(A,3);
        };;
        {
            D+=((XX7)+(0x5A827999L)+((((A)) & ((B))) | (((A)) & ((C))) | (((B)) & ((C)))));
            D=_lrotl(D,5);
        };;
        {
            C+=((XX11)+(0x5A827999L)+((((D)) & ((A))) | (((D)) & ((B))) | (((A)) & ((B)))));
            C=_lrotl(C,9);
        };;
        {
            B+=((XX15)+(0x5A827999L)+((((C)) & ((D))) | (((C)) & ((A))) | (((D)) & ((A)))));
            B=_lrotl(B,13);
        };;
        {
            A+=((XX0)+(0x6ED9EBA1L)+(((B)) ^ ((C)) ^ ((D))));
            A=_lrotl(A,3);
        };;
        {
            D+=((XX8)+(0x6ED9EBA1L)+(((A)) ^ ((B)) ^ ((C))));
            D=_lrotl(D,9);
        };;
        {
            C+=((XX4)+(0x6ED9EBA1L)+(((D)) ^ ((A)) ^ ((B))));
            C=_lrotl(C,11);
        };;
        {
            B+=((XX12)+(0x6ED9EBA1L)+(((C)) ^ ((D)) ^ ((A))));
            B=_lrotl(B,15);
        };;
        {
            A+=((XX2)+(0x6ED9EBA1L)+(((B)) ^ ((C)) ^ ((D))));
            A=_lrotl(A,3);
        };;
        {
            D+=((XX10)+(0x6ED9EBA1L)+(((A)) ^ ((B)) ^ ((C))));
            D=_lrotl(D,9);
        };;
        {
            C+=((XX6)+(0x6ED9EBA1L)+(((D)) ^ ((A)) ^ ((B))));
            C=_lrotl(C,11);
        };;
        {
            B+=((XX14)+(0x6ED9EBA1L)+(((C)) ^ ((D)) ^ ((A))));
            B=_lrotl(B,15);
        };;
        {
            A+=((XX1)+(0x6ED9EBA1L)+(((B)) ^ ((C)) ^ ((D))));
            A=_lrotl(A,3);
        };;
        {
            D+=((XX9)+(0x6ED9EBA1L)+(((A)) ^ ((B)) ^ ((C))));
            D=_lrotl(D,9);
        };;
        {
            C+=((XX5)+(0x6ED9EBA1L)+(((D)) ^ ((A)) ^ ((B))));
            C=_lrotl(C,11);
        };;
        {
            B+=((XX13)+(0x6ED9EBA1L)+(((C)) ^ ((D)) ^ ((A))));
            B=_lrotl(B,15);
        };;
        {
            A+=((XX3)+(0x6ED9EBA1L)+(((B)) ^ ((C)) ^ ((D))));
            A=_lrotl(A,3);
        };;
        {
            D+=((XX11)+(0x6ED9EBA1L)+(((A)) ^ ((B)) ^ ((C))));
            D=_lrotl(D,9);
        };;
        {
            C+=((XX7)+(0x6ED9EBA1L)+(((D)) ^ ((A)) ^ ((B))));
            C=_lrotl(C,11);
        };;
        {
            B+=((XX15)+(0x6ED9EBA1L)+(((C)) ^ ((D)) ^ ((A))));
            B=_lrotl(B,15);
        };;
        A = c->A += A;
        B = c->B += B;
