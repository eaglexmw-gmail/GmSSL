...
#line 13 "crypto\\cpt_err.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/crypto.h"
#line 14 "crypto\\cpt_err.c"
static ERR_STRING_DATA CRYPTO_str_functs[] = {
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(110) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "CRYPTO_dup_ex_data"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(111) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "CRYPTO_free_ex_data"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(100) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "CRYPTO_get_ex_new_index"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(115) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "CRYPTO_memdup"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(112) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "CRYPTO_new_ex_data"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(102) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "CRYPTO_set_ex_data"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(109) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "FIPS_mode_set"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(113) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "get_and_lock"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(117) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "OPENSSL_buf2hexstr"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(118) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "OPENSSL_hexstr2buf"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(116) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "OPENSSL_init_crypto"},
{0, ((void *)0)}
};
static ERR_STRING_DATA CRYPTO_str_reasons[] = {
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(0) & 0xFFF) << 12L) | (((unsigned int)(101) & 0xFFF) ) ), "fips mode not supported"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(0) & 0xFFF) << 12L) | (((unsigned int)(102) & 0xFFF) ) ), "illegal hex digit"},
{( (((unsigned int)(15) & 0x0FF) << 24L) | (((unsigned int)(0) & 0xFFF) << 12L) | (((unsigned int)(103) & 0xFFF) ) ), "odd number of digits"},
{0, ((void *)0)}
};
#line 44 "crypto\\cpt_err.c"
int ERR_load_CRYPTO_strings(void)
{
