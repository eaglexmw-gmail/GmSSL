#line 1 "crypto\\async\\async_err.c"
...
#line 12 "crypto\\async\\async_err.c"
...
#line 13 "crypto\\async\\async_err.c"
...
#line 14 "crypto\\async\\async_err.c"
static ERR_STRING_DATA ASYNC_str_functs[] = {
{( (((unsigned int)(51) & 0x0FF) << 24L) | (((unsigned int)(100) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "async_ctx_new"},
{( (((unsigned int)(51) & 0x0FF) << 24L) | (((unsigned int)(101) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "ASYNC_init_thread"},
{( (((unsigned int)(51) & 0x0FF) << 24L) | (((unsigned int)(102) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "async_job_new"},
{( (((unsigned int)(51) & 0x0FF) << 24L) | (((unsigned int)(103) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "ASYNC_pause_job"},
{( (((unsigned int)(51) & 0x0FF) << 24L) | (((unsigned int)(104) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "async_start_func"},
{( (((unsigned int)(51) & 0x0FF) << 24L) | (((unsigned int)(105) & 0xFFF) << 12L) | (((unsigned int)(0) & 0xFFF) ) ), "ASYNC_start_job"},
{0, ((void *)0)}
};
static ERR_STRING_DATA ASYNC_str_reasons[] = {
{( (((unsigned int)(51) & 0x0FF) << 24L) | (((unsigned int)(0) & 0xFFF) << 12L) | (((unsigned int)(101) & 0xFFF) ) ), "failed to set pool"},
{( (((unsigned int)(51) & 0x0FF) << 24L) | (((unsigned int)(0) & 0xFFF) << 12L) | (((unsigned int)(102) & 0xFFF) ) ), "failed to swap context"},
{( (((unsigned int)(51) & 0x0FF) << 24L) | (((unsigned int)(0) & 0xFFF) << 12L) | (((unsigned int)(105) & 0xFFF) ) ), "init failed"},
{( (((unsigned int)(51) & 0x0FF) << 24L) | (((unsigned int)(0) & 0xFFF) << 12L) | (((unsigned int)(103) & 0xFFF) ) ), "invalid pool size"},
{0, ((void *)0)}
};
#line 40 "crypto\\async\\async_err.c"
int ERR_load_ASYNC_strings(void)
{
if (ERR_func_error_string(ASYNC_str_functs[0].error) == ((void *)0)) {
ERR_load_strings(0, ASYNC_str_functs);
ERR_load_strings(0, ASYNC_str_reasons);
}
#line 50 "crypto\\async\\async_err.c"
return 1;
}
