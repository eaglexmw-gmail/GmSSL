...
typedef int (*sk_NAME_FUNCS_compfunc)(const NAME_FUNCS * const *a, const NAME_FUNCS *const *b);
typedef void (*sk_NAME_FUNCS_freefunc)(NAME_FUNCS *a);
typedef NAME_FUNCS * (*sk_NAME_FUNCS_copyfunc)(const NAME_FUNCS *a);
static __inline int sk_NAME_FUNCS_num(const struct stack_st_NAME_FUNCS *sk)
{
    return OPENSSL_sk_num((const OPENSSL_STACK *)sk);
}
static __inline NAME_FUNCS *sk_NAME_FUNCS_value(const struct stack_st_NAME_FUNCS *sk, int idx)
{
    return (NAME_FUNCS *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx);
}
static __inline struct stack_st_NAME_FUNCS *sk_NAME_FUNCS_new(sk_NAME_FUNCS_compfunc compare)
{
    return (struct stack_st_NAME_FUNCS *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare);
}
static __inline struct stack_st_NAME_FUNCS *sk_NAME_FUNCS_new_null(void)
{
    return (struct stack_st_NAME_FUNCS *)OPENSSL_sk_new_null();
}
static __inline void sk_NAME_FUNCS_free(struct stack_st_NAME_FUNCS *sk)
{
    OPENSSL_sk_free((OPENSSL_STACK *)sk);
}
static __inline void sk_NAME_FUNCS_zero(struct stack_st_NAME_FUNCS *sk)
{
    OPENSSL_sk_zero((OPENSSL_STACK *)sk);
}
static __inline NAME_FUNCS *sk_NAME_FUNCS_delete(struct stack_st_NAME_FUNCS *sk, int i)
{
    return (NAME_FUNCS *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i);
}
static __inline NAME_FUNCS *sk_NAME_FUNCS_delete_ptr(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr)
{
    return (NAME_FUNCS *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_NAME_FUNCS_push(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr)
{
    return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_NAME_FUNCS_unshift(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr)
{
    return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline NAME_FUNCS *sk_NAME_FUNCS_pop(struct stack_st_NAME_FUNCS *sk)
{
    return (NAME_FUNCS *)OPENSSL_sk_pop((OPENSSL_STACK *)sk);
}
static __inline NAME_FUNCS *sk_NAME_FUNCS_shift(struct stack_st_NAME_FUNCS *sk)
{
    return (NAME_FUNCS *)OPENSSL_sk_shift((OPENSSL_STACK *)sk);
}
static __inline void sk_NAME_FUNCS_pop_free(struct stack_st_NAME_FUNCS *sk, sk_NAME_FUNCS_freefunc freefunc)
{
    OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc);
}
static __inline int sk_NAME_FUNCS_insert(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr, int idx)
{
    return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx);
}
static __inline NAME_FUNCS *sk_NAME_FUNCS_set(struct stack_st_NAME_FUNCS *sk, int idx, NAME_FUNCS *ptr)
{
    return (NAME_FUNCS *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr);
}
static __inline int sk_NAME_FUNCS_find(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr)
{
    return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline int sk_NAME_FUNCS_find_ex(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr)
{
    return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr);
}
static __inline void sk_NAME_FUNCS_sort(struct stack_st_NAME_FUNCS *sk)
{
    OPENSSL_sk_sort((OPENSSL_STACK *)sk);
}
static __inline int sk_NAME_FUNCS_is_sorted(const struct stack_st_NAME_FUNCS *sk)
{
    return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_NAME_FUNCS * sk_NAME_FUNCS_dup(const struct stack_st_NAME_FUNCS *sk)
{
    return (struct stack_st_NAME_FUNCS *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk);
}
static __inline struct stack_st_NAME_FUNCS *sk_NAME_FUNCS_deep_copy(const struct stack_st_NAME_FUNCS *sk, sk_NAME_FUNCS_copyfunc copyfunc, sk_NAME_FUNCS_freefunc freefunc)
{
    return (struct stack_st_NAME_FUNCS *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc);
}
static __inline sk_NAME_FUNCS_compfunc sk_NAME_FUNCS_set_cmp_func(struct stack_st_NAME_FUNCS *sk, sk_NAME_FUNCS_compfunc compare)
{
    return (sk_NAME_FUNCS_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare);
}
struct lhash_st_OBJ_NAME
{
    union lh_OBJ_NAME_dummy
    {
        void* d1;
        unsigned long d2;
        int d3;
...
static __inline struct lhash_st_OBJ_NAME * lh_OBJ_NAME_new(unsigned long (*hfn)(const OBJ_NAME *), int (*cfn)(const OBJ_NAME *, const OBJ_NAME *))
{
    return (struct lhash_st_OBJ_NAME *) OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn);
}
static __inline void lh_OBJ_NAME_free(struct lhash_st_OBJ_NAME *lh)
{
    OPENSSL_LH_free((OPENSSL_LHASH *)lh);
}
static __inline OBJ_NAME *lh_OBJ_NAME_insert(struct lhash_st_OBJ_NAME *lh, OBJ_NAME *d)
{
    return (OBJ_NAME *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d);
}
static __inline OBJ_NAME *lh_OBJ_NAME_delete(struct lhash_st_OBJ_NAME *lh, const OBJ_NAME *d)
{
    return (OBJ_NAME *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d);
}
static __inline OBJ_NAME *lh_OBJ_NAME_retrieve(struct lhash_st_OBJ_NAME *lh, const OBJ_NAME *d)
{
    return (OBJ_NAME *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d);
}
static __inline int lh_OBJ_NAME_error(struct lhash_st_OBJ_NAME *lh)
{
    return OPENSSL_LH_error((OPENSSL_LHASH *)lh);
}
static __inline unsigned long lh_OBJ_NAME_num_items(struct lhash_st_OBJ_NAME *lh)
{
    return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh);
}
static __inline void lh_OBJ_NAME_node_stats_bio(const struct lhash_st_OBJ_NAME *lh, BIO *out)
{
    OPENSSL_LH_node_stats_bio((const OPENSSL_LHASH *)lh, out);
}
static __inline void lh_OBJ_NAME_node_usage_stats_bio(const struct lhash_st_OBJ_NAME *lh, BIO *out)
{
    OPENSSL_LH_node_usage_stats_bio((const OPENSSL_LHASH *)lh, out);
}
static __inline void lh_OBJ_NAME_stats_bio(const struct lhash_st_OBJ_NAME *lh, BIO *out)
{
    OPENSSL_LH_stats_bio((const OPENSSL_LHASH *)lh, out);
}
static __inline unsigned long lh_OBJ_NAME_get_down_load(struct lhash_st_OBJ_NAME *lh)
{
    return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh);
}
static __inline void lh_OBJ_NAME_set_down_load(struct lhash_st_OBJ_NAME *lh, unsigned long dl)
{
    OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl);
}
static __inline void lh_OBJ_NAME_doall(struct lhash_st_OBJ_NAME *lh, void (*doall)(OBJ_NAME *))
{
    OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall);
}
struct lhash_st_OBJ_NAME;
...
static __inline struct lhash_st_ADDED_OBJ * lh_ADDED_OBJ_new(unsigned long (*hfn)(const ADDED_OBJ *), int (*cfn)(const ADDED_OBJ *, const ADDED_OBJ *))
{
    return (struct lhash_st_ADDED_OBJ *) OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn);
}
static __inline void lh_ADDED_OBJ_free(struct lhash_st_ADDED_OBJ *lh)
{
    OPENSSL_LH_free((OPENSSL_LHASH *)lh);
}
static __inline ADDED_OBJ *lh_ADDED_OBJ_insert(struct lhash_st_ADDED_OBJ *lh, ADDED_OBJ *d)
{
    return (ADDED_OBJ *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d);
}
static __inline ADDED_OBJ *lh_ADDED_OBJ_delete(struct lhash_st_ADDED_OBJ *lh, const ADDED_OBJ *d)
{
    return (ADDED_OBJ *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d);
}
static __inline ADDED_OBJ *lh_ADDED_OBJ_retrieve(struct lhash_st_ADDED_OBJ *lh, const ADDED_OBJ *d)
{
    return (ADDED_OBJ *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d);
}
static __inline int lh_ADDED_OBJ_error(struct lhash_st_ADDED_OBJ *lh)
{
    return OPENSSL_LH_error((OPENSSL_LHASH *)lh);
}
static __inline unsigned long lh_ADDED_OBJ_num_items(struct lhash_st_ADDED_OBJ *lh)
{
    return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh);
}
static __inline void lh_ADDED_OBJ_node_stats_bio(const struct lhash_st_ADDED_OBJ *lh, BIO *out)
{
    OPENSSL_LH_node_stats_bio((const OPENSSL_LHASH *)lh, out);
}
static __inline void lh_ADDED_OBJ_node_usage_stats_bio(const struct lhash_st_ADDED_OBJ *lh, BIO *out)
{
    OPENSSL_LH_node_usage_stats_bio((const OPENSSL_LHASH *)lh, out);
}
static __inline void lh_ADDED_OBJ_stats_bio(const struct lhash_st_ADDED_OBJ *lh, BIO *out)
{
    OPENSSL_LH_stats_bio((const OPENSSL_LHASH *)lh, out);
}
static __inline unsigned long lh_ADDED_OBJ_get_down_load(struct lhash_st_ADDED_OBJ *lh)
{
    return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh);
}
static __inline void lh_ADDED_OBJ_set_down_load(struct lhash_st_ADDED_OBJ *lh, unsigned long dl)
{
    OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl);
}
static __inline void lh_ADDED_OBJ_doall(struct lhash_st_ADDED_OBJ *lh, void (*doall)(ADDED_OBJ *))
{
    OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall);
}
struct lhash_st_ADDED_OBJ;
...
static __inline void lh_OBJ_NAME_doall_OBJ_DOALL(struct lhash_st_OBJ_NAME *lh, void (*fn)(const OBJ_NAME *, OBJ_DOALL *), OBJ_DOALL *arg)
{
