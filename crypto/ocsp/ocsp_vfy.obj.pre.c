...
#line 14 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/ossl_typ.h"
...
#line 16 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/buffer.h"
#line 17 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/buffer.h"
...
#line 11 "crypto\\ocsp\\ocsp_vfy.c"
...
#line 12 "crypto\\ocsp\\ocsp_vfy.c"
...
#line 13 "crypto\\ocsp\\ocsp_vfy.c"
...
#line 14 "crypto\\ocsp\\ocsp_vfy.c"
...
static int ocsp_check_ids(struct stack_st_OCSP_SINGLERESP *sresp,
OCSP_CERTID **ret);
static int ocsp_match_issuerid(X509 *cert, OCSP_CERTID *cid,
struct stack_st_OCSP_SINGLERESP *sresp);
static int ocsp_check_delegated(X509 *x);
static int ocsp_req_find_signer(X509 **psigner, OCSP_REQUEST *req,
X509_NAME *nm, struct stack_st_X509 *certs,
unsigned long flags);
int OCSP_basic_verify(OCSP_BASICRESP *bs, struct stack_st_X509 *certs,
X509_STORE *st, unsigned long flags)
{
...
struct stack_st_X509 *untrusted = ((void *)0);
X509_STORE_CTX *ctx = ((void *)0);
int i, ret = ocsp_find_signer(&signer, bs, certs, flags);
if (!ret) {
ERR_put_error(39,(105),(118),"crypto\\ocsp\\ocsp_vfy.c",41);
#line 42 "crypto\\ocsp\\ocsp_vfy.c"
goto end;
}
ctx = X509_STORE_CTX_new();
if (ctx == ((void *)0)) {
ERR_put_error(39,(105),((1|64)),"crypto\\ocsp\\ocsp_vfy.c",46);
goto f_err;
}
...
if (skey == ((void *)0)) {
ERR_put_error(39,(105),(130),"crypto\\ocsp\\ocsp_vfy.c",55);
goto err;
}
ret = ASN1_item_verify((OCSP_RESPDATA_it()), &bs->signatureAlgorithm,bs->signature,&bs->tbsResponseData,skey);
if (ret <= 0) {
ERR_put_error(39,(105),(117),"crypto\\ocsp\\ocsp_vfy.c",60);
goto end;
}
}
if (!(flags & 0x10)) {
...
ERR_put_error(39,(105),((1|64)),"crypto\\ocsp\\ocsp_vfy.c",72);
goto f_err;
}
}
} else {
...
if (!init_res) {
ERR_put_error(39,(105),(11),"crypto\\ocsp\\ocsp_vfy.c",81);
goto f_err;
}
...
ERR_put_error(39,(105),(101),"crypto\\ocsp\\ocsp_vfy.c",91);
#line 92 "crypto\\ocsp\\ocsp_vfy.c"
...
if (X509_check_trust(x, 180, 0) != 1) {
ERR_put_error(39,(105),(112),"crypto\\ocsp\\ocsp_vfy.c",119);
goto err;
}
ret = 1;
}
...
X509_pubkey_digest(x, EVP_sha1(), tmphash, ((void *)0));
...
struct stack_st_OCSP_SINGLERESP *sresp;
X509 *signer, *sca;
OCSP_CERTID *caid = ((void *)0);
int i;
sresp = bs->tbsResponseData.responses;
if (sk_X509_num(chain) <= 0) {
ERR_put_error(39,(108),(105),"crypto\\ocsp\\ocsp_vfy.c",194);
return -1;
}
...
if (idcount <= 0) {
ERR_put_error(39,(107),(111),"crypto\\ocsp\\ocsp_vfy.c",239);
#line 240 "crypto\\ocsp\\ocsp_vfy.c"
return -1;
}
...
int mdlen;
unsigned char md[64];
if ((dgst = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(cid->hashAlgorithm.algorithm))))
== ((void *)0)) {
ERR_put_error(39,(109),(119),"crypto\\ocsp\\ocsp_vfy.c",277);
#line 278 "crypto\\ocsp\\ocsp_vfy.c"
return -1;
}
...
if (!X509_NAME_digest(iname, dgst, md, ((void *)0)))
return -1;
if (memcmp(md, cid->issuerNameHash.data, mdlen))
return 0;
X509_pubkey_digest(cert, dgst, md, ((void *)0));
...
tmpid = sk_OCSP_SINGLERESP_value(sresp, i)->certId;
ret = ocsp_match_issuerid(cert, tmpid, ((void *)0));
if (ret <= 0)
return ret;
}
return 1;
...
static int ocsp_check_delegated(X509 *x)
{
if ((X509_get_extension_flags(x) & 0x4)
&& (X509_get_extended_key_usage(x) & 0x20))
return 1;
ERR_put_error(39,(106),(103),"crypto\\ocsp\\ocsp_vfy.c",318);
return 0;
}
int OCSP_request_verify(OCSP_REQUEST *req, struct stack_st_X509 *certs,
X509_STORE *store, unsigned long flags)
...
if (ctx == ((void *)0)) {
ERR_put_error(39,(116),((1|64)),"crypto\\ocsp\\ocsp_vfy.c",338);
goto err;
}
if (!req->optionalSignature) {
ERR_put_error(39,(116),(128),"crypto\\ocsp\\ocsp_vfy.c",343);
goto err;
}
gen = req->tbsRequest.requestorName;
if (!gen || gen->type != 4) {
ERR_put_error(39,(116),(129),"crypto\\ocsp\\ocsp_vfy.c",349);
#line 350 "crypto\\ocsp\\ocsp_vfy.c"
goto err;
}
nm = gen->d.directoryName;
ret = ocsp_req_find_signer(&signer, req, nm, certs, flags);
if (ret <= 0) {
ERR_put_error(39,(116),(118),"crypto\\ocsp\\ocsp_vfy.c",356);
#line 357 "crypto\\ocsp\\ocsp_vfy.c"
goto err;
}
if ((ret == 2) && (flags & 0x200))
flags |= 0x10;
...
if (ret <= 0) {
ERR_put_error(39,(116),(117),"crypto\\ocsp\\ocsp_vfy.c",366);
goto err;
}
}
if (!(flags & 0x10)) {
int init_res;
if (flags & 0x8)
init_res = X509_STORE_CTX_init(ctx, store, signer, ((void *)0));
else
init_res = X509_STORE_CTX_init(ctx, store, signer,
req->optionalSignature->certs);
if (!init_res) {
ERR_put_error(39,(116),(11),"crypto\\ocsp\\ocsp_vfy.c",378);
goto err;
}
X509_STORE_CTX_set_purpose(ctx, 8);
...
ERR_put_error(39,(116),(101),"crypto\\ocsp\\ocsp_vfy.c",388);
#line 389 "crypto\\ocsp\\ocsp_vfy.c"
ERR_add_error_data(2, "Verify error:",
