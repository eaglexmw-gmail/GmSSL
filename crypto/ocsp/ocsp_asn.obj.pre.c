...
#line 17 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/bio.h"
...
#line 11 "crypto\\ocsp\\ocsp_asn.c"
...
#line 12 "crypto\\ocsp\\ocsp_asn.c"
...
#line 13 "crypto\\ocsp\\ocsp_asn.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\ocsp\\ocsp_lcl.h"
...
#line 14 "crypto\\ocsp\\ocsp_asn.c"
static const ASN1_TEMPLATE OCSP_SIGNATURE_seq_tt[] = {
{ ((0x1 << 12)), (0), (size_t)&(((OCSP_SIGNATURE *)0)->signatureAlgorithm), "signatureAlgorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((OCSP_SIGNATURE *)0)->signature), "signature", (ASN1_BIT_STRING_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x2 << 1)|(0x1)), (0), (size_t)&(((OCSP_SIGNATURE *)0)->certs), "certs", (X509_it) }
} ; const ASN1_ITEM * OCSP_SIGNATURE_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_SIGNATURE_seq_tt, sizeof(OCSP_SIGNATURE_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_SIGNATURE), "OCSP_SIGNATURE" }; return &local_it; }
OCSP_SIGNATURE *d2i_OCSP_SIGNATURE(OCSP_SIGNATURE **a, const unsigned char **in, long len) { return (OCSP_SIGNATURE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_SIGNATURE_it())); } int i2d_OCSP_SIGNATURE(OCSP_SIGNATURE *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_SIGNATURE_it())); } OCSP_SIGNATURE *OCSP_SIGNATURE_new(void) { return (OCSP_SIGNATURE *)ASN1_item_new((OCSP_SIGNATURE_it())); } void OCSP_SIGNATURE_free(OCSP_SIGNATURE *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_SIGNATURE_it())); }
static const ASN1_TEMPLATE OCSP_CERTID_seq_tt[] = {
{ ((0x1 << 12)), (0), (size_t)&(((OCSP_CERTID *)0)->hashAlgorithm), "hashAlgorithm", (X509_ALGOR_it) },
{ ((0x1 << 12)), (0), (size_t)&(((OCSP_CERTID *)0)->issuerNameHash), "issuerNameHash", (ASN1_OCTET_STRING_it) },
{ ((0x1 << 12)), (0), (size_t)&(((OCSP_CERTID *)0)->issuerKeyHash), "issuerKeyHash", (ASN1_OCTET_STRING_it) },
{ ((0x1 << 12)), (0), (size_t)&(((OCSP_CERTID *)0)->serialNumber), "serialNumber", (ASN1_INTEGER_it) }
} ; const ASN1_ITEM * OCSP_CERTID_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_CERTID_seq_tt, sizeof(OCSP_CERTID_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_CERTID), "OCSP_CERTID" }; return &local_it; }
OCSP_CERTID *d2i_OCSP_CERTID(OCSP_CERTID **a, const unsigned char **in, long len) { return (OCSP_CERTID *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_CERTID_it())); } int i2d_OCSP_CERTID(OCSP_CERTID *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_CERTID_it())); } OCSP_CERTID *OCSP_CERTID_new(void) { return (OCSP_CERTID *)ASN1_item_new((OCSP_CERTID_it())); } void OCSP_CERTID_free(OCSP_CERTID *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_CERTID_it())); }
static const ASN1_TEMPLATE OCSP_ONEREQ_seq_tt[] = {
{ (0), (0), (size_t)&(((OCSP_ONEREQ *)0)->reqCert), "reqCert", (OCSP_CERTID_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x2 << 1)|(0x1)), (0), (size_t)&(((OCSP_ONEREQ *)0)->singleRequestExtensions), "singleRequestExtensions", (X509_EXTENSION_it) }
} ; const ASN1_ITEM * OCSP_ONEREQ_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_ONEREQ_seq_tt, sizeof(OCSP_ONEREQ_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_ONEREQ), "OCSP_ONEREQ" }; return &local_it; }
OCSP_ONEREQ *d2i_OCSP_ONEREQ(OCSP_ONEREQ **a, const unsigned char **in, long len) { return (OCSP_ONEREQ *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_ONEREQ_it())); } int i2d_OCSP_ONEREQ(OCSP_ONEREQ *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_ONEREQ_it())); } OCSP_ONEREQ *OCSP_ONEREQ_new(void) { return (OCSP_ONEREQ *)ASN1_item_new((OCSP_ONEREQ_it())); } void OCSP_ONEREQ_free(OCSP_ONEREQ *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_ONEREQ_it())); }
static const ASN1_TEMPLATE OCSP_REQINFO_seq_tt[] = {
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((OCSP_REQINFO *)0)->version), "version", (ASN1_INTEGER_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (1), (size_t)&(((OCSP_REQINFO *)0)->requestorName), "requestorName", (GENERAL_NAME_it) },
{ ((0x2 << 1)), (0), (size_t)&(((OCSP_REQINFO *)0)->requestList), "requestList", (OCSP_ONEREQ_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x2 << 1)|(0x1)), (2), (size_t)&(((OCSP_REQINFO *)0)->requestExtensions), "requestExtensions", (X509_EXTENSION_it) }
} ; const ASN1_ITEM * OCSP_REQINFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_REQINFO_seq_tt, sizeof(OCSP_REQINFO_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_REQINFO), "OCSP_REQINFO" }; return &local_it; }
...
{ ((0x1 << 12)), (0), (size_t)&(((OCSP_REQUEST *)0)->tbsRequest), "tbsRequest", (OCSP_REQINFO_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((OCSP_REQUEST *)0)->optionalSignature), "optionalSignature", (OCSP_SIGNATURE_it) }
} ; const ASN1_ITEM * OCSP_REQUEST_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_REQUEST_seq_tt, sizeof(OCSP_REQUEST_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_REQUEST), "OCSP_REQUEST" }; return &local_it; }
OCSP_REQUEST *d2i_OCSP_REQUEST(OCSP_REQUEST **a, const unsigned char **in, long len) { return (OCSP_REQUEST *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_REQUEST_it())); } int i2d_OCSP_REQUEST(OCSP_REQUEST *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_REQUEST_it())); } OCSP_REQUEST *OCSP_REQUEST_new(void) { return (OCSP_REQUEST *)ASN1_item_new((OCSP_REQUEST_it())); } void OCSP_REQUEST_free(OCSP_REQUEST *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_REQUEST_it())); }
static const ASN1_TEMPLATE OCSP_RESPBYTES_seq_tt[] = {
{ (0), (0), (size_t)&(((OCSP_RESPBYTES *)0)->responseType), "responseType", (ASN1_OBJECT_it) },
{ (0), (0), (size_t)&(((OCSP_RESPBYTES *)0)->response), "response", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * OCSP_RESPBYTES_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_RESPBYTES_seq_tt, sizeof(OCSP_RESPBYTES_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_RESPBYTES), "OCSP_RESPBYTES" }; return &local_it; }
OCSP_RESPBYTES *d2i_OCSP_RESPBYTES(OCSP_RESPBYTES **a, const unsigned char **in, long len) { return (OCSP_RESPBYTES *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_RESPBYTES_it())); } int i2d_OCSP_RESPBYTES(OCSP_RESPBYTES *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_RESPBYTES_it())); } OCSP_RESPBYTES *OCSP_RESPBYTES_new(void) { return (OCSP_RESPBYTES *)ASN1_item_new((OCSP_RESPBYTES_it())); } void OCSP_RESPBYTES_free(OCSP_RESPBYTES *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_RESPBYTES_it())); }
static const ASN1_TEMPLATE OCSP_RESPONSE_seq_tt[] = {
{ (0), (0), (size_t)&(((OCSP_RESPONSE *)0)->responseStatus), "responseStatus", (ASN1_ENUMERATED_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((OCSP_RESPONSE *)0)->responseBytes), "responseBytes", (OCSP_RESPBYTES_it) }
} ; const ASN1_ITEM * OCSP_RESPONSE_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_RESPONSE_seq_tt, sizeof(OCSP_RESPONSE_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_RESPONSE), "OCSP_RESPONSE" }; return &local_it; }
OCSP_RESPONSE *d2i_OCSP_RESPONSE(OCSP_RESPONSE **a, const unsigned char **in, long len) { return (OCSP_RESPONSE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_RESPONSE_it())); } int i2d_OCSP_RESPONSE(OCSP_RESPONSE *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_RESPONSE_it())); } OCSP_RESPONSE *OCSP_RESPONSE_new(void) { return (OCSP_RESPONSE *)ASN1_item_new((OCSP_RESPONSE_it())); } void OCSP_RESPONSE_free(OCSP_RESPONSE *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_RESPONSE_it())); }
static const ASN1_TEMPLATE OCSP_RESPID_ch_tt[] = {
{ ((0x2 << 3)|(0x2<<6) | 0), (1), (size_t)&(((OCSP_RESPID *)0)->value.byName), "value.byName", (X509_NAME_it) },
{ ((0x2 << 3)|(0x2<<6) | 0), (2), (size_t)&(((OCSP_RESPID *)0)->value.byKey), "value.byKey", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * OCSP_RESPID_it(void) { static const ASN1_ITEM local_it = { 0x2, (size_t)&(((OCSP_RESPID *)0)->type) , OCSP_RESPID_ch_tt, sizeof(OCSP_RESPID_ch_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_RESPID), "OCSP_RESPID" }; return &local_it; }
OCSP_RESPID *d2i_OCSP_RESPID(OCSP_RESPID **a, const unsigned char **in, long len) { return (OCSP_RESPID *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_RESPID_it())); } int i2d_OCSP_RESPID(OCSP_RESPID *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_RESPID_it())); } OCSP_RESPID *OCSP_RESPID_new(void) { return (OCSP_RESPID *)ASN1_item_new((OCSP_RESPID_it())); } void OCSP_RESPID_free(OCSP_RESPID *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_RESPID_it())); }
static const ASN1_TEMPLATE OCSP_REVOKEDINFO_seq_tt[] = {
{ (0), (0), (size_t)&(((OCSP_REVOKEDINFO *)0)->revocationTime), "revocationTime", (ASN1_GENERALIZEDTIME_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((OCSP_REVOKEDINFO *)0)->revocationReason), "revocationReason", (ASN1_ENUMERATED_it) }
} ; const ASN1_ITEM * OCSP_REVOKEDINFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_REVOKEDINFO_seq_tt, sizeof(OCSP_REVOKEDINFO_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_REVOKEDINFO), "OCSP_REVOKEDINFO" }; return &local_it; }
OCSP_REVOKEDINFO *d2i_OCSP_REVOKEDINFO(OCSP_REVOKEDINFO **a, const unsigned char **in, long len) { return (OCSP_REVOKEDINFO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_REVOKEDINFO_it())); } int i2d_OCSP_REVOKEDINFO(OCSP_REVOKEDINFO *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_REVOKEDINFO_it())); } OCSP_REVOKEDINFO *OCSP_REVOKEDINFO_new(void) { return (OCSP_REVOKEDINFO *)ASN1_item_new((OCSP_REVOKEDINFO_it())); } void OCSP_REVOKEDINFO_free(OCSP_REVOKEDINFO *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_REVOKEDINFO_it())); }
static const ASN1_TEMPLATE OCSP_CERTSTATUS_ch_tt[] = {
{ ((0x1 << 3)|(0x2<<6) | 0), (0), (size_t)&(((OCSP_CERTSTATUS *)0)->value.good), "value.good", (ASN1_NULL_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (1), (size_t)&(((OCSP_CERTSTATUS *)0)->value.revoked), "value.revoked", (OCSP_REVOKEDINFO_it) },
{ ((0x1 << 3)|(0x2<<6) | 0), (2), (size_t)&(((OCSP_CERTSTATUS *)0)->value.unknown), "value.unknown", (ASN1_NULL_it) }
} ; const ASN1_ITEM * OCSP_CERTSTATUS_it(void) { static const ASN1_ITEM local_it = { 0x2, (size_t)&(((OCSP_CERTSTATUS *)0)->type) , OCSP_CERTSTATUS_ch_tt, sizeof(OCSP_CERTSTATUS_ch_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_CERTSTATUS), "OCSP_CERTSTATUS" }; return &local_it; }
...
{ (0), (0), (size_t)&(((OCSP_SINGLERESP *)0)->certId), "certId", (OCSP_CERTID_it) },
{ (0), (0), (size_t)&(((OCSP_SINGLERESP *)0)->certStatus), "certStatus", (OCSP_CERTSTATUS_it) },
{ (0), (0), (size_t)&(((OCSP_SINGLERESP *)0)->thisUpdate), "thisUpdate", (ASN1_GENERALIZEDTIME_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((OCSP_SINGLERESP *)0)->nextUpdate), "nextUpdate", (ASN1_GENERALIZEDTIME_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x2 << 1)|(0x1)), (1), (size_t)&(((OCSP_SINGLERESP *)0)->singleExtensions), "singleExtensions", (X509_EXTENSION_it) }
} ; const ASN1_ITEM * OCSP_SINGLERESP_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_SINGLERESP_seq_tt, sizeof(OCSP_SINGLERESP_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_SINGLERESP), "OCSP_SINGLERESP" }; return &local_it; }
OCSP_SINGLERESP *d2i_OCSP_SINGLERESP(OCSP_SINGLERESP **a, const unsigned char **in, long len) { return (OCSP_SINGLERESP *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_SINGLERESP_it())); } int i2d_OCSP_SINGLERESP(OCSP_SINGLERESP *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_SINGLERESP_it())); } OCSP_SINGLERESP *OCSP_SINGLERESP_new(void) { return (OCSP_SINGLERESP *)ASN1_item_new((OCSP_SINGLERESP_it())); } void OCSP_SINGLERESP_free(OCSP_SINGLERESP *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_SINGLERESP_it())); }
static const ASN1_TEMPLATE OCSP_RESPDATA_seq_tt[] = {
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((OCSP_RESPDATA *)0)->version), "version", (ASN1_INTEGER_it) },
{ ((0x1 << 12)), (0), (size_t)&(((OCSP_RESPDATA *)0)->responderId), "responderId", (OCSP_RESPID_it) },
{ (0), (0), (size_t)&(((OCSP_RESPDATA *)0)->producedAt), "producedAt", (ASN1_GENERALIZEDTIME_it) },
{ ((0x2 << 1)), (0), (size_t)&(((OCSP_RESPDATA *)0)->responses), "responses", (OCSP_SINGLERESP_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x2 << 1)|(0x1)), (1), (size_t)&(((OCSP_RESPDATA *)0)->responseExtensions), "responseExtensions", (X509_EXTENSION_it) }
} ; const ASN1_ITEM * OCSP_RESPDATA_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_RESPDATA_seq_tt, sizeof(OCSP_RESPDATA_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_RESPDATA), "OCSP_RESPDATA" }; return &local_it; }
OCSP_RESPDATA *d2i_OCSP_RESPDATA(OCSP_RESPDATA **a, const unsigned char **in, long len) { return (OCSP_RESPDATA *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_RESPDATA_it())); } int i2d_OCSP_RESPDATA(OCSP_RESPDATA *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_RESPDATA_it())); } OCSP_RESPDATA *OCSP_RESPDATA_new(void) { return (OCSP_RESPDATA *)ASN1_item_new((OCSP_RESPDATA_it())); } void OCSP_RESPDATA_free(OCSP_RESPDATA *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_RESPDATA_it())); }
static const ASN1_TEMPLATE OCSP_BASICRESP_seq_tt[] = {
{ ((0x1 << 12)), (0), (size_t)&(((OCSP_BASICRESP *)0)->tbsResponseData), "tbsResponseData", (OCSP_RESPDATA_it) },
{ ((0x1 << 12)), (0), (size_t)&(((OCSP_BASICRESP *)0)->signatureAlgorithm), "signatureAlgorithm", (X509_ALGOR_it) },
{ (0), (0), (size_t)&(((OCSP_BASICRESP *)0)->signature), "signature", (ASN1_BIT_STRING_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x2 << 1)|(0x1)), (0), (size_t)&(((OCSP_BASICRESP *)0)->certs), "certs", (X509_it) }
} ; const ASN1_ITEM * OCSP_BASICRESP_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_BASICRESP_seq_tt, sizeof(OCSP_BASICRESP_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_BASICRESP), "OCSP_BASICRESP" }; return &local_it; }
OCSP_BASICRESP *d2i_OCSP_BASICRESP(OCSP_BASICRESP **a, const unsigned char **in, long len) { return (OCSP_BASICRESP *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_BASICRESP_it())); } int i2d_OCSP_BASICRESP(OCSP_BASICRESP *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_BASICRESP_it())); } OCSP_BASICRESP *OCSP_BASICRESP_new(void) { return (OCSP_BASICRESP *)ASN1_item_new((OCSP_BASICRESP_it())); } void OCSP_BASICRESP_free(OCSP_BASICRESP *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_BASICRESP_it())); }
static const ASN1_TEMPLATE OCSP_CRLID_seq_tt[] = {
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (0), (size_t)&(((OCSP_CRLID *)0)->crlUrl), "crlUrl", (ASN1_IA5STRING_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (1), (size_t)&(((OCSP_CRLID *)0)->crlNum), "crlNum", (ASN1_INTEGER_it) },
{ ((0x2 << 3)|(0x2<<6) | (0x1)), (2), (size_t)&(((OCSP_CRLID *)0)->crlTime), "crlTime", (ASN1_GENERALIZEDTIME_it) }
} ; const ASN1_ITEM * OCSP_CRLID_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_CRLID_seq_tt, sizeof(OCSP_CRLID_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_CRLID), "OCSP_CRLID" }; return &local_it; }
OCSP_CRLID *d2i_OCSP_CRLID(OCSP_CRLID **a, const unsigned char **in, long len) { return (OCSP_CRLID *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_CRLID_it())); } int i2d_OCSP_CRLID(OCSP_CRLID *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_CRLID_it())); } OCSP_CRLID *OCSP_CRLID_new(void) { return (OCSP_CRLID *)ASN1_item_new((OCSP_CRLID_it())); } void OCSP_CRLID_free(OCSP_CRLID *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_CRLID_it())); }
static const ASN1_TEMPLATE OCSP_SERVICELOC_seq_tt[] = {
{ (0), (0), (size_t)&(((OCSP_SERVICELOC *)0)->issuer), "issuer", (X509_NAME_it) },
{ ((0x2 << 1)|(0x1)), (0), (size_t)&(((OCSP_SERVICELOC *)0)->locator), "locator", (ACCESS_DESCRIPTION_it) }
} ; const ASN1_ITEM * OCSP_SERVICELOC_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OCSP_SERVICELOC_seq_tt, sizeof(OCSP_SERVICELOC_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(OCSP_SERVICELOC), "OCSP_SERVICELOC" }; return &local_it; }
OCSP_SERVICELOC *d2i_OCSP_SERVICELOC(OCSP_SERVICELOC **a, const unsigned char **in, long len) { return (OCSP_SERVICELOC *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OCSP_SERVICELOC_it())); } int i2d_OCSP_SERVICELOC(OCSP_SERVICELOC *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (OCSP_SERVICELOC_it())); } OCSP_SERVICELOC *OCSP_SERVICELOC_new(void) { return (OCSP_SERVICELOC *)ASN1_item_new((OCSP_SERVICELOC_it())); } void OCSP_SERVICELOC_free(OCSP_SERVICELOC *a) { ASN1_item_free((ASN1_VALUE *)a, (OCSP_SERVICELOC_it())); }
