...
#line 30 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/bn.h"
...
#line 12 "crypto\\rsa\\rsa_chk.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\rsa\\rsa_locl.h"
...
#line 11 "d:\\07.opensrc\\gmssl\\crypto\\rsa\\rsa_locl.h"
struct rsa_st
{
    int pad;
    long version;
...
int RSA_check_key_ex(const RSA *key, BN_GENCB *cb)
{
    ...
    {
        ERR_put_error(4,(160),(147),"crypto\\rsa\\rsa_chk.c",27);
        return 0;
    }
    i = BN_new();
    j = BN_new();
    ...
    {
        ret = -1;
        ERR_put_error(4,(160),((1|64)),"crypto\\rsa\\rsa_chk.c",40);
        goto err;
    }
    if (BN_is_one(key->e))
    {
        ret = 0;
        ERR_put_error(4,(160),(101),"crypto\\rsa\\rsa_chk.c",46);
    }
    if (!BN_is_odd(key->e))
    {
        ret = 0;
        ERR_put_error(4,(160),(101),"crypto\\rsa\\rsa_chk.c",50);
    }
    if (BN_is_prime_ex(key->p, 0, ((void *)0), cb) != 1)
    {
        ret = 0;
        ERR_put_error(4,(160),(128),"crypto\\rsa\\rsa_chk.c",56);
    }
    if (BN_is_prime_ex(key->q, 0, ((void *)0), cb) != 1)
    {
        ret = 0;
        ERR_put_error(4,(160),(129),"crypto\\rsa\\rsa_chk.c",62);
    }
    ...
    {
        ret = 0;
        ERR_put_error(4,(160),(127),"crypto\\rsa\\rsa_chk.c",72);
    }
    ...
    {
        ret = 0;
        ERR_put_error(4,(160),(123),"crypto\\rsa\\rsa_chk.c",105);
    }
    if (key->dmp1 != ((void *)0) && key->dmq1 != ((void *)0) && key->iqmp != ((void *)0))
    {
        ...
        if (!BN_div(((void *)0),(j),(key->d),(i),(ctx)))
        {
            ret = -1;
            goto err;
        }
        ...
        {
            ret = 0;
            ERR_put_error(4,(160),(124),"crypto\\rsa\\rsa_chk.c",120);
        }
        ...
        {
            ret = 0;
            ERR_put_error(4,(160),(125),"crypto\\rsa\\rsa_chk.c",134);
        }
        ...
        {
            ret = 0;
            ERR_put_error(4,(160),(126),"crypto\\rsa\\rsa_chk.c",144);
        }
    }
err:
    BN_free(i);
