...
#line 11 "crypto\\rsa\\rsa_x931g.c"
...
#line 12 "crypto\\rsa\\rsa_x931g.c"
...
#line 13 "crypto\\rsa\\rsa_x931g.c"
...
#line 14 "crypto\\rsa\\rsa_x931g.c"
...
#line 15 "crypto\\rsa\\rsa_x931g.c"
...
#line 16 "crypto\\rsa\\rsa_x931g.c"
int RSA_X931_derive_ex(RSA *rsa, BIGNUM *p1, BIGNUM *p2, BIGNUM *q1,
BIGNUM *q2, const BIGNUM *Xp1, const BIGNUM *Xp2,
const BIGNUM *Xp, const BIGNUM *Xq1, const BIGNUM *Xq2,
const BIGNUM *Xq, const BIGNUM *e, BN_GENCB *cb)
...
if (rsa->dmp1 == ((void *)0))
goto err;
if (!BN_div(((void *)0),(rsa->dmp1),(rsa->d),(r1),(ctx)))
goto err;
rsa->dmq1 = BN_new();
if (rsa->dmq1 == ((void *)0))
goto err;
if (!BN_div(((void *)0),(rsa->dmq1),(rsa->d),(r2),(ctx)))
goto err;
