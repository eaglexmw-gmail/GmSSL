#line 1 "crypto\\x509v3\\v3_pcia.c"
...
#line 43 "crypto\\x509v3\\v3_pcia.c"
...
#line 44 "crypto\\x509v3\\v3_pcia.c"
...
#line 45 "crypto\\x509v3\\v3_pcia.c"
static const ASN1_TEMPLATE PROXY_POLICY_seq_tt[] =
{
{ (0), (0), (size_t)&(((PROXY_POLICY *)0)->policyLanguage), "policyLanguage", (ASN1_OBJECT_it) },
{ ((0x1)), (0), (size_t)&(((PROXY_POLICY *)0)->policy), "policy", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * PROXY_POLICY_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, PROXY_POLICY_seq_tt, sizeof(PROXY_POLICY_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(PROXY_POLICY), "PROXY_POLICY" }; return &local_it; }
PROXY_POLICY *d2i_PROXY_POLICY(PROXY_POLICY **a, const unsigned char **in, long len) { return (PROXY_POLICY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (PROXY_POLICY_it())); } int i2d_PROXY_POLICY(PROXY_POLICY *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (PROXY_POLICY_it())); } PROXY_POLICY *PROXY_POLICY_new(void) { return (PROXY_POLICY *)ASN1_item_new((PROXY_POLICY_it())); } void PROXY_POLICY_free(PROXY_POLICY *a) { ASN1_item_free((ASN1_VALUE *)a, (PROXY_POLICY_it())); }
static const ASN1_TEMPLATE PROXY_CERT_INFO_EXTENSION_seq_tt[] =
{
{ ((0x1)), (0), (size_t)&(((PROXY_CERT_INFO_EXTENSION *)0)->pcPathLengthConstraint), "pcPathLengthConstraint", (ASN1_INTEGER_it) },
{ (0), (0), (size_t)&(((PROXY_CERT_INFO_EXTENSION *)0)->proxyPolicy), "proxyPolicy", (PROXY_POLICY_it) }
} ; const ASN1_ITEM * PROXY_CERT_INFO_EXTENSION_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, PROXY_CERT_INFO_EXTENSION_seq_tt, sizeof(PROXY_CERT_INFO_EXTENSION_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(PROXY_CERT_INFO_EXTENSION), "PROXY_CERT_INFO_EXTENSION" }; return &local_it; }
PROXY_CERT_INFO_EXTENSION *d2i_PROXY_CERT_INFO_EXTENSION(PROXY_CERT_INFO_EXTENSION **a, const unsigned char **in, long len) { return (PROXY_CERT_INFO_EXTENSION *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (PROXY_CERT_INFO_EXTENSION_it())); } int i2d_PROXY_CERT_INFO_EXTENSION(PROXY_CERT_INFO_EXTENSION *a, unsigned char **out) { return ASN1_item_i2d((ASN1_VALUE *)a, out, (PROXY_CERT_INFO_EXTENSION_it())); } PROXY_CERT_INFO_EXTENSION *PROXY_CERT_INFO_EXTENSION_new(void) { return (PROXY_CERT_INFO_EXTENSION *)ASN1_item_new((PROXY_CERT_INFO_EXTENSION_it())); } void PROXY_CERT_INFO_EXTENSION_free(PROXY_CERT_INFO_EXTENSION *a) { ASN1_item_free((ASN1_VALUE *)a, (PROXY_CERT_INFO_EXTENSION_it())); }
