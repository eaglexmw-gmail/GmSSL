...
const ASN1_ITEM * PROXY_POLICY_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, PROXY_POLICY_seq_tt, sizeof(PROXY_POLICY_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(PROXY_POLICY), "PROXY_POLICY" };
    return &local_it;
}
PROXY_POLICY *d2i_PROXY_POLICY(PROXY_POLICY **a, const unsigned char **in, long len)
{
...
const ASN1_ITEM * PROXY_CERT_INFO_EXTENSION_it(void)
{
    static const ASN1_ITEM local_it = { 0x1, 16, PROXY_CERT_INFO_EXTENSION_seq_tt, sizeof(PROXY_CERT_INFO_EXTENSION_seq_tt) / sizeof(ASN1_TEMPLATE), ((void *)0), sizeof(PROXY_CERT_INFO_EXTENSION), "PROXY_CERT_INFO_EXTENSION" };
    return &local_it;
}
PROXY_CERT_INFO_EXTENSION *d2i_PROXY_CERT_INFO_EXTENSION(PROXY_CERT_INFO_EXTENSION **a, const unsigned char **in, long len)
{
