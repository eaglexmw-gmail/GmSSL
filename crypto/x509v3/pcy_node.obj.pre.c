#line 1 "crypto\\x509v3\\pcy_node.c"
...
#line 11 "crypto\\x509v3\\pcy_node.c"
...
#line 12 "crypto\\x509v3\\pcy_node.c"
...
#line 13 "crypto\\x509v3\\pcy_node.c"
#line 1 "d:\\07.opensrc\\gmssl\\crypto\\x509v3\\pcy_int.h"
typedef struct X509_POLICY_DATA_st X509_POLICY_DATA;
struct stack_st_X509_POLICY_DATA; typedef int (*sk_X509_POLICY_DATA_compfunc)(const X509_POLICY_DATA * const *a, const X509_POLICY_DATA *const *b); typedef void (*sk_X509_POLICY_DATA_freefunc)(X509_POLICY_DATA *a); typedef X509_POLICY_DATA * (*sk_X509_POLICY_DATA_copyfunc)(const X509_POLICY_DATA *a); static __inline int sk_X509_POLICY_DATA_num(const struct stack_st_X509_POLICY_DATA *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __inline X509_POLICY_DATA *sk_X509_POLICY_DATA_value(const struct stack_st_X509_POLICY_DATA *sk, int idx) { return (X509_POLICY_DATA *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __inline struct stack_st_X509_POLICY_DATA *sk_X509_POLICY_DATA_new(sk_X509_POLICY_DATA_compfunc compare) { return (struct stack_st_X509_POLICY_DATA *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __inline struct stack_st_X509_POLICY_DATA *sk_X509_POLICY_DATA_new_null(void) { return (struct stack_st_X509_POLICY_DATA *)OPENSSL_sk_new_null(); } static __inline void sk_X509_POLICY_DATA_free(struct stack_st_X509_POLICY_DATA *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __inline void sk_X509_POLICY_DATA_zero(struct stack_st_X509_POLICY_DATA *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __inline X509_POLICY_DATA *sk_X509_POLICY_DATA_delete(struct stack_st_X509_POLICY_DATA *sk, int i) { return (X509_POLICY_DATA *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __inline X509_POLICY_DATA *sk_X509_POLICY_DATA_delete_ptr(struct stack_st_X509_POLICY_DATA *sk, X509_POLICY_DATA *ptr) { return (X509_POLICY_DATA *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline int sk_X509_POLICY_DATA_push(struct stack_st_X509_POLICY_DATA *sk, X509_POLICY_DATA *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline int sk_X509_POLICY_DATA_unshift(struct stack_st_X509_POLICY_DATA *sk, X509_POLICY_DATA *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline X509_POLICY_DATA *sk_X509_POLICY_DATA_pop(struct stack_st_X509_POLICY_DATA *sk) { return (X509_POLICY_DATA *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __inline X509_POLICY_DATA *sk_X509_POLICY_DATA_shift(struct stack_st_X509_POLICY_DATA *sk) { return (X509_POLICY_DATA *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __inline void sk_X509_POLICY_DATA_pop_free(struct stack_st_X509_POLICY_DATA *sk, sk_X509_POLICY_DATA_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __inline int sk_X509_POLICY_DATA_insert(struct stack_st_X509_POLICY_DATA *sk, X509_POLICY_DATA *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __inline X509_POLICY_DATA *sk_X509_POLICY_DATA_set(struct stack_st_X509_POLICY_DATA *sk, int idx, X509_POLICY_DATA *ptr) { return (X509_POLICY_DATA *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __inline int sk_X509_POLICY_DATA_find(struct stack_st_X509_POLICY_DATA *sk, X509_POLICY_DATA *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline int sk_X509_POLICY_DATA_find_ex(struct stack_st_X509_POLICY_DATA *sk, X509_POLICY_DATA *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __inline void sk_X509_POLICY_DATA_sort(struct stack_st_X509_POLICY_DATA *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __inline int sk_X509_POLICY_DATA_is_sorted(const struct stack_st_X509_POLICY_DATA *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __inline struct stack_st_X509_POLICY_DATA * sk_X509_POLICY_DATA_dup(const struct stack_st_X509_POLICY_DATA *sk) { return (struct stack_st_X509_POLICY_DATA *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __inline struct stack_st_X509_POLICY_DATA *sk_X509_POLICY_DATA_deep_copy(const struct stack_st_X509_POLICY_DATA *sk, sk_X509_POLICY_DATA_copyfunc copyfunc, sk_X509_POLICY_DATA_freefunc freefunc) { return (struct stack_st_X509_POLICY_DATA *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __inline sk_X509_POLICY_DATA_compfunc sk_X509_POLICY_DATA_set_cmp_func(struct stack_st_X509_POLICY_DATA *sk, sk_X509_POLICY_DATA_compfunc compare) { return (sk_X509_POLICY_DATA_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
#line 15 "crypto\\x509v3\\pcy_node.c"
...
X509_POLICY_NODE *tree_find_sk(struct stack_st_X509_POLICY_NODE *nodes,
const ASN1_OBJECT *id)
{
X509_POLICY_DATA n;
X509_POLICY_NODE l;
...
{
X509_POLICY_NODE *node;
node = CRYPTO_zalloc(sizeof(*node), "crypto\\x509v3\\pcy_node.c", 68);
if (node == ((void *)0))
return ((void *)0);
node->data = data;
node->parent = parent;
...
void policy_node_free(X509_POLICY_NODE *node)
{
CRYPTO_free(node, "crypto\\x509v3\\pcy_node.c", 110);
}
int policy_node_match(const X509_POLICY_LEVEL *lvl,
const X509_POLICY_NODE *node, const ASN1_OBJECT *oid)
{
