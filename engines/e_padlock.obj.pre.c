...
#line 16 "engines\\e_padlock.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/evp.h"
#line 17 "engines\\e_padlock.c"
...
#line 18 "engines\\e_padlock.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/rand.h"
#line 19 "engines\\e_padlock.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/err.h"
#line 20 "engines\\e_padlock.c"
...
#line 21 "engines\\e_padlock.c"
#line 37 "engines\\e_padlock.c"
static ENGINE *ENGINE_padlock(void);
#line 49 "engines\\e_padlock.c"
#line 50 "engines\\e_padlock.c"
...
ENGINE_free(toadd);
ERR_clear_error();
#line 64 "engines\\e_padlock.c"
}
#line 67 "engines\\e_padlock.c"
...
#line 243 "engines\\e_padlock.c"
#line 247 "engines\\e_padlock.c"
#line 251 "engines\\e_padlock.c"
#line 255 "engines\\e_padlock.c"
#line 259 "engines\\e_padlock.c"
#line 263 "engines\\e_padlock.c"
...
((struct padlock_cipher_data *) ( (unsigned char *)(EVP_CIPHER_CTX_get_cipher_data(ctx)) + ( (0x10 - ((size_t)(EVP_CIPHER_CTX_get_cipher_data(ctx)) & 0x0F)) & 0x0F ) )), nbytes);
}
static int
padlock_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out_arg,
const unsigned char *in_arg, size_t nbytes)
{
struct padlock_cipher_data *cdata = ((struct padlock_cipher_data *) ( (unsigned char *)(EVP_CIPHER_CTX_get_cipher_data(ctx)) + ( (0x10 - ((size_t)(EVP_CIPHER_CTX_get_cipher_data(ctx)) & 0x0F)) & 0x0F ) ));
int ret;
memcpy(cdata->iv, EVP_CIPHER_CTX_iv(ctx), 16);
if ((ret = padlock_cbc_encrypt(out_arg, in_arg, cdata, nbytes)))
memcpy(EVP_CIPHER_CTX_iv_noconst(ctx), cdata->iv, 16);
return ret;
}
static int
...
EVP_CIPHER_CTX_set_num(ctx, chunk % 16);
}
if (nbytes == 0)
return 1;
memcpy(cdata->iv, EVP_CIPHER_CTX_iv(ctx), 16);
if ((chunk = nbytes & ~(16 - 1))) {
...
padlock_ctr32_encrypt(out, in, ctx, 16 * blocks);
}
static int
...
static EVP_CIPHER *_hidden_aes_128_ecb = ((void *)0); static const EVP_CIPHER *padlock_aes_128_ecb(void) { if (_hidden_aes_128_ecb == ((void *)0) && ((_hidden_aes_128_ecb = EVP_CIPHER_meth_new(418, 16, 16)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_ecb, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_128_ecb, 0 | 0x1) || !EVP_CIPHER_meth_set_init(_hidden_aes_128_ecb, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_128_ecb, padlock_ecb_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_128_ecb, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_128_ecb, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_128_ecb, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_128_ecb); _hidden_aes_128_ecb = ((void *)0); } return _hidden_aes_128_ecb; }
static EVP_CIPHER *_hidden_aes_128_cbc = ((void *)0); static const EVP_CIPHER *padlock_aes_128_cbc(void) { if (_hidden_aes_128_cbc == ((void *)0) && ((_hidden_aes_128_cbc = EVP_CIPHER_meth_new(419, 16, 16)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_cbc, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_128_cbc, 0 | 0x2) || !EVP_CIPHER_meth_set_init(_hidden_aes_128_cbc, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_128_cbc, padlock_cbc_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_128_cbc, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_128_cbc, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_128_cbc, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_128_cbc); _hidden_aes_128_cbc = ((void *)0); } return _hidden_aes_128_cbc; }
static EVP_CIPHER *_hidden_aes_128_cfb = ((void *)0); static const EVP_CIPHER *padlock_aes_128_cfb(void) { if (_hidden_aes_128_cfb == ((void *)0) && ((_hidden_aes_128_cfb = EVP_CIPHER_meth_new(421, 1, 16)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_cfb, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_128_cfb, 0 | 0x3) || !EVP_CIPHER_meth_set_init(_hidden_aes_128_cfb, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_128_cfb, padlock_cfb_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_128_cfb, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_128_cfb, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_128_cfb, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_128_cfb); _hidden_aes_128_cfb = ((void *)0); } return _hidden_aes_128_cfb; }
static EVP_CIPHER *_hidden_aes_128_ofb = ((void *)0); static const EVP_CIPHER *padlock_aes_128_ofb(void) { if (_hidden_aes_128_ofb == ((void *)0) && ((_hidden_aes_128_ofb = EVP_CIPHER_meth_new(420, 1, 16)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_ofb, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_128_ofb, 0 | 0x4) || !EVP_CIPHER_meth_set_init(_hidden_aes_128_ofb, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_128_ofb, padlock_ofb_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_128_ofb, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_128_ofb, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_128_ofb, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_128_ofb); _hidden_aes_128_ofb = ((void *)0); } return _hidden_aes_128_ofb; }
static EVP_CIPHER *_hidden_aes_128_ctr = ((void *)0); static const EVP_CIPHER *padlock_aes_128_ctr(void) { if (_hidden_aes_128_ctr == ((void *)0) && ((_hidden_aes_128_ctr = EVP_CIPHER_meth_new(904, 1, 16)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_ctr, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_128_ctr, 0 | 0x5) || !EVP_CIPHER_meth_set_init(_hidden_aes_128_ctr, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_128_ctr, padlock_ctr_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_128_ctr, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_128_ctr, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_128_ctr, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_128_ctr); _hidden_aes_128_ctr = ((void *)0); } return _hidden_aes_128_ctr; }
static EVP_CIPHER *_hidden_aes_192_ecb = ((void *)0); static const EVP_CIPHER *padlock_aes_192_ecb(void) { if (_hidden_aes_192_ecb == ((void *)0) && ((_hidden_aes_192_ecb = EVP_CIPHER_meth_new(422, 16, 24)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_192_ecb, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_192_ecb, 0 | 0x1) || !EVP_CIPHER_meth_set_init(_hidden_aes_192_ecb, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_192_ecb, padlock_ecb_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_192_ecb, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_192_ecb, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_192_ecb, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_192_ecb); _hidden_aes_192_ecb = ((void *)0); } return _hidden_aes_192_ecb; }
static EVP_CIPHER *_hidden_aes_192_cbc = ((void *)0); static const EVP_CIPHER *padlock_aes_192_cbc(void) { if (_hidden_aes_192_cbc == ((void *)0) && ((_hidden_aes_192_cbc = EVP_CIPHER_meth_new(423, 16, 24)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_192_cbc, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_192_cbc, 0 | 0x2) || !EVP_CIPHER_meth_set_init(_hidden_aes_192_cbc, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_192_cbc, padlock_cbc_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_192_cbc, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_192_cbc, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_192_cbc, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_192_cbc); _hidden_aes_192_cbc = ((void *)0); } return _hidden_aes_192_cbc; }
static EVP_CIPHER *_hidden_aes_192_cfb = ((void *)0); static const EVP_CIPHER *padlock_aes_192_cfb(void) { if (_hidden_aes_192_cfb == ((void *)0) && ((_hidden_aes_192_cfb = EVP_CIPHER_meth_new(425, 1, 24)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_192_cfb, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_192_cfb, 0 | 0x3) || !EVP_CIPHER_meth_set_init(_hidden_aes_192_cfb, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_192_cfb, padlock_cfb_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_192_cfb, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_192_cfb, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_192_cfb, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_192_cfb); _hidden_aes_192_cfb = ((void *)0); } return _hidden_aes_192_cfb; }
static EVP_CIPHER *_hidden_aes_192_ofb = ((void *)0); static const EVP_CIPHER *padlock_aes_192_ofb(void) { if (_hidden_aes_192_ofb == ((void *)0) && ((_hidden_aes_192_ofb = EVP_CIPHER_meth_new(424, 1, 24)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_192_ofb, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_192_ofb, 0 | 0x4) || !EVP_CIPHER_meth_set_init(_hidden_aes_192_ofb, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_192_ofb, padlock_ofb_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_192_ofb, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_192_ofb, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_192_ofb, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_192_ofb); _hidden_aes_192_ofb = ((void *)0); } return _hidden_aes_192_ofb; }
static EVP_CIPHER *_hidden_aes_192_ctr = ((void *)0); static const EVP_CIPHER *padlock_aes_192_ctr(void) { if (_hidden_aes_192_ctr == ((void *)0) && ((_hidden_aes_192_ctr = EVP_CIPHER_meth_new(905, 1, 24)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_192_ctr, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_192_ctr, 0 | 0x5) || !EVP_CIPHER_meth_set_init(_hidden_aes_192_ctr, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_192_ctr, padlock_ctr_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_192_ctr, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_192_ctr, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_192_ctr, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_192_ctr); _hidden_aes_192_ctr = ((void *)0); } return _hidden_aes_192_ctr; }
static EVP_CIPHER *_hidden_aes_256_ecb = ((void *)0); static const EVP_CIPHER *padlock_aes_256_ecb(void) { if (_hidden_aes_256_ecb == ((void *)0) && ((_hidden_aes_256_ecb = EVP_CIPHER_meth_new(426, 16, 32)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_256_ecb, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_256_ecb, 0 | 0x1) || !EVP_CIPHER_meth_set_init(_hidden_aes_256_ecb, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_256_ecb, padlock_ecb_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_256_ecb, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_256_ecb, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_256_ecb, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_256_ecb); _hidden_aes_256_ecb = ((void *)0); } return _hidden_aes_256_ecb; }
static EVP_CIPHER *_hidden_aes_256_cbc = ((void *)0); static const EVP_CIPHER *padlock_aes_256_cbc(void) { if (_hidden_aes_256_cbc == ((void *)0) && ((_hidden_aes_256_cbc = EVP_CIPHER_meth_new(427, 16, 32)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_256_cbc, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_256_cbc, 0 | 0x2) || !EVP_CIPHER_meth_set_init(_hidden_aes_256_cbc, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_256_cbc, padlock_cbc_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_256_cbc, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_256_cbc, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_256_cbc, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_256_cbc); _hidden_aes_256_cbc = ((void *)0); } return _hidden_aes_256_cbc; }
static EVP_CIPHER *_hidden_aes_256_cfb = ((void *)0); static const EVP_CIPHER *padlock_aes_256_cfb(void) { if (_hidden_aes_256_cfb == ((void *)0) && ((_hidden_aes_256_cfb = EVP_CIPHER_meth_new(429, 1, 32)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_256_cfb, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_256_cfb, 0 | 0x3) || !EVP_CIPHER_meth_set_init(_hidden_aes_256_cfb, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_256_cfb, padlock_cfb_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_256_cfb, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_256_cfb, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_256_cfb, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_256_cfb); _hidden_aes_256_cfb = ((void *)0); } return _hidden_aes_256_cfb; }
static EVP_CIPHER *_hidden_aes_256_ofb = ((void *)0); static const EVP_CIPHER *padlock_aes_256_ofb(void) { if (_hidden_aes_256_ofb == ((void *)0) && ((_hidden_aes_256_ofb = EVP_CIPHER_meth_new(428, 1, 32)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_256_ofb, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_256_ofb, 0 | 0x4) || !EVP_CIPHER_meth_set_init(_hidden_aes_256_ofb, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_256_ofb, padlock_ofb_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_256_ofb, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_256_ofb, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_256_ofb, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_256_ofb); _hidden_aes_256_ofb = ((void *)0); } return _hidden_aes_256_ofb; }
static EVP_CIPHER *_hidden_aes_256_ctr = ((void *)0); static const EVP_CIPHER *padlock_aes_256_ctr(void) { if (_hidden_aes_256_ctr == ((void *)0) && ((_hidden_aes_256_ctr = EVP_CIPHER_meth_new(906, 1, 32)) == ((void *)0) || !EVP_CIPHER_meth_set_iv_length(_hidden_aes_256_ctr, 16) || !EVP_CIPHER_meth_set_flags(_hidden_aes_256_ctr, 0 | 0x5) || !EVP_CIPHER_meth_set_init(_hidden_aes_256_ctr, padlock_aes_init_key) || !EVP_CIPHER_meth_set_do_cipher(_hidden_aes_256_ctr, padlock_ctr_cipher) || !EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_256_ctr, sizeof(struct padlock_cipher_data) + 16) || !EVP_CIPHER_meth_set_set_asn1_params(_hidden_aes_256_ctr, EVP_CIPHER_set_asn1_iv) || !EVP_CIPHER_meth_set_get_asn1_params(_hidden_aes_256_ctr, EVP_CIPHER_get_asn1_iv))) { EVP_CIPHER_meth_free(_hidden_aes_256_ctr); _hidden_aes_256_ctr = ((void *)0); } return _hidden_aes_256_ctr; }
static int
...
unsigned long mode = (EVP_CIPHER_flags(EVP_CIPHER_CTX_cipher(ctx)) & 0xF0007);
if (key == ((void *)0))
return 0;               
cdata = ((struct padlock_cipher_data *) ( (unsigned char *)(EVP_CIPHER_CTX_get_cipher_data(ctx)) + ( (0x10 - ((size_t)(EVP_CIPHER_CTX_get_cipher_data(ctx)) & 0x0F)) & 0x0F ) ));
...
#line 731 "engines\\e_padlock.c"
#line 732 "engines\\e_padlock.c"
#line 733 "engines\\e_padlock.c"
#line 748 "engines\\e_padlock.c"
