...
#pragma pack(push,8)
#line 41 "C:\\Program Files (x86)\\Microsoft Visual Studio 11.0\\VC\\INCLUDE\\stdlib.h"
#line 42 "C:\\Program Files (x86)\\Microsoft Visual Studio 11.0\\VC\\INCLUDE\\stdlib.h"
...
#line 14 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/rand.h"
...
#line 18 "fuzz\\server.c"
#line 1 "D:\\07.OpenSrc\\GmSSL\\include\\openssl/rsa.h"
#line 19 "fuzz\\server.c"
#line 1 "d:\\07.opensrc\\gmssl\\fuzz\\fuzzer.h"
int FuzzerTestOneInput(const uint8_t *buf, size_t len);
int FuzzerInitialize(int *argc, char ***argv);
#line 20 "fuzz\\server.c"
...
privkey = d2i_RSAPrivateKey(((void *)0), &bufp, sizeof(kRSAPrivateKeyDER));
(void)((privkey != ((void *)0)) ? 0 : (OPENSSL_die("assertion failed: " "privkey != NULL", "fuzz\\server.c", 203), 1));
pkey = EVP_PKEY_new();
EVP_PKEY_assign((pkey),6, (char *)(privkey));
ret = SSL_CTX_use_PrivateKey(ctx, pkey);
(void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "fuzz\\server.c", 207), 1));
EVP_PKEY_free(pkey);
bufp = kCertificateDER;
cert = d2i_X509(((void *)0), &bufp, sizeof(kCertificateDER));
(void)((cert != ((void *)0)) ? 0 : (OPENSSL_die("assertion failed: " "cert != NULL", "fuzz\\server.c", 211), 1));
ret = SSL_CTX_use_certificate(ctx, cert);
(void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "fuzz\\server.c", 213), 1));
X509_free(cert);
return 1;
}
int FuzzerTestOneInput(const uint8_t *buf, size_t len) {
...
(void)(((size_t)BIO_write(in, buf, len) == len) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(in, buf, len) == len", "fuzz\\server.c", 238), 1));
