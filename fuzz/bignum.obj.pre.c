...
(void)((BN_bin2bn(buf, l1, b1) == b1) ? 0 : (OPENSSL_die("assertion failed: " "BN_bin2bn(buf, l1, b1) == b1", "fuzz\\bignum.c", 60), 1));
BN_set_negative(b1, s1);
(void)((BN_bin2bn(buf + l1, l2, b2) == b2) ? 0 : (OPENSSL_die("assertion failed: " "BN_bin2bn(buf + l1, l2, b2) == b2", "fuzz\\bignum.c", 62), 1));
BN_set_negative(b2, s2);
(void)((BN_bin2bn(buf + l1 + l2, l3, b3) == b3) ? 0 : (OPENSSL_die("assertion failed: " "BN_bin2bn(buf + l1 + l2, l3, b3) == b3", "fuzz\\bignum.c", 64), 1));
BN_set_negative(b3, s3);
if (BN_is_zero(b3)) {
success = 1;
goto done;
}
(void)((BN_mod_exp(b4, b1, b2, b3, ctx)) ? 0 : (OPENSSL_die("assertion failed: " "BN_mod_exp(b4, b1, b2, b3, ctx)", "fuzz\\bignum.c", 73), 1));
(void)((BN_mod_exp_simple(b5, b1, b2, b3, ctx)) ? 0 : (OPENSSL_die("assertion failed: " "BN_mod_exp_simple(b5, b1, b2, b3, ctx)", "fuzz\\bignum.c", 74), 1));
success = BN_cmp(b4, b5) == 0;
if (!success) {
BN_print_fp((&__iob_func()[1]), b1);
putchar('\n');
BN_print_fp((&__iob_func()[1]), b2);
putchar('\n');
BN_print_fp((&__iob_func()[1]), b3);
putchar('\n');
BN_print_fp((&__iob_func()[1]), b4);
putchar('\n');
BN_print_fp((&__iob_func()[1]), b5);
putchar('\n');
}
done:
(void)((success) ? 0 : (OPENSSL_die("assertion failed: " "success", "fuzz\\bignum.c", 91), 1));
return 0;
}
